...
[​](https://trigger.dev/docs/run-usage#getting-the-run-cost-and-duration)
...
[​](https://trigger.dev/docs/run-usage#getting-the-run-cost-and-duration-from-your-backend)

Getting the run cost and duration from your backend
--------------------------------------------------------------------------------------------------------------------------------------------------

You can use [runs.retrieve()](https://trigger.dev/docs/management/runs/retrieve)
 to get a single run or [runs.list()](https://trigger.dev/docs/management/runs/list)
 to get a list of runs. The response will include `costInCents` `baseCostInCents` and `durationMs` fields.
...
[​](https://trigger.dev/docs/run-usage#getting-the-cost-and-duration-of-a-block-of-code)
...
[Previous](https://trigger.dev/docs/tasks/streams)
[ContextGet the context of a task run.\
\
Next](https://trigger.dev/docs/context)
