...
[​](https://trigger.dev/docs/wait-for#wait-idempotency)
...
[Previous](https://trigger.dev/docs/wait)
[Wait untilWait until a date, then continue execution.\
\
Next](https://trigger.dev/docs/wait-until)
