...
[​](https://trigger.dev/docs/idempotency#why-use-idempotency-keys)
...
[​](https://trigger.dev/docs/idempotency#idempotencykey-option)
...
When you pass a raw string, it defaults to `"run"` scope (scoped to the parent run). See [Default behavior](https://trigger.dev/docs/idempotency#default-behavior)
 for details on how scopes work and how to use global scope instead.
...
[​](https://trigger.dev/docs/idempotency#understanding-scopes)
...
[​](https://trigger.dev/docs/idempotency#available-scopes)
...
[​](https://trigger.dev/docs/idempotency#run-scope-default)
...
[​](https://trigger.dev/docs/idempotency#attempt-scope)
...
[​](https://trigger.dev/docs/idempotency#global-scope)
...
Even with `global` scope, idempotency keys are still isolated to the specific task and environment. Using the same key to trigger _different_ tasks will not deduplicate - both tasks will run. See [Environment and task scoping](https://trigger.dev/docs/idempotency#environment-and-task-scoping)
 for more details.

[​](https://trigger.dev/docs/idempotency#default-behavior)
...
[​](https://trigger.dev/docs/idempotency#passing-a-raw-string)
...
[​](https://trigger.dev/docs/idempotency#triggering-from-backend-code)
...
[​](https://trigger.dev/docs/idempotency#idempotencykeyttl-option)
...
![idempotency-key-ttl](https://mintcdn.com/trigger/uys6iMwf9B_ojh8r/images/idempotency-key-ttl.png?w=2500&fit=max&auto=format&n=uys6iMwf9B_ojh8r&q=85&s=d701231ed25ac6e732be10529e46e017) By default idempotency keys are stored for 30 days. You can change this by passing the `idempotencyKeyTTL` option when triggering a task:
...
[​](https://trigger.dev/docs/idempotency#failed-runs-and-idempotency)
...
[​](https://trigger.dev/docs/idempotency#payload-based-idempotency)
...
[​](https://trigger.dev/docs/idempotency#resetting-idempotency-keys)
...
[​](https://trigger.dev/docs/idempotency#api-signature)
...
[​](https://trigger.dev/docs/idempotency#resetting-keys-created-with-idempotencykeys-create)
...
[​](https://trigger.dev/docs/idempotency#resetting-global-keys)
...
[​](https://trigger.dev/docs/idempotency#resetting-run-scoped-keys)
...
If you triggered the task from backend code, all scopes behave as global (see [Triggering from backend code](https://trigger.dev/docs/idempotency#triggering-from-backend-code)
). Use `scope: "global"` when resetting.

### 

[​](https://trigger.dev/docs/idempotency#resetting-attempt-scoped-keys)
...
[​](https://trigger.dev/docs/idempotency#resetting-from-the-dashboard)
...
This is useful when you need to manually allow a task to be re-triggered without writing code. ![Idempotency section in the run details pane showing the key, scope, and expiration time](https://mintcdn.com/trigger/ZdW-AgQGBQJjNstH/images/idempotency-key-dashboard.png?w=2500&fit=max&auto=format&n=ZdW-AgQGBQJjNstH&q=85&s=00c04dc5f963a8a601568a8dbe06f5c3)
...
[​](https://trigger.dev/docs/idempotency#important-notes)
...
[​](https://trigger.dev/docs/idempotency#environment-and-task-scoping)
...
[​](https://trigger.dev/docs/idempotency#how-scopes-affect-the-key)
...
[Previous](https://trigger.dev/docs/machines)
[Max durationSet a maximum duration for a task to run.\
\
Next](https://trigger.dev/docs/runs/max-duration)
