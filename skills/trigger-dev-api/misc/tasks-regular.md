...
> Source: https://trigger.dev/docs/tasks-regular

They are defined using the `task()` function and can be [triggered](https://trigger.dev/docs/triggering)
 from your backend or inside another task. Like all tasks they don’t have timeouts, they should be placed inside a [/trigger folder](https://trigger.dev/docs/config/config-file)
, and you [can configure them](https://trigger.dev/docs/tasks/overview#defining-a-task)
.

[​](https://trigger.dev/docs/tasks-regular#example-tasks)
...
[​](https://trigger.dev/docs/tasks-regular#a-task-that-does-an-openai-call-with-retrying)
