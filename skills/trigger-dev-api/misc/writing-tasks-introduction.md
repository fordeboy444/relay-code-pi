...
Before digging deeper into the details of writing tasks, you should read the [fundamentals of tasks](https://trigger.dev/docs/tasks/overview)
 to understand what tasks are and how they work.

[​](https://trigger.dev/docs/writing-tasks-introduction#writing-tasks)
...
[​](https://trigger.dev/docs/writing-tasks-introduction#our-library-of-examples-guides-and-projects)
...
[Previous](https://trigger.dev/docs/mcp-agent-rules)
[Logging, tracing & metricsHow to use the built-in logging, tracing, and metrics system.\
\
Next](https://trigger.dev/docs/logging)
