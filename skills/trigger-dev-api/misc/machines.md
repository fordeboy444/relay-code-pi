...
[​](https://trigger.dev/docs/machines#machine-configurations)
...
[​](https://trigger.dev/docs/machines#overriding-the-machine-when-triggering)

Overriding the machine when triggering
-----------------------------------------------------------------------------------------------------------------------

You can also override the task machine when you [trigger](https://trigger.dev/docs/triggering)
 it:
...
[​](https://trigger.dev/docs/machines#out-of-memory-oom-errors)
...
[​](https://trigger.dev/docs/machines#memory/resource-monitoring)

Memory/Resource monitoring

To better understand why an OOM error occurred, we’ve published a helper class that will log memory debug information at regular intervals. First, add this `ResourceMonitor` class to your project:View ResourceMonitor class
...
This will produce logs that look like this: ![Resource monitor logs](https://mintcdn.com/trigger/TySlE0a_RvppyBcX/images/machines-resource-monitor-logs.png?w=2500&fit=max&auto=format&n=TySlE0a_RvppyBcX&q=85&s=b565ef6b5295ce0d44fa6feba31ff143) If you are spawning a child process and you want to monitor its memory usage, you can pass the `processName` option to the `ResourceMonitor` class:
...
This will produce logs that includes the memory and CPU usage of the `ffmpeg` process: ![Resource monitor logs](https://mintcdn.com/trigger/TySlE0a_RvppyBcX/images/machines-resource-monitor-ffmpeg.png?w=2500&fit=max&auto=format&n=TySlE0a_RvppyBcX&q=85&s=d1a412cdf3a968599f08fb27deaf4007)

### 

[​](https://trigger.dev/docs/machines#explicit-oom-errors)
...
[​](https://trigger.dev/docs/machines#retrying-with-a-larger-machine)
...
[Previous](https://trigger.dev/docs/versioning)
[IdempotencyAn API call or operation is idempotent if it has the same result when called more than once.\
\
Next](https://trigger.dev/docs/idempotency)
