...
**Action required: Trigger.dev v3 deprecation**We’re retiring Trigger.dev v3. **New v3 deploys will stop working from 1 April 2026.** Trigger.dev v4 is stable, fully supported, and recommended for all users.**Key dates:**
...
**What you need to do:** Migrate to v4 before April to avoid disruption to your task executions. The migration takes about 2 minutes — follow the steps on this page below. If you have questions or need help, [contact us](https://trigger.dev/contact)
 or reach out in our [Discord](https://trigger.dev/discord)
.

[​](https://trigger.dev/docs/migrating-from-v3#what%E2%80%99s-new-in-v4)
...
| Wait idempotency | Skip waits if the same idempotency key is used again when using [wait for](https://trigger.dev/docs/wait-for#wait-idempotency)<br>, [wait until](https://trigger.dev/docs/wait-until#wait-idempotency)<br>, or [wait for token](https://trigger.dev/docs/wait-for-token#wait-idempotency)<br>. |
...
| [Middleware & locals](https://trigger.dev/docs/migrating-from-v3#middleware-and-locals) | The middleware system runs at the top level, executing before and after all lifecycle hooks. The locals API allows sharing data between middleware and hooks. |
...
[​](https://trigger.dev/docs/migrating-from-v3#node-js-support)
...
[​](https://trigger.dev/docs/migrating-from-v3#v3)
...
[​](https://trigger.dev/docs/migrating-from-v3#v4)
...
[​](https://trigger.dev/docs/migrating-from-v3#how-to-migrate-to-v4)
...
When migrating from v3 to v4, our infrastructure IPs may change. If you use IP allowlisting (e.g. for databases or APIs), [update your allowlists](https://trigger.dev/changelog/static-ips)
 with the current static IPs before or immediately after switching to v4 to avoid connectivity issues or downtime.

[​](https://trigger.dev/docs/migrating-from-v3#migrate-using-ai)
...
[​](https://trigger.dev/docs/migrating-from-v3#installation)
...
[​](https://trigger.dev/docs/migrating-from-v3#deprecations)
...
[​](https://trigger.dev/docs/migrating-from-v3#@trigger-dev/sdk/v3)
...
[​](https://trigger.dev/docs/migrating-from-v3#handleerror-and-init)
...
This has now been deprecated in favor of the `locals` API and middleware. See the [Improved middleware and locals](https://trigger.dev/docs/tasks/overview#middleware-and-locals-functions)
 section for more details.

### 

[​](https://trigger.dev/docs/migrating-from-v3#tooltask)
...
[​](https://trigger.dev/docs/migrating-from-v3#breaking-changes)
...
[​](https://trigger.dev/docs/migrating-from-v3#queue-changes)
...
[​](https://trigger.dev/docs/migrating-from-v3#lifecycle-hooks)
...
[​](https://trigger.dev/docs/migrating-from-v3#context-changes)
...
[​](https://trigger.dev/docs/migrating-from-v3#batchtrigger-changes)
...
[​](https://trigger.dev/docs/migrating-from-v3#opentelemetry)
...
[Previous](https://trigger.dev/docs/limits)
[OverviewTasks are functions that can run for a long time and provide strong resilience to failure.\
\
Next](https://trigger.dev/docs/tasks/overview)
