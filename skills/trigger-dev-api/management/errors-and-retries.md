...
[​](https://trigger.dev/docs/management/errors-and-retries#handling-errors)
...
[​](https://trigger.dev/docs/management/errors-and-retries#retries)

Retries
------------------------------------------------------------------------------

The SDK will automatically retry requests that fail due to network errors or server errors. By default, the SDK will retry requests up to 3 times, with an exponential backoff delay between retries. You can customize the retry behavior by passing a `requestOptions` option to the `configure` function:
...
[Previous](https://trigger.dev/docs/management/multiple-clients)
[Auto-paginationUsing auto-pagination with the Trigger.dev management API\
\
Next](https://trigger.dev/docs/management/auto-pagination)
