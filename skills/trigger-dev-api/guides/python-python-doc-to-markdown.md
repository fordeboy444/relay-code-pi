...
[​](https://trigger.dev/docs/guides/python/python-doc-to-markdown#overview)

Overview
---------------------------------------------------------------------------------------

Convert documents to markdown using Microsoft’s [MarkItDown](https://github.com/microsoft/markitdown)
 library. This can be especially useful for preparing documents in a structured format for AI applications.

[​](https://trigger.dev/docs/guides/python/python-doc-to-markdown#prerequisites)
...
*   [Python](https://www.python.org/)
     installed on your local machine. _This example requires Python 3.10 or higher._

[​](https://trigger.dev/docs/guides/python/python-doc-to-markdown#features)

Features
---------------------------------------------------------------------------------------

*   A Trigger.dev task which downloads a document from a URL and runs the Python script which converts it to markdown
*   A Python script to convert documents to markdown using Microsoft’s [MarkItDown](https://github.com/microsoft/markitdown)
     library
*   Uses our [Python build extension](https://trigger.dev/docs/config/extensions/pythonExtension)
     to install dependencies and run Python scripts

[​](https://trigger.dev/docs/guides/python/python-doc-to-markdown#github-repo)
...
[​](https://trigger.dev/docs/guides/python/python-doc-to-markdown#the-code)
...
[​](https://trigger.dev/docs/guides/python/python-doc-to-markdown#build-configuration)
...
[​](https://trigger.dev/docs/guides/python/python-doc-to-markdown#task-code)
...
src/trigger/convertToMarkdown.ts
...
[​](https://trigger.dev/docs/guides/python/python-doc-to-markdown#add-a-requirements-txt-file)
...
[​](https://trigger.dev/docs/guides/python/python-doc-to-markdown#the-python-script)
...
[​](https://trigger.dev/docs/guides/python/python-doc-to-markdown#testing-your-task)
...
[​](https://trigger.dev/docs/guides/python/python-doc-to-markdown#markitdown-conversion-capabilities)
...
[​](https://trigger.dev/docs/guides/python/python-doc-to-markdown#learn-more-about-using-python-with-trigger-dev)
...
[Previous](https://trigger.dev/docs/guides/python/python-image-processing)
[Headless web crawlerLearn how to use Python, Crawl4AI and Playwright to create a headless browser web crawler with Trigger.dev.\
\
Next](https://trigger.dev/docs/guides/python/python-crawl4ai)
