...
[​](https://trigger.dev/docs/guides/examples/react-email#overview)
...
This example uses [Resend](https://resend.com/)
 as the email provider. You can use other email providers like [Loops](https://loops.so/)
 or [SendGrid](https://sendgrid.com/)
 etc. Full list of their integrations can be found [here](https://react.email/docs/introduction#integrations)
.

[​](https://trigger.dev/docs/guides/examples/react-email#task-code)
...
[​](https://trigger.dev/docs/guides/examples/react-email#the-email)

The email
--------------------------------------------------------------------------------

This example email should look like this: ![React Email](https://mintcdn.com/trigger/5SxX7bFjJKRsidSL/images/react-email.png?w=2500&fit=max&auto=format&n=5SxX7bFjJKRsidSL&q=85&s=1281ba4f08fe017c3cab10d66c208592) This is just a simple implementation, you can customize the email to be as complex as you want. Check out the [React email templates](https://react.email/templates)
 for more inspiration.

[​](https://trigger.dev/docs/guides/examples/react-email#testing-your-task)
...
[​](https://trigger.dev/docs/guides/examples/react-email#deploying-your-task)
...
[​](https://trigger.dev/docs/guides/examples/react-email#using-cursor-/-ai-to-build-your-emails)

Using Cursor / AI to build your emails
------------------------------------------------------------------------------------------------------------------------------------------

In this video you can see how we use Cursor to build a welcome email. We recommend using our [Cursor rules](https://trigger.dev/changelog/cursor-rules-writing-tasks/)
 to help you build your tasks and emails.

#### 

[​](https://trigger.dev/docs/guides/examples/react-email#video-creating-a-new-email-template-using-cursor)

Video: creating a new email template using Cursor

#### 

[​](https://trigger.dev/docs/guides/examples/react-email#the-generated-email-template)

The generated email template

![Cursor](https://mintcdn.com/trigger/5SxX7bFjJKRsidSL/images/react-email-welcome.png?w=2500&fit=max&auto=format&n=5SxX7bFjJKRsidSL&q=85&s=e145996626c42ce55077aafb7cebfa47)

#### 

[​](https://trigger.dev/docs/guides/examples/react-email#the-generated-code)
...
[​](https://trigger.dev/docs/guides/examples/react-email#troubleshooting)
...
See our [common problems guide](https://trigger.dev/docs/troubleshooting#reactdomserver-rendertopipeablestream-is-not-a-function-when-using-react-email)
 for more information.

[​](https://trigger.dev/docs/guides/examples/react-email#learn-more)
...
[​](https://trigger.dev/docs/guides/examples/react-email#react-email-docs)

React Email docs

Check out the [React Email docs](https://react.email/docs)
 and learn how to set up and use React Email, including how to preview your emails locally.
...
[Previous](https://trigger.dev/docs/guides/examples/react-pdf)
[Replicate image generationLearn how to generate images from source image URLs using Replicate and Trigger.dev.\
\
Next](https://trigger.dev/docs/guides/examples/replicate-image-generation)
