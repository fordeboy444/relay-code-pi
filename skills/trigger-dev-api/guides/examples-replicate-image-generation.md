...
[​](https://trigger.dev/docs/guides/examples/replicate-image-generation#overview)

Overview
---------------------------------------------------------------------------------------------

This example demonstrates how to use Trigger.dev to generate images from source image URLs using [Replicate](https://replicate.com/)
, the [nano-banana](https://replicate.com/google/nano-banana)
 model.

[​](https://trigger.dev/docs/guides/examples/replicate-image-generation#task-code)
...
[​](https://trigger.dev/docs/guides/examples/replicate-image-generation#environment-variables)
...
[Previous](https://trigger.dev/docs/guides/examples/react-email)
[Resend email sequenceThis example will show you how to send a sequence of emails over several days using Resend with Trigger.dev.\
\
Next](https://trigger.dev/docs/guides/examples/resend-email-sequence)
