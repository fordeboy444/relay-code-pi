...
[​](https://trigger.dev/docs/guides/examples/react-pdf#overview)

Overview
----------------------------------------------------------------------------

This example demonstrates how to use Trigger.dev to generate a PDF using [react-pdf](https://react-pdf.org/)
 and save it to Cloudflare R2.

[​](https://trigger.dev/docs/guides/examples/react-pdf#task-code)
...
[​](https://trigger.dev/docs/guides/examples/react-pdf#testing-your-task)
...
[Previous](https://trigger.dev/docs/guides/examples/puppeteer)
[React EmailLearn how to send beautiful emails using React Email and Trigger.dev.\
\
Next](https://trigger.dev/docs/guides/examples/react-email)
