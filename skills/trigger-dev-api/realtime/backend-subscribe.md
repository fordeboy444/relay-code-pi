...
[​](https://trigger.dev/docs/realtime/backend/subscribe#runs-subscribetorun)
...
[​](https://trigger.dev/docs/realtime/backend/subscribe#type-safety)
...
[​](https://trigger.dev/docs/realtime/backend/subscribe#subscribe-to-metadata-updates-from-your-tasks)
...
For frontend applications using React, see our [React hooks metadata documentation](https://trigger.dev/docs/realtime/react-hooks/subscribe#using-metadata-to-show-progress-in-your-ui)
 for consuming metadata updates in your UI.
...
[​](https://trigger.dev/docs/realtime/backend/subscribe#how-to-subscribe-to-metadata-updates)
...
[​](https://trigger.dev/docs/realtime/backend/subscribe#type-safety-2)
...
[Previous](https://trigger.dev/docs/realtime/backend/overview)
[StreamingRead AI/LLM output, file chunks, and other streaming data from your Trigger.dev tasks in backend code.\
\
Next](https://trigger.dev/docs/realtime/backend/streams)
