...
| `MACHINE_PRESETS_OVERRIDE_PATH` | No  | —   | Path to machine presets override file. See [machine overrides](https://trigger.dev/docs/self-hosting/overview#machine-overrides)<br>. |
...
[​](https://trigger.dev/docs/self-hosting/env/webapp#multi-provider-object-storage)
...
[​](https://trigger.dev/docs/self-hosting/env/webapp#how-it-works)
...
[​](https://trigger.dev/docs/self-hosting/env/webapp#configuration)

Configuration

#### 

[​](https://trigger.dev/docs/self-hosting/env/webapp#default-provider-backward-compatible)
...
[​](https://trigger.dev/docs/self-hosting/env/webapp#named-providers)
...
[​](https://trigger.dev/docs/self-hosting/env/webapp#default-protocol-for-new-uploads)
...
[​](https://trigger.dev/docs/self-hosting/env/webapp#migration-guide)
...
[Previous](https://trigger.dev/docs/self-hosting/kubernetes)
[SupervisorEnvironment variables for the supervisor container.\
\
Next](https://trigger.dev/docs/self-hosting/env/supervisor)
