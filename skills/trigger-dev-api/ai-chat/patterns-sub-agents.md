...
Sub-agents let a parent agent delegate work to other agents running as durable Trigger.dev tasks. The sub-agent’s response streams back through the parent as preliminary tool results, so the frontend sees the sub-agent working inside the parent’s tool call card. This builds on the AI SDK’s [async generator tool pattern](https://ai-sdk.dev/docs/agents/subagents)
 and Trigger.dev’s [AgentChat](https://trigger.dev/docs/ai-chat/server-chat)
 for server-side agent interaction.

[​](https://trigger.dev/docs/ai-chat/patterns/sub-agents#how-it-works)
...
[​](https://trigger.dev/docs/ai-chat/patterns/sub-agents#single-turn-sub-agent)
...
[​](https://trigger.dev/docs/ai-chat/patterns/sub-agents#multi-turn-sub-agent-llm-driven)
...
[​](https://trigger.dev/docs/ai-chat/patterns/sub-agents#cross-turn-persistence)
...
[​](https://trigger.dev/docs/ai-chat/patterns/sub-agents#how-sub-agents-clean-up)
...
[​](https://trigger.dev/docs/ai-chat/patterns/sub-agents#what-the-frontend-sees)
...
[​](https://trigger.dev/docs/ai-chat/patterns/sub-agents#controlling-what-the-parent-llm-sees)
...
[​](https://trigger.dev/docs/ai-chat/patterns/sub-agents#chatstream-messages)
...
[​](https://trigger.dev/docs/ai-chat/patterns/sub-agents#combining-with-chat-agent)
...
[​](https://trigger.dev/docs/ai-chat/patterns/sub-agents#streaming-progress-from-a-subtask-to-the-parent-chat)
...
[​](https://trigger.dev/docs/ai-chat/patterns/sub-agents#inside-ai-toolexecute-accessing-tool-+-chat-context)
...
The subtask body also has read-only access to any [`chat.local`](https://trigger.dev/docs/ai-chat/chat-local)
 values initialized in the parent — auto-hydrated from the parent’s metadata on first access.

Was this page helpful?

YesNo

[Previous](https://trigger.dev/docs/ai-chat/error-handling)
[Version upgradesGracefully migrate suspended chat agents to a new deployment using chat.requestUpgrade() and the continuation mechanism.\
\
Next](https://trigger.dev/docs/ai-chat/patterns/version-upgrades)
