...
[​](https://trigger.dev/docs/ai-chat/server-chat#type-safe-client-data)
...
[​](https://trigger.dev/docs/ai-chat/server-chat#conversation-lifecycle)
...
[​](https://trigger.dev/docs/ai-chat/server-chat#sending-messages)
...
[​](https://trigger.dev/docs/ai-chat/server-chat#preloading-optional)
...
[​](https://trigger.dev/docs/ai-chat/server-chat#closing)
...
[​](https://trigger.dev/docs/ai-chat/server-chat#reading-responses)
...
[​](https://trigger.dev/docs/ai-chat/server-chat#get-the-full-text)
...
[​](https://trigger.dev/docs/ai-chat/server-chat#get-structured-results)
...
[​](https://trigger.dev/docs/ai-chat/server-chat#stream-chunks-in-real-time)
...
[​](https://trigger.dev/docs/ai-chat/server-chat#stateless-request-handlers)
...
[​](https://trigger.dev/docs/ai-chat/server-chat#sub-agent-tool-pattern)
...
This supports single-turn delegation, multi-turn LLM-driven conversations with persistent sub-agents, and cross-turn state that survives snapshot/restore. See the [Sub-Agents guide](https://trigger.dev/docs/ai-chat/patterns/sub-agents)
 for the full pattern including multi-turn conversations, cleanup, and what the frontend sees.

[​](https://trigger.dev/docs/ai-chat/server-chat#additional-methods)
...
[​](https://trigger.dev/docs/ai-chat/server-chat#steering)
...
[​](https://trigger.dev/docs/ai-chat/server-chat#stop-generation)
...
[​](https://trigger.dev/docs/ai-chat/server-chat#raw-messages)
...
[​](https://trigger.dev/docs/ai-chat/server-chat#reconnect)
...
[​](https://trigger.dev/docs/ai-chat/server-chat#agentchat-options)
...
[​](https://trigger.dev/docs/ai-chat/server-chat#chatstream-methods)
...
[Previous](https://trigger.dev/docs/ai-chat/frontend)
[SessionsA Session is a stateful execution of an agent, with two-way streaming and durable compute. A single Session can have multiple runs associated with it.\
\
Next](https://trigger.dev/docs/ai-chat/sessions)
