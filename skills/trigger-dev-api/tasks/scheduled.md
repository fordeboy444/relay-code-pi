...
Scheduled tasks are only for recurring tasks. If you want to trigger a one-off task at a future time, you should [use the delay option](https://trigger.dev/docs/triggering#delay)
.

[​](https://trigger.dev/docs/tasks/scheduled#defining-a-scheduled-task)
...
Like all tasks they don’t have timeouts, they should be placed inside a [/trigger folder](https://trigger.dev/docs/config/config-file)
, and you [can configure them](https://trigger.dev/docs/tasks/overview#defining-a-task)
. You can set a [TTL](https://trigger.dev/docs/runs#time-to-live-ttl)
 on a scheduled task to automatically expire runs that aren’t dequeued in time. This is useful when a schedule fires while the previous run is still executing - rather than queueing up stale runs, they’ll expire:
...
[​](https://trigger.dev/docs/tasks/scheduled#how-to-attach-a-schedule)
...
[​](https://trigger.dev/docs/tasks/scheduled#declarative-schedules)

Declarative schedules

These sync when you run the [dev](https://trigger.dev/docs/cli-dev-commands)
 or [deploy](https://trigger.dev/docs/cli-deploy-commands)
 commands. To create them you add the `cron` property to your `schedules.task()`. This property is optional and is only used if you want to add a declarative schedule to your task:
...
When you run the [dev](https://trigger.dev/docs/cli-dev-commands)
 or [deploy](https://trigger.dev/docs/cli-deploy-commands)
 commands, declarative schedules will be synced. If you add, delete or edit the `cron` property it will be updated when you run these commands. You can view your schedules on the Schedules page in the dashboard.

### 

[​](https://trigger.dev/docs/tasks/scheduled#imperative-schedules)
...
[​](https://trigger.dev/docs/tasks/scheduled#supported-cron-syntax)
...
[​](https://trigger.dev/docs/tasks/scheduled#when-schedules-won%E2%80%99t-trigger)
...
[​](https://trigger.dev/docs/tasks/scheduled#attaching-schedules-in-the-dashboard)
...
page](https://mintcdn.com/trigger/5SxX7bFjJKRsidSL/images/schedules-blank.png?w=2500&fit=max&auto=format&n=5SxX7bFjJKRsidSL&q=85&s=bc86e5670d9c0b0c85cb3db0cde6bfbe) 
...
page](https://mintcdn.com/trigger/5SxX7bFjJKRsidSL/images/schedules-create.png?w=2500&fit=max&auto=format&n=5SxX7bFjJKRsidSL&q=85&s=06ce41644450d0f6bc12745c26e8859b) These are the options when creating a schedule:
...
[​](https://trigger.dev/docs/tasks/scheduled#attaching-schedules-with-the-sdk)
...
See [the SDK reference](https://trigger.dev/docs/management/schedules/create)
 for full details.

### 

[​](https://trigger.dev/docs/tasks/scheduled#dynamic-schedules-or-multi-tenant-schedules)
...
[​](https://trigger.dev/docs/tasks/scheduled#testing-schedules)
...
In the sidebar select the “Test” page, then select a scheduled task from the list (they have a clock icon on them) ![Test page](https://mintcdn.com/trigger/5SxX7bFjJKRsidSL/images/schedules-test.png?w=2500&fit=max&auto=format&n=5SxX7bFjJKRsidSL&q=85&s=82ac96f5c94674e853545cb60285b38a) 
...
Fill in the form \[1\]. You can select from a recent run \[2\] to pre-populate the fields. Press “Run test” when you’re ready ![Schedule test form](https://mintcdn.com/trigger/5SxX7bFjJKRsidSL/images/schedules-test-form.png?w=2500&fit=max&auto=format&n=5SxX7bFjJKRsidSL&q=85&s=8878736225374e8cc8ddd0d8227a596a) 

[​](https://trigger.dev/docs/tasks/scheduled#managing-schedules-with-the-sdk)
...
[​](https://trigger.dev/docs/tasks/scheduled#retrieving-an-existing-schedule)
...
See [the SDK reference](https://trigger.dev/docs/management/schedules/retrieve)
 for full details.

### 

[​](https://trigger.dev/docs/tasks/scheduled#listing-schedules)
...
See [the SDK reference](https://trigger.dev/docs/management/schedules/list)
 for full details.

### 

[​](https://trigger.dev/docs/tasks/scheduled#updating-a-schedule)
...
See [the SDK reference](https://trigger.dev/docs/management/schedules/update)
 for full details.

### 

[​](https://trigger.dev/docs/tasks/scheduled#deactivating-a-schedule)
...
See [the SDK reference](https://trigger.dev/docs/management/schedules/deactivate)
 for full details.

### 

[​](https://trigger.dev/docs/tasks/scheduled#activating-a-schedule)
...
See [the SDK reference](https://trigger.dev/docs/management/schedules/activate)
 for full details.

### 

[​](https://trigger.dev/docs/tasks/scheduled#deleting-a-schedule)
...
See [the SDK reference](https://trigger.dev/docs/management/schedules/delete)
 for full details.

### 

[​](https://trigger.dev/docs/tasks/scheduled#getting-possible-timezones)
...
See [the SDK reference](https://trigger.dev/docs/management/schedules/timezones)
 for full details.
...
[Previous](https://trigger.dev/docs/tasks/schemaTask)
[TriggeringTasks need to be triggered in order to run.\
\
Next](https://trigger.dev/docs/triggering)
