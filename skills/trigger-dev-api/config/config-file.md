...
[​](https://trigger.dev/docs/config/config-file#dirs)
...
[​](https://trigger.dev/docs/config/config-file#custom-tsconfig-path)
...
[​](https://trigger.dev/docs/config/config-file#lifecycle-functions)
...
[​](https://trigger.dev/docs/config/config-file#instrumentations)

Instrumentations
-------------------------------------------------------------------------------------

We use OpenTelemetry (OTEL) for our run logs. This means you get a lot of information about your tasks with no effort. But you probably want to add more information to your logs. For example, here’s all the Prisma calls automatically logged: ![The run log](https://mintcdn.com/trigger/uys6iMwf9B_ojh8r/images/auto-instrumentation.png?w=2500&fit=max&auto=format&n=uys6iMwf9B_ojh8r&q=85&s=b161da0f8c3c970e234e7574c0042951) Here we add Prisma and OpenAI instrumentations to your `trigger.config.ts` file.
...
There is a [huge library of instrumentations](https://opentelemetry.io/ecosystem/registry/?language=js)
 you can easily add to your project like this. Some ones we recommend:
...
[​](https://trigger.dev/docs/config/config-file#telemetry-exporters)

Telemetry Exporters

You can also configure custom telemetry exporters to send your traces, logs, and metrics to other external services. For example, you can send your logs to [Axiom](https://axiom.co/docs/guides/opentelemetry-nodejs#exporter-instrumentation-ts)
. First, add the opentelemetry exporter packages to your package.json file:
...
See our [Bun guide](https://trigger.dev/docs/guides/frameworks/bun)
 for more information.

### 

[​](https://trigger.dev/docs/config/config-file#node-js-versions)
...
[​](https://trigger.dev/docs/config/config-file#v3)
...
[​](https://trigger.dev/docs/config/config-file#v4)
...
[​](https://trigger.dev/docs/config/config-file#default-machine)
...
See our [machines documentation](https://trigger.dev/docs/machines)
 for more information.

[​](https://trigger.dev/docs/config/config-file#log-level)
...
[​](https://trigger.dev/docs/config/config-file#console-logging)
...
[​](https://trigger.dev/docs/config/config-file#max-duration)
...
[​](https://trigger.dev/docs/config/config-file#ttl)
...
You can override this on a per-task basis by setting `ttl` on the task definition, or per-trigger by passing `ttl` in the trigger options. To opt a specific task out of the config-level TTL, set `ttl: 0` on the task. See [Time-to-live (TTL)](https://trigger.dev/docs/runs#time-to-live-ttl)
 for more information.

[​](https://trigger.dev/docs/config/config-file#process-keep-alive)
...
[​](https://trigger.dev/docs/config/config-file#development-behavior)
...
[​](https://trigger.dev/docs/config/config-file#ca-certificates)
...
[​](https://trigger.dev/docs/config/config-file#build-configuration)
...
[​](https://trigger.dev/docs/config/config-file#webassembly-wasm-packages)
...
[​](https://trigger.dev/docs/config/config-file#jsx)
...
By default we enabled [esbuild’s automatic JSX runtime](https://esbuild.github.io/content-types/#auto-import-for-jsx)
 which means you don’t need to import `React` in your JSX files. You can disable this by setting `automatic` to `false`. See the [esbuild JSX documentation](https://esbuild.github.io/content-types/#jsx)
 for more information.
...
You can add custom [import conditions](https://esbuild.github.io/api/#conditions)
 to your build using the `conditions` option:
...
[​](https://trigger.dev/docs/config/config-file#additionalfiles)

additionalFiles

See the [additionalFiles documentation](https://trigger.dev/docs/config/extensions/additionalFiles)
 for more information.
...
See the [additionalPackages documentation](https://trigger.dev/docs/config/extensions/additionalPackages)
 for more information.

#### 

[​](https://trigger.dev/docs/config/config-file#emitdecoratormetadata)

`emitDecoratorMetadata`

See the [emitDecoratorMetadata documentation](https://trigger.dev/docs/config/extensions/emitDecoratorMetadata)
 for more information.

#### 

[​](https://trigger.dev/docs/config/config-file#prisma)

Prisma

See the [prismaExtension documentation](https://trigger.dev/docs/config/extensions/prismaExtension)
 for more information.

#### 

[​](https://trigger.dev/docs/config/config-file#syncenvvars)

syncEnvVars

See the [syncEnvVars documentation](https://trigger.dev/docs/config/extensions/syncEnvVars)
 for more information.

#### 

[​](https://trigger.dev/docs/config/config-file#puppeteer)

puppeteer

See the [puppeteer documentation](https://trigger.dev/docs/config/extensions/puppeteer)
 for more information.

#### 

[​](https://trigger.dev/docs/config/config-file#ffmpeg)

ffmpeg

See the [ffmpeg documentation](https://trigger.dev/docs/config/extensions/ffmpeg)
 for more information.

#### 

[​](https://trigger.dev/docs/config/config-file#esbuild-plugins)

esbuild plugins

See the [esbuild plugins documentation](https://trigger.dev/docs/config/extensions/esbuildPlugin)
 for more information.

#### 

[​](https://trigger.dev/docs/config/config-file#aptget)

aptGet

See the [aptGet documentation](https://trigger.dev/docs/config/extensions/aptGet)
 for more information.
...
[Previous](https://trigger.dev/docs/ai-chat/changelog)
[OverviewCustomize how your project is built and deployed to Trigger.dev with build extensions\
\
Next](https://trigger.dev/docs/config/extensions/overview)
