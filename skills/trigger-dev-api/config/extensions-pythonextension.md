...
If you need to execute Python scripts in your Trigger.dev project, you can use the `pythonExtension` build extension via the `@trigger.dev/python` package. First, you’ll need to install the `@trigger.dev/python` package:
...
[​](https://trigger.dev/docs/config/extensions/pythonExtension#adding-python-scripts)
...
[​](https://trigger.dev/docs/config/extensions/pythonExtension#using-requirements-files)
...
[​](https://trigger.dev/docs/config/extensions/pythonExtension#virtual-environments)
...
[​](https://trigger.dev/docs/config/extensions/pythonExtension#streaming-output)
...
[​](https://trigger.dev/docs/config/extensions/pythonExtension#environment-variables)
...
[Previous](https://trigger.dev/docs/config/extensions/prismaExtension)
[playwrightUse the playwright build extension to use Playwright with Trigger.dev\
\
Next](https://trigger.dev/docs/config/extensions/playwright)
