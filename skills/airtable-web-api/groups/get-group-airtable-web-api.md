# Get group - Airtable Web API

- **URL:** https://airtable.com/developers/web/api/get-scim-group
- **Summary:** get`https://airtable.com/scim/v2/Groups/{groupId}` Get a single group as a SCIM Group See SCIM Groups A list of schemas, including at least SCIM's core group schema URI.
...
get`https://airtable.com/scim/v2/Groups/{groupId}`

Get a single group as a [SCIM Group](https://datatracker.ietf.org/doc/html/rfc7643#section-4.2)
 object.
