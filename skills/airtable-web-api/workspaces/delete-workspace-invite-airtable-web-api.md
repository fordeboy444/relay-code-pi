# Delete workspace invite - Airtable Web API

- **URL:** https://airtable.com/developers/web/api/delete-workspace-invite
...
delete`https://api.airtable.com/v0/meta/workspaces/{workspaceId}/invites/{inviteId}`
