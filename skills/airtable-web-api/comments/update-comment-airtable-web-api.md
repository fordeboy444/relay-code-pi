# Update comment - Airtable Web API

- **URL:** https://airtable.com/developers/web/api/update-comment
- **Summary:** patch`https://api.airtable.com/v0/{baseId}/{tableIdOrName}/{recordId}/comments/{rowCommentId}` Updates a comment on a record.
...
patch`https://api.airtable.com/v0/{baseId}/{tableIdOrName}/{recordId}/comments/{rowCommentId}`

Updates a comment on a record. API users can only update comments they have created. [User mentioned](https://airtable.com/developers/web/api/model/user-mentioned)
 is supported.
