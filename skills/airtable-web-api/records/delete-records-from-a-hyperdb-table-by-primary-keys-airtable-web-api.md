# Delete records from a HyperDB table by primary keys - Airtable Web API

- **URL:** https://airtable.com/developers/web/api/hyperdb-delete-records-by-primary-keys
- **Summary:** Delete records from a HyperDB table by primary keys
...
|     |     |
| --- | --- |
| <br>`primaryKeysForDelete` | `array of strings` |
