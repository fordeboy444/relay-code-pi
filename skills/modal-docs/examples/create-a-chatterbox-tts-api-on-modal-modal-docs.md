# Create a Chatterbox TTS API on Modal | Modal Docs

- **URL:** https://modal.com/docs/examples/chatterbox_tts
- **Summary:** This example demonstrates how to deploy a text-to-speech (TTS) API using the open source model Chatterbox Turbo on Modal.
...
Check out [Resemble AI’s website](https://www.resemble.ai/)
 or the [Chatterbox Github](https://github.com/resemble-ai/chatterbox)
...
[Create a Chatterbox TTS API on Modal](https://modal.com/docs/examples/chatterbox_tts#create-a-chatterbox-tts-api-on-modal)
[Setup](https://modal.com/docs/examples/chatterbox_tts#setup)
[Define a container image](https://modal.com/docs/examples/chatterbox_tts#define-a-container-image)
[The TTS model class](https://modal.com/docs/examples/chatterbox_tts#the-tts-model-class)
