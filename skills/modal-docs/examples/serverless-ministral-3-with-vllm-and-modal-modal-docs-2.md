...
- **URL:** https://modal.com/docs/examples/vllm_snapshot
...
[Serverless Ministral 3 with vLLM and Modal](https://modal.com/docs/examples/vllm_snapshot#serverless-ministral-3-with-vllm-and-modal)
[Set up the container image](https://modal.com/docs/examples/vllm_snapshot#set-up-the-container-image)
[Download the Ministral weights](https://modal.com/docs/examples/vllm_snapshot#download-the-ministral-weights)
[Cache with Modal Volumes](https://modal.com/docs/examples/vllm_snapshot#cache-with-modal-volumes)
[Serve Ministral 3 with vLLM](https://modal.com/docs/examples/vllm_snapshot#serve-ministral-3-with-vllm)
[Improve cold start time with snapshots](https://modal.com/docs/examples/vllm_snapshot#improve-cold-start-time-with-snapshots)
[Define the server](https://modal.com/docs/examples/vllm_snapshot#define-the-server)
[Deploy the server](https://modal.com/docs/examples/vllm_snapshot#deploy-the-server)
[Interact with the server](https://modal.com/docs/examples/vllm_snapshot#interact-with-the-server)
[Test the server](https://modal.com/docs/examples/vllm_snapshot#test-the-server)
[Test memory snapshotting](https://modal.com/docs/examples/vllm_snapshot#test-memory-snapshotting)
