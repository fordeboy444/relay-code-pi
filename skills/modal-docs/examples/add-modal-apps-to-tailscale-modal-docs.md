# Add Modal Apps to Tailscale | Modal Docs

- **URL:** https://modal.com/docs/examples/modal_tailscale
- **Summary:** This example demonstrates how to integrate Modal with Tailscale (https://tailscale.com). It outlines the steps to configure Modal containers so that they join the Tailscale network.
...
This example demonstrates how to integrate Modal with Tailscale ([https://tailscale.com](https://tailscale.com/)
...
Install Tailscale and copy custom entrypoint script ([entrypoint.sh](https://github.com/modal-labs/modal-examples/blob/main/10_integrations/tailscale/entrypoint.sh)
...
Packages might not be installed locally. This catches import errors and only attempts imports in the container.
...
[Add Modal Apps to Tailscale](https://modal.com/docs/examples/modal_tailscale#add-modal-apps-to-tailscale)
