# Run OpenCode in a Modal Sandbox | Modal Docs

- **URL:** https://modal.com/docs/examples/opencode_server
- **Summary:** This example demonstrates how to run OpenCode remotely and connect to it from your local terminal or browser.

[View on GitHub](https://github.com/modal-labs/modal-examples/blob/main/13_sandboxes/opencode_server.py)
...
Coding agents are most useful when they have context and tools. By default, this script clones the [Modal examples repo](https://github.com/modal-labs/modal-examples)
 and gives the agent access to your Modal credentials, so it can run and debug examples (including this one!). Meta.
...
Now, we create a [Modal Sandbox](https://modal.com/docs/guide/sandboxes)
 to run our coding agent session. This Sandbox has our environment Image and a password for authentication.
...
. You can create one by heading to the [Secrets Dashboard](https://modal.com/secrets)
 and creating a new “Custom” Secret. Use `OPENCODE_SERVER_PASSWORD` as the key and the password as the value.
...
[Run OpenCode in a Modal Sandbox](https://modal.com/docs/examples/opencode_server#run-opencode-in-a-modal-sandbox)
[Set up OpenCode on Modal](https://modal.com/docs/examples/opencode_server#set-up-opencode-on-modal)
[Clone a GitHub repository](https://modal.com/docs/examples/opencode_server#clone-a-github-repository)
[Grant Modal credentials](https://modal.com/docs/examples/opencode_server#grant-modal-credentials)
[Start the Sandbox](https://modal.com/docs/examples/opencode_server#start-the-sandbox)
[Putting it all together](https://modal.com/docs/examples/opencode_server#putting-it-all-together)
[Command-line options](https://modal.com/docs/examples/opencode_server#command-line-options)
