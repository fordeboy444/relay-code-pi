...
- **Summary:** This example shows you how to run a Streamlit app with modal serve, and then deploy it as a serverless web app.
...
![example streamlit app](https://modal.com/_app/immutable/assets/streamlit.RHfhqFCX.png)
...
[Run and share Streamlit apps](https://modal.com/docs/examples/serve_streamlit#run-and-share-streamlit-apps)
[Define container dependencies](https://modal.com/docs/examples/serve_streamlit#define-container-dependencies)
[Spawning the Streamlit server](https://modal.com/docs/examples/serve_streamlit#spawning-the-streamlit-server)
[Iterate and Deploy](https://modal.com/docs/examples/serve_streamlit#iterate-and-deploy)
