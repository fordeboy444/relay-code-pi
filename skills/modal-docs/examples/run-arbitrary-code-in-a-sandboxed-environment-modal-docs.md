...
- **Summary:** This example demonstrates how to run arbitrary code in multiple languages in a Modal Sandbox.
...
This example demonstrates how to run arbitrary code in multiple languages in a Modal [Sandbox](https://modal.com/docs/guide/sandbox)
.
...
We can now use [`Sandbox.exec`](https://modal.com/docs/reference/modal.Sandbox#exec)
 to run a few different commands in the Sandbox.
...
[Setting up a multi-language environment](https://modal.com/docs/examples/safe_code_execution#setting-up-a-multi-language-environment)
[Running bash, Python, Node.js, Ruby, and PHP in a Sandbox](https://modal.com/docs/examples/safe_code_execution#running-bash-python-nodejs-ruby-and-php-in-a-sandbox)
