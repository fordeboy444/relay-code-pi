...
[Make music with ACE-Step 1.5](https://modal.com/docs/examples/musicgen#make-music-with-ace-step-15)
[Setting up dependencies](https://modal.com/docs/examples/musicgen#setting-up-dependencies)
[Running music generation on Modal](https://modal.com/docs/examples/musicgen#running-music-generation-on-modal)
[Hosting a web UI for the music generator](https://modal.com/docs/examples/musicgen#hosting-a-web-ui-for-the-music-generator)
