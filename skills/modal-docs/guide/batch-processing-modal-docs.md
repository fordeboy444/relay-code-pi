...
The fastest way to submit multiple jobs for asynchronous processing is by invoking a Function with `.spawn_map`. When combined with the [`--detach`](https://modal.com/docs/cli/latest/run)
...
This pattern works best for jobs that store results externally—for example, in a [Modal Volume](https://modal.com/docs/guide/volumes)
, [Cloud Bucket Mount](https://modal.com/docs/guide/cloud-bucket-mounts)
, or your own database\*.

_\* For database connections, consider using [Modal Proxy](https://modal.com/docs/guide/proxy-ips)
 to maintain a static IP across thousands of containers._
...
The recommended way to use Modal Functions within your existing data pipeline is through [deployed Function invocation](https://modal.com/docs/guide/trigger-deployed-functions)
...
[Batch Processing](https://modal.com/docs/guide/batch-processing#batch-processing)
[Background Execution with .spawn_map](https://modal.com/docs/guide/batch-processing#background-execution-with-spawn_map)
[Parallel Processing with .map](https://modal.com/docs/guide/batch-processing#parallel-processing-with-map)
[Integration with Existing Systems](https://modal.com/docs/guide/batch-processing#integration-with-existing-systems)
