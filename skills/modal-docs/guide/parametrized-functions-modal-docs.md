...
- **URL:** https://modal.com/docs/guide/parametrized-functions
...
[Parametrized functions](https://modal.com/docs/guide/parametrized-functions#parametrized-functions)
[Looking up a parametrized function](https://modal.com/docs/guide/parametrized-functions#looking-up-a-parametrized-function)
[Parametrized Web Functions](https://modal.com/docs/guide/parametrized-functions#parametrized-web-functions)
[Using parametrized functions with lifecycle functions](https://modal.com/docs/guide/parametrized-functions#using-parametrized-functions-with-lifecycle-functions)
[Performance](https://modal.com/docs/guide/parametrized-functions#performance)
