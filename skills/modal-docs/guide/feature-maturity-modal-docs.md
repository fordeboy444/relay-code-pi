# Feature Maturity | Modal Docs

- **URL:** https://modal.com/docs/guide/feature-maturity
- **Summary:** New features at Modal evolve through several stages. To help you understand their stability, we use two separate concepts:
...
*   [Release phases](https://modal.com/docs/guide/feature-maturity#release-phases)
     ([Alpha](https://modal.com/docs/guide/feature-maturity#alpha)
    , [Beta](https://modal.com/docs/guide/feature-maturity#beta)
     or [GA](https://modal.com/docs/guide/feature-maturity#general-availability-ga)
    ): signals the stability of a feature’s underlying infrastructure
*   [Experimental SDK](https://modal.com/docs/guide/feature-maturity#experimental-sdk)
    : signals API stability in the code interface
...
*   Join our [Slack community](https://modal.com/slack)
     to discuss with the team and other users
*   Reach out to [support@modal.com](mailto:support@modal.com)
     with specific feedback or bug reports

[Feature Maturity](https://modal.com/docs/guide/feature-maturity#feature-maturity)
[Release Phases](https://modal.com/docs/guide/feature-maturity#release-phases)
[Alpha](https://modal.com/docs/guide/feature-maturity#alpha)
[Beta](https://modal.com/docs/guide/feature-maturity#beta)
[General Availability (GA)](https://modal.com/docs/guide/feature-maturity#general-availability-ga)
[Experimental SDK](https://modal.com/docs/guide/feature-maturity#experimental-sdk)
[SDK Deprecations](https://modal.com/docs/guide/feature-maturity#sdk-deprecations)
[Other interfaces](https://modal.com/docs/guide/feature-maturity#other-interfaces)
[Providing Feedback](https://modal.com/docs/guide/feature-maturity#providing-feedback)
