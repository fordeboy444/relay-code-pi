...
- **Summary:** Control access to Modal Workspaces, Environments, and Web Functions with role-based permissions for Owners, Managers, and Members.
...
Modal [Workspaces](https://modal.com/docs/guide/workspaces)
 organize Modal Apps and other resources for a group of users. These roles control access at the level of the entire Workspace.
...
Modal [Environments](https://modal.com/docs/guide/environments)
 isolate Modal Apps and other resources from one another within a Workspace.
...
1.  **Enable RBAC**: This requires a Team or Enterprise plan. See our [pricing page](https://modal.com/pricing)
     for more information.
    
2.  **Create or restrict an Environment**: To create a new restricted Environment, use [`modal environment create --restricted NAME`](https://modal.com/docs/cli/latest/environment#modal-environment-create)
    . To restrict an existing unrestricted Environment, navigate to your Workspace’s Environment Management page in [Settings](https://modal.com/settings)
    , select the Environment, and click **Make Restricted**.
...
[Service users](https://modal.com/docs/guide/service-users)
 are programmatic identities authenticated with API tokens. They are useful for CI/CD pipelines, deployment bots, and other machine-to-machine communication needs.
...
[Web Functions](https://modal.com/docs/guide/webhooks)
 can be protected with proxy tokens, which authenticate inbound HTTP requests before they reach your function.
...
Restricted Environments prevent app and task identities in other Environments from accessing resources inside the restricted Environment. For more detail, see [Cross-Environment Lookups](https://modal.com/docs/guide/environments#cross-environment-lookups)
.
...
[Role-Based Access Control (RBAC)](https://modal.com/docs/guide/rbac#role-based-access-control-rbac)
[Workspace Roles](https://modal.com/docs/guide/rbac#workspace-roles)
[Environment Roles](https://modal.com/docs/guide/rbac#environment-roles)
[Setting up restricted Environments](https://modal.com/docs/guide/rbac#setting-up-restricted-environments)
[Default access by actor](https://modal.com/docs/guide/rbac#default-access-by-actor)
[Service users and service tokens](https://modal.com/docs/guide/rbac#service-users-and-service-tokens)
[Proxy tokens for Web Functions](https://modal.com/docs/guide/rbac#proxy-tokens-for-web-functions)
[Creating a scoped proxy token](https://modal.com/docs/guide/rbac#creating-a-scoped-proxy-token)
[Scoped vs. workspace-wide tokens](https://modal.com/docs/guide/rbac#scoped-vs-workspace-wide-tokens)
[Cross-Environment access](https://modal.com/docs/guide/rbac#cross-environment-access)
[Cross-Environment behavior for app and task identities](https://modal.com/docs/guide/rbac#cross-environment-behavior-for-app-and-task-identities)
[Example: inbound vs. outbound access](https://modal.com/docs/guide/rbac#example-inbound-vs-outbound-access)
[Protecting production secrets with restricted Environments](https://modal.com/docs/guide/rbac#protecting-production-secrets-with-restricted-environments)
[Common access patterns](https://modal.com/docs/guide/rbac#common-access-patterns)
[FAQ](https://modal.com/docs/guide/rbac#faq)
