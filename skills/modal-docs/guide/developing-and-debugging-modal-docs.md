...
- **URL:** https://modal.com/docs/guide/developing-debugging
- **Summary:** Modal makes it easy to run apps in the cloud, try code changes in the cloud, and debug remotely executing code as if it were right there on your laptop. To speed boost your inner dev loop, this guide provides a rundown of tools and techniques for developing and debugging software in Modal.
...
For a more interesting example, you can [`pip_install("ipython")`](https://modal.com/docs/sdk/py/latest/modal.Image#pip_install)
...
Modal also lets you run interactive commands on your running Containers from the terminal — much like `ssh`\-ing into a traditional machine or cloud VM.

To run a command inside a running Container, you first need to get the Container ID. You can view all running Containers and their Container IDs with [`modal container list`](https://modal.com/docs/cli/latest/container)
.
...
You can also launch an interactive shell in a new Container with the same environment as your Function. This is handy for debugging issues with your Image, interactively refining build commands, and exploring the contents of [`Volume`](https://modal.com/docs/sdk/py/latest/modal.Volume)
s and [`NetworkFileSystem`](https://modal.com/docs/sdk/py/latest/modal.NetworkFileSystem)
s.

The primary interface for accessing this feature is the [`modal shell`](https://modal.com/docs/cli/latest/shell)
 CLI command, which accepts a Function name in your App (or prompts you to select one, if none is provided), and runs an interactive command on the same image as the Function, with the same [`Secret`](https://modal.com/docs/sdk/py/latest/modal.Secret)
s and [`NetworkFileSystem`](https://modal.com/docs/sdk/py/latest/modal.NetworkFileSystem)
...
Live updating works with Web Functions, syncing your changes as you make them, and it also works well with cron schedules and job queues.
...
To enable debug logs in the Modal client running in the remote container, you can set `MODAL_LOGLEVEL` using a Modal [`Secret`](https://modal.com/docs/sdk/py/latest/modal.Secret)
.
...
To see a traceback (a.k.a [stack trace](https://en.wikipedia.org/wiki/Stack_trace)
) for a client-side exception, you can set the `MODAL_TRACEBACK` environment variable to `1`.
...
[Interactivity](https://modal.com/docs/guide/developing-debugging#interactivity)
[Interactive functions](https://modal.com/docs/guide/developing-debugging#interactive-functions)
[Debugging Running Containers](https://modal.com/docs/guide/developing-debugging#debugging-running-containers)
[Debug Shells](https://modal.com/docs/guide/developing-debugging#debug-shells)
[modal container exec](https://modal.com/docs/guide/developing-debugging#modal-container-exec)
[Live container profiling](https://modal.com/docs/guide/developing-debugging#live-container-profiling)
[Debugging Container Images](https://modal.com/docs/guide/developing-debugging#debugging-container-images)
[Live updating](https://modal.com/docs/guide/developing-debugging#live-updating)
[Hot reloading with modal serve](https://modal.com/docs/guide/developing-debugging#hot-reloading-with-modal-serve)
[Observability](https://modal.com/docs/guide/developing-debugging#observability)
[Debug logs](https://modal.com/docs/guide/developing-debugging#debug-logs)
[Client tracebacks](https://modal.com/docs/guide/developing-debugging#client-tracebacks)
