# Global variables | Modal Docs

- **URL:** https://modal.com/docs/guide/global-variables
- **Summary:** Handle global variables and data in Modal Functions using modal.is_local to differentiate local and cloud execution.
...
For instance, to create a [`modal.Secret`](https://modal.com/docs/guide/secrets)
...
[Global variables](https://modal.com/docs/guide/global-variables#global-variables)
[Warning about regular module globals](https://modal.com/docs/guide/global-variables#warning-about-regular-module-globals)
