# Configuring CPU, memory, and disk | Modal Docs

- **URL:** https://modal.com/docs/guide/resources
- **Summary:** Request specific CPU cores and memory for Modal containers. Configure resource limits for compute-intensive workloads.
...
This guide covers resource configuration for both [Functions](https://modal.com/docs/guide/apps#apps-functions-and-entrypoints)
 and [Sandboxes](https://modal.com/docs/guide/sandboxes)
. For Sandbox-specific guidance on pricing and cost optimization, see [Sandbox pricing and resources](https://modal.com/docs/guide/sandbox-resources)
.
...
For both CPU and memory, a maximum is enforced at Function or Sandbox creation time to ensure your containers can be scheduled for execution. Requests exceeding the maximum will be rejected with an [`InvalidError`](https://modal.com/docs/sdk/py/latest/modal.exception#modalexceptioninvaliderror)
.
...
Specify this limit using the `memory` parameter on [`@app.function()`](https://modal.com/docs/sdk/py/latest/modal.App#function)
 or [`Sandbox.create()`](https://modal.com/docs/sdk/py/latest/modal.Sandbox#create)
:
...
Increased disk sizes can be requested with the `ephemeral_disk` parameter on [`@app.function()`](https://modal.com/docs/sdk/py/latest/modal.App#function)
. The maximum disk size is 3.0 TiB (3,145,728 MiB). Larger disks are intended to be used for [dataset processing](https://modal.com/docs/guide/dataset-ingestion)
.

[Configuring CPU, memory, and disk](https://modal.com/docs/guide/resources#configuring-cpu-memory-and-disk)
[CPU cores](https://modal.com/docs/guide/resources#cpu-cores)
[Memory](https://modal.com/docs/guide/resources#memory)
[How much can I request?](https://modal.com/docs/guide/resources#how-much-can-i-request)
[Billing](https://modal.com/docs/guide/resources#billing)
[Resource limits](https://modal.com/docs/guide/resources#resource-limits)
[CPU limits](https://modal.com/docs/guide/resources#cpu-limits)
[Memory limits](https://modal.com/docs/guide/resources#memory-limits)
[Disk limits](https://modal.com/docs/guide/resources#disk-limits)

See it in action

[Sandbox pricing and resources](https://modal.com/docs/guide/sandbox-resources)
