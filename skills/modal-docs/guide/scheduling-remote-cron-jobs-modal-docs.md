...
- **Summary:** A common requirement is to perform some task at a given time every day or week automatically. Modal facilitates this through function schedules.
...
There are two kinds of base schedule values - [`modal.Period`](https://modal.com/docs/sdk/py/latest/modal.Period)
 and [`modal.Cron`](https://modal.com/docs/sdk/py/latest/modal.Cron)
.

[`modal.Period`](https://modal.com/docs/sdk/py/latest/modal.Period)
...
[`modal.Cron`](https://modal.com/docs/sdk/py/latest/modal.Cron)
...
For more details, see the API reference for [Period](https://modal.com/docs/sdk/py/latest/modal.Period)
, [Cron](https://modal.com/docs/sdk/py/latest/modal.Cron)
 and [Function](https://modal.com/docs/sdk/py/latest/modal.Function)

[Scheduling remote cron jobs](https://modal.com/docs/guide/cron#scheduling-remote-cron-jobs)
[Basic scheduling](https://modal.com/docs/guide/cron#basic-scheduling)
[Monitoring your scheduled runs](https://modal.com/docs/guide/cron#monitoring-your-scheduled-runs)
[Schedule types](https://modal.com/docs/guide/cron#schedule-types)

See it in action

[Hacker News Slackbot](https://modal.com/docs/examples/hackernews_alerts)
