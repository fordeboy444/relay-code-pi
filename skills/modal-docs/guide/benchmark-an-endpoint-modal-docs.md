# Benchmark an endpoint | Modal Docs

- **URL:** https://modal.com/docs/guide/endpoint-benchmarks
- **Summary:** Live metrics tell you how an endpoint behaves under whatever traffic it happens to be getting. A benchmark tells you how it behaves under a known, repeatable load — so you can compare models, regions, and configurations on an apples-to-apples basis.
...
[Benchmark an endpoint](https://modal.com/docs/guide/endpoint-benchmarks#benchmark-an-endpoint)
[Workload patterns](https://modal.com/docs/guide/endpoint-benchmarks#workload-patterns)
[Endpoint preview benchmarks](https://modal.com/docs/guide/endpoint-benchmarks#endpoint-preview-benchmarks)
[Caveats](https://modal.com/docs/guide/endpoint-benchmarks#caveats)
