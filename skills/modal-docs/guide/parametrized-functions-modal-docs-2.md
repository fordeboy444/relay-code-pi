# Parametrized functions | Modal Docs

- **URL:** https://modal.com/docs/guide/parameterized-functions
- **Summary:** A single Modal Function can be parametrized by a set of arguments, so that each unique combination of arguments will behave like an individual Modal Function with its own auto-scaling and lifecycle logic.
...
To parametrize a Modal Function, you need to use Modal’s [class syntax](https://modal.com/docs/guide/lifecycle-functions)
 and the [`@app.cls`](https://modal.com/docs/sdk/py/latest/modal.App#cls)
 decorator. Specifically, you’ll need to:

1.  Convert your function to a method by making it a member of a class.
2.  Decorate the class with `@app.cls(...)` with the same arguments you previously had for `@app.function(...)` or your [Web Function decorator](https://modal.com/docs/guide/webhooks)
    .
...
For example, here is how you might parametrize the [`@modal.enter`](https://modal.com/docs/guide/lifecycle-functions#enter)
...
Currently, parametrized Function creation is rate limited to 1 per second, with the ability to burst to 1000. Please [get in touch](mailto:support@modal.com)
 if you need higher rate limits.

[Parametrized functions](https://modal.com/docs/guide/parameterized-functions#parametrized-functions)
[Looking up a parametrized function](https://modal.com/docs/guide/parameterized-functions#looking-up-a-parametrized-function)
[Parametrized Web Functions](https://modal.com/docs/guide/parameterized-functions#parametrized-web-functions)
[Using parametrized functions with lifecycle functions](https://modal.com/docs/guide/parameterized-functions#using-parametrized-functions-with-lifecycle-functions)
[Performance](https://modal.com/docs/guide/parameterized-functions#performance)
