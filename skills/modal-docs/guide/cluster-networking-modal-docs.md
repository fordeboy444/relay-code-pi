# Cluster networking | Modal Docs

- **URL:** https://modal.com/docs/guide/private-networking
- **Summary:** Enable low-latency, high-bandwidth (50+ Gbps) private networking between Modal containers for distributed workloads.
...
In this snippet we see that the i6pn-enabled container is able to retrieve its own IPv6 address by resolving `i6pn.modal.local`. For this Function container to discover the addresses of _other_ containers, address sharing must be implemented using an auxiliary data structure, such as a shared `modal.Dict` or `modal.Queue`.
...
Modal operates a [global fleet](https://modal.com/docs/guide/region-selection)
...
For cluster networked containers that need to be publicly accessible, you need to expose ports with [modal.Tunnel](https://modal.com/docs/guide/tunnels)
...
[Cluster networking](https://modal.com/docs/guide/private-networking#cluster-networking)
[Private networking](https://modal.com/docs/guide/private-networking#private-networking)
[Region boundaries](https://modal.com/docs/guide/private-networking#region-boundaries)
[Public network access to cluster networking](https://modal.com/docs/guide/private-networking#public-network-access-to-cluster-networking)
