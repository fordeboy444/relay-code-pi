...
- **URL:** https://modal.com/docs/guide/sdk-javascript-go
- **Summary:** Interact with Modal Sandboxes and call deployed Modal Functions from JS and Go codebases
...
For installation instructions, see the READMEs for [JavaScript](https://github.com/modal-labs/modal-client/tree/main/js)
 and [Go](https://github.com/modal-labs/modal-client/tree/main/go)
 on GitHub.

JavaScript/TypeScript 

The `modal` package is [distributed via npm](https://www.npmjs.org/package/modal)
. See the [JS API reference documentation](https://modal-labs.github.io/libmodal/)
 for details.
...
The `modal-go` package is [installed via go get](https://pkg.go.dev/github.com/modal-labs/modal-client/go)
. See the [Go API reference documentation](https://pkg.go.dev/github.com/modal-labs/modal-client/go#section-documentation)
 for details.
...
[Modal SDKs for JavaScript and Go](https://modal.com/docs/guide/sdk-javascript-go#modal-sdks-for-javascript-and-go)
[Installation](https://modal.com/docs/guide/sdk-javascript-go#installation)
[JavaScript/TypeScript](https://modal.com/docs/guide/sdk-javascript-go#javascripttypescript)
[Simple JavaScript Example](https://modal.com/docs/guide/sdk-javascript-go#simple-javascript-example)
[Go](https://modal.com/docs/guide/sdk-javascript-go#go)
[Simple Go Example](https://modal.com/docs/guide/sdk-javascript-go#simple-go-example)
[Support](https://modal.com/docs/guide/sdk-javascript-go#support)
