# Sandbox resources and pricing | Modal Docs

- **URL:** https://modal.com/docs/guide/sandbox-resources
- **Summary:** Configure CPU, memory, and other resources for Modal Sandboxes. Modal's usage based pricing and ability to burst beyond requests enable cost-efficient resource allocation.
...
This page covers resource configuration and pricing for Modal Sandboxes. For general documentation on CPU and memory options, see [Reserving CPU and memory](https://modal.com/docs/guide/resources)
.
...
See [Billing](https://modal.com/docs/guide/resources#billing)
 in the resource guide for more details.
...
For details on default values and maximum limits, see [Reserving CPU and memory](https://modal.com/docs/guide/resources)
.
...
See [Resource limits](https://modal.com/docs/guide/resources#resource-limits)
 for details on how CPU and memory limits behave.
...
2.  Run your typical workload and observe actual resource usage in the [Modal dashboard](https://modal.com/apps)
     to understand your baseline needs.
...
You can also run Sandboxes with GPUs. See [GPU acceleration](https://modal.com/docs/guide/gpu)
 for available GPU types and configuration.

Unlike CPU Sandboxes, GPU Sandboxes are subject to [preemption](https://modal.com/docs/guide/preemption)
. Design your GPU workloads to handle interruptions gracefully.

Additional resources 

*   [Sandbox pricing](https://modal.com/pricing#sandboxes)
    : current pricing for Sandboxes
...
*   [Billing](https://modal.com/docs/guide/billing)
    : billing cycles, budgets, and cost attribution

[Sandbox resources and pricing](https://modal.com/docs/guide/sandbox-resources#sandbox-resources-and-pricing)
[Pay for what you use](https://modal.com/docs/guide/sandbox-resources#pay-for-what-you-use)
[Configuring resources](https://modal.com/docs/guide/sandbox-resources#configuring-resources)
[Resource limits](https://modal.com/docs/guide/sandbox-resources#resource-limits)
[Tuning your requests](https://modal.com/docs/guide/sandbox-resources#tuning-your-requests)
[GPU Sandboxes](https://modal.com/docs/guide/sandbox-resources#gpu-sandboxes)
[Additional resources](https://modal.com/docs/guide/sandbox-resources#additional-resources)

See it in action

[Reserving CPU and memory](https://modal.com/docs/guide/resources)

[Sandboxes overview](https://modal.com/docs/guide/sandboxes)
