...
- **URL:** https://modal.com/docs/sdk/py/latest/modal.Sandbox
- **Summary:** A Sandbox object lets you interact with a running sandbox. This API is similar to Python’s asyncio.subprocess.Process.
...
Refer to the [guide](https://modal.com/docs/guide/sandbox)
...
If True, the sandbox will receive a MODAL_IDENTITY_TOKEN env var for OIDC-based auth. (Default is False)
...
experimental_options dict\[str, Any\] | None

Experimental options to pass to the sandbox.

_experimental_enable_snapshot bool
...
_DEPRECATED_ Optionally override the default environment

pty_info api_pb2.PTYInfo | None

_DEPRECATED_ Use `pty` instead. `pty` will override `pty_info`.

cidr_allowlist Sequence\[str\] | None

_DEPRECATED_ Use outbound_cidr_allowlist instead.
...
An [`Image`](https://modal.com/docs/sdk/py/latest/modal.Image)
...
`timeout` If the snapshot does not return within that window, the call is cancelled and `modal.exception.TimeoutError` is raised.
...
NOTE: Previous to client [v0.64.153](https://modal.com/docs/sdk/py/changelog#064153-2024-09-30)
...
_pty_info api_pb2.PTYInfo | None

_DEPRECATED_ Use `pty` instead. `pty` will override `_pty_info`.
...
[modal.Sandbox](https://modal.com/docs/sdk/py/latest/modal.Sandbox#modalsandbox)
[hydrate](https://modal.com/docs/sdk/py/latest/modal.Sandbox#hydrate)
[create](https://modal.com/docs/sdk/py/latest/modal.Sandbox#create)
[detach](https://modal.com/docs/sdk/py/latest/modal.Sandbox#detach)
[from_name](https://modal.com/docs/sdk/py/latest/modal.Sandbox#from_name)
[from_id](https://modal.com/docs/sdk/py/latest/modal.Sandbox#from_id)
[get_tags](https://modal.com/docs/sdk/py/latest/modal.Sandbox#get_tags)
[set_tags](https://modal.com/docs/sdk/py/latest/modal.Sandbox#set_tags)
[snapshot_filesystem](https://modal.com/docs/sdk/py/latest/modal.Sandbox#snapshot_filesystem)
[mount_image](https://modal.com/docs/sdk/py/latest/modal.Sandbox#mount_image)
[unmount_image](https://modal.com/docs/sdk/py/latest/modal.Sandbox#unmount_image)
[snapshot_directory](https://modal.com/docs/sdk/py/latest/modal.Sandbox#snapshot_directory)
[wait](https://modal.com/docs/sdk/py/latest/modal.Sandbox#wait)
[wait_until_ready](https://modal.com/docs/sdk/py/latest/modal.Sandbox#wait_until_ready)
[tunnels](https://modal.com/docs/sdk/py/latest/modal.Sandbox#tunnels)
[create_connect_token](https://modal.com/docs/sdk/py/latest/modal.Sandbox#create_connect_token)
[reload_volumes](https://modal.com/docs/sdk/py/latest/modal.Sandbox#reload_volumes)
[terminate](https://modal.com/docs/sdk/py/latest/modal.Sandbox#terminate)
[poll](https://modal.com/docs/sdk/py/latest/modal.Sandbox#poll)
[exec](https://modal.com/docs/sdk/py/latest/modal.Sandbox#exec)
[filesystem](https://modal.com/docs/sdk/py/latest/modal.Sandbox#filesystem)
[copy_from_local](https://modal.com/docs/sdk/py/latest/modal.Sandbox#filesystemcopy_from_local)
[copy_to_local](https://modal.com/docs/sdk/py/latest/modal.Sandbox#filesystemcopy_to_local)
[list_files](https://modal.com/docs/sdk/py/latest/modal.Sandbox#filesystemlist_files)
[make_directory](https://modal.com/docs/sdk/py/latest/modal.Sandbox#filesystemmake_directory)
[read_bytes](https://modal.com/docs/sdk/py/latest/modal.Sandbox#filesystemread_bytes)
[read_text](https://modal.com/docs/sdk/py/latest/modal.Sandbox#filesystemread_text)
[remove](https://modal.com/docs/sdk/py/latest/modal.Sandbox#filesystemremove)
[stat](https://modal.com/docs/sdk/py/latest/modal.Sandbox#filesystemstat)
[watch](https://modal.com/docs/sdk/py/latest/modal.Sandbox#filesystemwatch)
[write_bytes](https://modal.com/docs/sdk/py/latest/modal.Sandbox#filesystemwrite_bytes)
[write_text](https://modal.com/docs/sdk/py/latest/modal.Sandbox#filesystemwrite_text)
[open](https://modal.com/docs/sdk/py/latest/modal.Sandbox#open)
[ls](https://modal.com/docs/sdk/py/latest/modal.Sandbox#ls)
[mkdir](https://modal.com/docs/sdk/py/latest/modal.Sandbox#mkdir)
[rm](https://modal.com/docs/sdk/py/latest/modal.Sandbox#rm)
[watch](https://modal.com/docs/sdk/py/latest/modal.Sandbox#watch)
[stdout](https://modal.com/docs/sdk/py/latest/modal.Sandbox#stdout)
[stderr](https://modal.com/docs/sdk/py/latest/modal.Sandbox#stderr)
[stdin](https://modal.com/docs/sdk/py/latest/modal.Sandbox#stdin)
[returncode](https://modal.com/docs/sdk/py/latest/modal.Sandbox#returncode)
[list](https://modal.com/docs/sdk/py/latest/modal.Sandbox#list)
