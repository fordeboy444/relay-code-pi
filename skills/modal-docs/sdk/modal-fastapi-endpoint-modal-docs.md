...
- **URL:** https://modal.com/docs/sdk/py/latest/modal.fastapi_endpoint
...
[modal.fastapi_endpoint](https://modal.com/docs/sdk/py/latest/modal.fastapi_endpoint#modalfastapi_endpoint)
