...
- **URL:** https://modal.com/docs/sdk/py/latest/modal.Cron
- **Summary:** Cron jobs are a type of schedule, specified using the Unix cron tab syntax.
...
Cron jobs are a type of schedule, specified using the [Unix cron tab](https://crontab.guru/)
 syntax.
...
[modal.Cron](https://modal.com/docs/sdk/py/latest/modal.Cron#modalcron)
