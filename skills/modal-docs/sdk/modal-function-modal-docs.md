...
- **URL:** https://modal.com/docs/sdk/py/latest/modal.Function
- **Summary:** Functions are the basic units of serverless execution on Modal.
...
Note that options cannot be “unset” with this method (i.e., if a GPU is configured in the `@app.cls()` decorator, passing `gpu=None` here will not create a CPU-only instance). Additionally, container arguments like `volumes` and `secrets` will _replace_ the base configuration or any previous use of this method rather than extending it.
...
Returns a new Function instance that is dynamically configured to behave like a Function using the `@modal.concurrent` decorator. This instance will autoscale independently from the base Function.
...
Returns a new Function instance that is dynamically configured to behave like a Function using the `@modal.batched` decorator. This instance will autoscale independently from the base Function.
...
A [`modal.FunctionCall`](https://modal.com/docs/sdk/py/latest/modal.FunctionCall)
 object that can later be polled or waited for using [`.get(timeout=...)`](https://modal.com/docs/sdk/py/latest/modal.FunctionCall#get)
.
...
[modal.Function](https://modal.com/docs/sdk/py/latest/modal.Function#modalfunction)
[hydrate](https://modal.com/docs/sdk/py/latest/modal.Function#hydrate)
[update_autoscaler](https://modal.com/docs/sdk/py/latest/modal.Function#update_autoscaler)
[from_name](https://modal.com/docs/sdk/py/latest/modal.Function#from_name)
[get_web_url](https://modal.com/docs/sdk/py/latest/modal.Function#get_web_url)
[with_options](https://modal.com/docs/sdk/py/latest/modal.Function#with_options)
[with_concurrency](https://modal.com/docs/sdk/py/latest/modal.Function#with_concurrency)
[with_batching](https://modal.com/docs/sdk/py/latest/modal.Function#with_batching)
[remote](https://modal.com/docs/sdk/py/latest/modal.Function#remote)
[remote_gen](https://modal.com/docs/sdk/py/latest/modal.Function#remote_gen)
[local](https://modal.com/docs/sdk/py/latest/modal.Function#local)
[spawn](https://modal.com/docs/sdk/py/latest/modal.Function#spawn)
[get_raw_f](https://modal.com/docs/sdk/py/latest/modal.Function#get_raw_f)
[get_current_stats](https://modal.com/docs/sdk/py/latest/modal.Function#get_current_stats)
[map](https://modal.com/docs/sdk/py/latest/modal.Function#map)
[starmap](https://modal.com/docs/sdk/py/latest/modal.Function#starmap)
[for_each](https://modal.com/docs/sdk/py/latest/modal.Function#for_each)
[spawn_map](https://modal.com/docs/sdk/py/latest/modal.Function#spawn_map)
