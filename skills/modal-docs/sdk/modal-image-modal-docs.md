...
- **URL:** https://modal.com/docs/sdk/py/latest/modal.Image
- **Summary:** Base class for container images to run functions in.
...
Set `copy=True` to copy the files into an Image layer at build time instead, similar to how [`COPY`](https://docs.docker.com/engine/reference/builder/#copy)
...
Patterns or callable controlling which files to exclude. (Default is NON_PYTHON_FILES)
...
For defining Modal functions, images are built automatically when deploying or running an App. You do not need to build the image explicitly in that case.
...
Poetry will be installed to the Image (using pip) unless `poetry_version` is set to None. Note that the interpretation of `poetry_version="latest"` depends on the Modal Image Builder version, with versions 2024.10 and earlier limiting poetry to 1.x.
...
NOTE: This does _not_ install the project itself into the environment (this is equivalent to the `--no-install-project` flag in the `uv sync` command) and you would be expected to add any local python source files using `Image.add_local_python_source` or similar methods after this call.
...
Ignore rules for the implicit context mount (defaults to auto `.dockerignore` behavior). (Default is AUTO_DOCKERIGNORE)
...
You will need to pass a `modal.Secret` containing [your GCP service account key data](https://cloud.google.com/iam/docs/keys-create-delete#creating)
 as `SERVICE_ACCOUNT_JSON`. This can be done from the [Secrets](https://modal.com/secrets)
 page. Your service account should be granted a specific role depending on the GCP registry used:

*   For Artifact Registry images (`pkg.dev` domains) use the [“Artifact Registry Reader”](https://cloud.google.com/artifact-registry/docs/access-control#roles)
     role
*   For Container Registry images (`gcr.io` domains) use the [“Storage Object Viewer”](https://cloud.google.com/artifact-registry/docs/transition/setup-gcr-repo)
     role
...
You will need to pass a `modal.Secret` containing either IAM user credentials or OIDC configuration to access the target ECR registry.
...
Note that since this Image doesn’t contain Python or other standard OS utilities, higher-level Image build steps like `pip_install` cannot be chained onto it. It also cannot be used for `modal.Function` execution, which requires a Python interpreter.
...
[modal.Image](https://modal.com/docs/sdk/py/latest/modal.Image#modalimage)
[add_local_file](https://modal.com/docs/sdk/py/latest/modal.Image#add_local_file)
[add_local_dir](https://modal.com/docs/sdk/py/latest/modal.Image#add_local_dir)
[add_local_python_source](https://modal.com/docs/sdk/py/latest/modal.Image#add_local_python_source)
[from_id](https://modal.com/docs/sdk/py/latest/modal.Image#from_id)
[build](https://modal.com/docs/sdk/py/latest/modal.Image#build)
[pip_install](https://modal.com/docs/sdk/py/latest/modal.Image#pip_install)
[pip_install_private_repos](https://modal.com/docs/sdk/py/latest/modal.Image#pip_install_private_repos)
[pip_install_from_requirements](https://modal.com/docs/sdk/py/latest/modal.Image#pip_install_from_requirements)
[pip_install_from_pyproject](https://modal.com/docs/sdk/py/latest/modal.Image#pip_install_from_pyproject)
[uv_pip_install](https://modal.com/docs/sdk/py/latest/modal.Image#uv_pip_install)
[poetry_install_from_file](https://modal.com/docs/sdk/py/latest/modal.Image#poetry_install_from_file)
[uv_sync](https://modal.com/docs/sdk/py/latest/modal.Image#uv_sync)
[dockerfile_commands](https://modal.com/docs/sdk/py/latest/modal.Image#dockerfile_commands)
[entrypoint](https://modal.com/docs/sdk/py/latest/modal.Image#entrypoint)
[shell](https://modal.com/docs/sdk/py/latest/modal.Image#shell)
[run_commands](https://modal.com/docs/sdk/py/latest/modal.Image#run_commands)
[micromamba](https://modal.com/docs/sdk/py/latest/modal.Image#micromamba)
[micromamba_install](https://modal.com/docs/sdk/py/latest/modal.Image#micromamba_install)
[from_registry](https://modal.com/docs/sdk/py/latest/modal.Image#from_registry)
[from_gcp_artifact_registry](https://modal.com/docs/sdk/py/latest/modal.Image#from_gcp_artifact_registry)
[from_aws_ecr](https://modal.com/docs/sdk/py/latest/modal.Image#from_aws_ecr)
[from_dockerfile](https://modal.com/docs/sdk/py/latest/modal.Image#from_dockerfile)
[from_scratch](https://modal.com/docs/sdk/py/latest/modal.Image#from_scratch)
[debian_slim](https://modal.com/docs/sdk/py/latest/modal.Image#debian_slim)
[apt_install](https://modal.com/docs/sdk/py/latest/modal.Image#apt_install)
[run_function](https://modal.com/docs/sdk/py/latest/modal.Image#run_function)
[env](https://modal.com/docs/sdk/py/latest/modal.Image#env)
[workdir](https://modal.com/docs/sdk/py/latest/modal.Image#workdir)
[cmd](https://modal.com/docs/sdk/py/latest/modal.Image#cmd)
[pipe](https://modal.com/docs/sdk/py/latest/modal.Image#pipe)
[imports](https://modal.com/docs/sdk/py/latest/modal.Image#imports)
[from_name](https://modal.com/docs/sdk/py/latest/modal.Image#from_name)
[publish](https://modal.com/docs/sdk/py/latest/modal.Image#publish)
