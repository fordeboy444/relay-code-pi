# modal.batched | Modal Docs

- **URL:** https://modal.com/docs/sdk/py/latest/modal.batched
- **Summary:** Decorator for functions or class methods that should be batched.
...
See the [dynamic batching guide](https://modal.com/docs/guide/dynamic-batching)
...
[modal.batched](https://modal.com/docs/sdk/py/latest/modal.batched#modalbatched)
