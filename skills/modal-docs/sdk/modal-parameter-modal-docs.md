...
- **URL:** https://modal.com/docs/sdk/py/latest/modal.parameter
- **Summary:** Used to specify options for modal.cls parameters, similar to dataclass.field for dataclasses
...
[modal.parameter](https://modal.com/docs/sdk/py/latest/modal.parameter#modalparameter)
