...
- **URL:** https://modal.com/docs/sdk/py/latest/modal.Server
- **Summary:** Server runs an HTTP server started in an @modal.enter method.
...
Generally, you will not construct a Server directly. Instead, use the [`@app.server()`](https://modal.com/docs/sdk/py/latest/modal.App#server)
 decorator.
...
[modal.Server](https://modal.com/docs/sdk/py/latest/modal.Server#modalserver)
[object_id](https://modal.com/docs/sdk/py/latest/modal.Server#object_id)
[get_url](https://modal.com/docs/sdk/py/latest/modal.Server#get_url)
[update_autoscaler](https://modal.com/docs/sdk/py/latest/modal.Server#update_autoscaler)
[hydrate](https://modal.com/docs/sdk/py/latest/modal.Server#hydrate)
[from_name](https://modal.com/docs/sdk/py/latest/modal.Server#from_name)
