# modal.concurrent | Modal Docs

- **URL:** https://modal.com/docs/sdk/py/latest/modal.concurrent
- **Summary:** Decorator that allows individual containers to handle multiple inputs concurrently.
...
[modal.concurrent](https://modal.com/docs/sdk/py/latest/modal.concurrent#modalconcurrent)
