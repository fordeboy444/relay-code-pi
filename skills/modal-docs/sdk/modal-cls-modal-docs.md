...
- **URL:** https://modal.com/docs/sdk/py/latest/modal.Cls
- **Summary:** Cls adds method pooling and lifecycle hook behavior to modal.Function.
...
Cls adds method pooling and [lifecycle hook](https://modal.com/docs/guide/lifecycle-functions)
 behavior to [modal.Function](https://modal.com/docs/sdk/py/latest/modal.Function)
.

Generally, you will not construct a Cls directly. Instead, use the [`@app.cls()`](https://modal.com/docs/sdk/py/latest/modal.App#cls)
...
[modal.Cls](https://modal.com/docs/sdk/py/latest/modal.Cls#modalcls)
[hydrate](https://modal.com/docs/sdk/py/latest/modal.Cls#hydrate)
[from_name](https://modal.com/docs/sdk/py/latest/modal.Cls#from_name)
[with_options](https://modal.com/docs/sdk/py/latest/modal.Cls#with_options)
[with_concurrency](https://modal.com/docs/sdk/py/latest/modal.Cls#with_concurrency)
[with_batching](https://modal.com/docs/sdk/py/latest/modal.Cls#with_batching)
