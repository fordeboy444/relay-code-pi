...
- **URL:** https://modal.com/docs/sdk/py/latest/modal.App
- **Summary:** A Modal App is a group of functions and classes that are deployed together.
...
Note that you should not invoke this in global scope of a file where you have Modal Functions or Classes defined, since that would run the block when the Function or Cls is imported in your containers as well. If you want to run it as your entrypoint, consider protecting it with `if __name__ == "__main__"`.
...
Note that an explicit [`app.run()`](https://modal.com/docs/sdk/py/latest/modal.App#run)
 is not needed, as an [app](https://modal.com/docs/guide/apps)
...
_experimental_restrict_output bool
...
Decorator to register a new Modal [Cls](https://modal.com/docs/sdk/py/latest/modal.Cls)
 with this App.
...
Servers run HTTP servers that are started in a `@modal.enter()` method. Unlike `@app.cls()`, servers only expose HTTP endpoints and do not support `.remote()` method calls.

See the [guide](https://modal.com/docs/guide/servers)
...
compute_region str | Sequence\[str\] | None
...
[modal.App](https://modal.com/docs/sdk/py/latest/modal.App#modalapp)
[name](https://modal.com/docs/sdk/py/latest/modal.App#name)
[app_id](https://modal.com/docs/sdk/py/latest/modal.App#app_id)
[description](https://modal.com/docs/sdk/py/latest/modal.App#description)
[lookup](https://modal.com/docs/sdk/py/latest/modal.App#lookup)
[get_dashboard_url](https://modal.com/docs/sdk/py/latest/modal.App#get_dashboard_url)
[run](https://modal.com/docs/sdk/py/latest/modal.App#run)
[deploy](https://modal.com/docs/sdk/py/latest/modal.App#deploy)
[local_entrypoint](https://modal.com/docs/sdk/py/latest/modal.App#local_entrypoint)
[function](https://modal.com/docs/sdk/py/latest/modal.App#function)
[cls](https://modal.com/docs/sdk/py/latest/modal.App#cls)
[server](https://modal.com/docs/sdk/py/latest/modal.App#server)
[include](https://modal.com/docs/sdk/py/latest/modal.App#include)
[set_tags](https://modal.com/docs/sdk/py/latest/modal.App#set_tags)
[get_tags](https://modal.com/docs/sdk/py/latest/modal.App#get_tags)
