...
[modal.App](https://modal.com/docs/reference/modal.App#modalapp)
[name](https://modal.com/docs/reference/modal.App#name)
[app_id](https://modal.com/docs/reference/modal.App#app_id)
[description](https://modal.com/docs/reference/modal.App#description)
[lookup](https://modal.com/docs/reference/modal.App#lookup)
[get_dashboard_url](https://modal.com/docs/reference/modal.App#get_dashboard_url)
[run](https://modal.com/docs/reference/modal.App#run)
[deploy](https://modal.com/docs/reference/modal.App#deploy)
[local_entrypoint](https://modal.com/docs/reference/modal.App#local_entrypoint)
[function](https://modal.com/docs/reference/modal.App#function)
[cls](https://modal.com/docs/reference/modal.App#cls)
[server](https://modal.com/docs/reference/modal.App#server)
[include](https://modal.com/docs/reference/modal.App#include)
[set_tags](https://modal.com/docs/reference/modal.App#set_tags)
[get_tags](https://modal.com/docs/reference/modal.App#get_tags)
