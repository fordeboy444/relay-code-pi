...
[modal.Cls](https://modal.com/docs/reference/modal.Cls#modalcls)
[hydrate](https://modal.com/docs/reference/modal.Cls#hydrate)
[from_name](https://modal.com/docs/reference/modal.Cls#from_name)
[with_options](https://modal.com/docs/reference/modal.Cls#with_options)
[with_concurrency](https://modal.com/docs/reference/modal.Cls#with_concurrency)
[with_batching](https://modal.com/docs/reference/modal.Cls#with_batching)
