# modal shell | Modal Docs

- **URL:** https://modal.com/docs/cli/latest/shell
- **Summary:** Run a command or interactive shell inside a Modal container.
...
[modal shell](https://modal.com/docs/cli/latest/shell#modal-shell)
