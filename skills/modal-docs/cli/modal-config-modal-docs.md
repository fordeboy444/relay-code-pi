...
- **URL:** https://modal.com/docs/cli/latest/config
- **Summary:** Manage client configuration for the current profile.
...
Refer to [https://modal.com/docs/sdk/py/latest/modal.config](https://modal.com/docs/sdk/py/latest/modal.config)
 for a full explanation of what these options mean, and how to set them.
...
[modal config](https://modal.com/docs/cli/latest/config#modal-config)
[modal config set-environment](https://modal.com/docs/cli/latest/config#modal-config-set-environment)
[modal config show](https://modal.com/docs/cli/latest/config#modal-config-show)
