...
- **URL:** https://developer.unipile.com/reference/messagescontroller_patchmessage
- **Summary:** Edit a message. Supported for WhatsApp and LinkedIn Classic only. WhatsApp may reject edits after an indicative 15-minute window following the original send time. LinkedIn Classic edits are only possible within the first 60 minutes after the message is sent.
