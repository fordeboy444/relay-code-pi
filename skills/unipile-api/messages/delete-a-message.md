...
- **URL:** https://developer.unipile.com/reference/messagescontroller_deletemessage
- **Summary:** Delete a message. Supported for WhatsApp and LinkedIn only. For LinkedIn, it is only possible within the first 60 minutes after the message is sent.
