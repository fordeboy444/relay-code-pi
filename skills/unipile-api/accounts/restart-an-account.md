...
- **URL:** https://developer.unipile.com/reference/accountscontroller_restartaccount
...
The id of the account to restart.

200

OK. The account sources have been restarted.
...
`AccountRestarted` `AccountFailedToRestart`
...
https://api1.unipile.com:13111/api/v1/accounts/{id}/restart
...
2
     ...
     \--url https://api1.unipile.com:13111/api/v1/accounts/id/restart \\
