...
- **URL:** https://developer.unipile.com/reference/userscontroller_getfollowing
- **Summary:** Returns a list of all the followed accounts of an account. Ensure careful implementation of this action and consult provider limits and restrictions: https://developer.unipile.com/docs/provider-limits-and-restrictions
...
`Instagram only` The user to get the followed accounts from (provider_id or username).
...
The account to get the followed accounts from. (if user_id is not provided)
...
https://api1.unipile.com:13111/api/v1/users/following
...
2
     ...
     \--url https://api1.unipile.com:13111/api/v1/users/following \\
