...
- **URL:** https://developer.unipile.com/reference/userscontroller_cancelinvitation
- **Summary:** Unipile API 
Transform your app into a powerful communication hub using our easy-to-integrate Email, Calendar, and Messaging APIs.
...
`Instagram`: Use the 'provider_id' retrieved in user profile (not 'provider_messaging_id')
...
https://api1.unipile.com:13111/api/v1/users/invite/sent/{invitation_id}
...
2
     ...
     \--url https://api1.unipile.com:13111/api/v1/users/invite/sent/invitation_id \\
