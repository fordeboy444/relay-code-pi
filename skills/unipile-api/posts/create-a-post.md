...
- **URL:** https://developer.unipile.com/reference/postscontroller_createpost
...
On `linkedin`, image file resolution is limited to 6012px x 6012px max.
...
`Linkedin only` The ID of a job posting that should be displayed within a preview card.
...
post_typeString 1String 2String 3

enum

`Instagram only`: Publish as a regular feed post or as a story. Defaults to `feed` when omitted or empty.
...
https://api1.unipile.com:13111/api/v1/posts
