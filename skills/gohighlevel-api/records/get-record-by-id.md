...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/objects/get-record-by-id
- **Summary:** Allows you to get a Standard Object like business and custom object record by Id

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/objects/get-record-by-id#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/objects/custom_objects.pet or business.email (for company'\''s email)/records/632c34b4c9b7da3358ac9891' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>'
