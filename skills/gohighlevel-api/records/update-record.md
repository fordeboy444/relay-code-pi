...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/objects/update-object-record
- **Summary:** Update a Custom Object Record by Id. Supported Objects are business and custom objects. Documentation Link - https://doc.clickup.com/8631005/d/h/87cpx-277156/93bf0c2e23177b0/87cpx-376296

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/objects/update-object-record#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L -X PUT 'https://services.leadconnectorhq.com/objects/custom_objects.pet or business.email (for company'\''s email)/records/632c34b4c9b7da3358ac9891' \-H 'Content-Type: application/json' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>' \-d '{}'
