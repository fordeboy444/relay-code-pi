...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/knowledge-base/create
- **Summary:** Create a new FAQ inside knowledge base

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/knowledge-base/create#__docusaurus_skipToContent_fallback)
...
**Example:** `710KoEzy793Fxubft0bc`
    ...
    {  "locationId": "HqDZpF8GH3qvgJTmKCoL",  "question": "What is the capital of France?",  "answer": "The capital of France is Paris.",  "knowledgeBaseId": "710KoEzy793Fxubft0bc"}
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/knowledge-bases/faqs' \-H 'Content-Type: application/json' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>' \-d '{  "locationId": "HqDZpF8GH3qvgJTmKCoL",  "question": "What is the capital of France?",  "answer": "The capital of France is Paris.",  "knowledgeBaseId": "710KoEzy793Fxubft0bc"}'
