...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/knowledge-base/update
- **Summary:** Update an existing knowledge base FAQ

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/knowledge-base/update#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L -X PUT 'https://services.leadconnectorhq.com/knowledge-bases/faqs/710KoEzy793Fxubft0bc' \-H 'Content-Type: application/json' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>' \-d '{  "question": "What is the capital of France?",  "answer": "The capital of France is Paris."}'
