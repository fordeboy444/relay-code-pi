...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/knowledge-base/list
- **Summary:** Retrieves FAQs for a knowledge base. Supports pagination using limit and lastFaqId parameters.

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/knowledge-base/list#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/knowledge-bases/faqs?knowledgeBaseId=710KoEzy793Fxubft0bc&locationId=qDZpF8GH3qvgJTmKCoL&limit=10&lastFaqId=3rzeElC1FOVY91veVBkp' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>'
