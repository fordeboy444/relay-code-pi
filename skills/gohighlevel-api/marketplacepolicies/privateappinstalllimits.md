...
- **Summary:** Effective date​ Applies to Private apps created on or after **18 November 2025**.

[Skip to main content](https://marketplace.gohighlevel.com/docs/MarketplacePolicies/PrivateAppInstallLimits#__docusaurus_skipToContent_fallback)
...
**Need help?** Email us on **[marketplace@gohighlevel.com](mailto:marketplace@gohighlevel.com)
**
...
*   [Effective date](https://marketplace.gohighlevel.com/docs/MarketplacePolicies/PrivateAppInstallLimits#effective-date)
    
*   [Purpose](https://marketplace.gohighlevel.com/docs/MarketplacePolicies/PrivateAppInstallLimits#purpose)
    
*   [Summary](https://marketplace.gohighlevel.com/docs/MarketplacePolicies/PrivateAppInstallLimits#summary)
    
*   [Key definitions](https://marketplace.gohighlevel.com/docs/MarketplacePolicies/PrivateAppInstallLimits#key-definitions)
    
*   [Thresholds and behavior](https://marketplace.gohighlevel.com/docs/MarketplacePolicies/PrivateAppInstallLimits#thresholds-and-behavior)
    *   [Install experience](https://marketplace.gohighlevel.com/docs/MarketplacePolicies/PrivateAppInstallLimits#install-experience)
        
    *   [Real‑time enforcement](https://marketplace.gohighlevel.com/docs/MarketplacePolicies/PrivateAppInstallLimits#realtime-enforcement)
        
*   [Security Review](https://marketplace.gohighlevel.com/docs/MarketplacePolicies/PrivateAppInstallLimits#security-review)
    *   [When you can request](https://marketplace.gohighlevel.com/docs/MarketplacePolicies/PrivateAppInstallLimits#when-you-can-request)
        
    *   [What you submit](https://marketplace.gohighlevel.com/docs/MarketplacePolicies/PrivateAppInstallLimits#what-you-submit)
        
    *   [Outcomes](https://marketplace.gohighlevel.com/docs/MarketplacePolicies/PrivateAppInstallLimits#outcomes)
        
    *   [Re‑review](https://marketplace.gohighlevel.com/docs/MarketplacePolicies/PrivateAppInstallLimits#rereview)
        
*   [Publishing publicly](https://marketplace.gohighlevel.com/docs/MarketplacePolicies/PrivateAppInstallLimits#publishing-publicly)
    *   [How to publish](https://marketplace.gohighlevel.com/docs/MarketplacePolicies/PrivateAppInstallLimits#how-to-publish)
        
    *   [Public listing requirements](https://marketplace.gohighlevel.com/docs/MarketplacePolicies/PrivateAppInstallLimits#public-listing-requirements)
        
*   [Where you’ll see this in product](https://marketplace.gohighlevel.com/docs/MarketplacePolicies/PrivateAppInstallLimits#where-youll-see-this-in-product)
    
*   [Converting between Public and Private](https://marketplace.gohighlevel.com/docs/MarketplacePolicies/PrivateAppInstallLimits#converting-between-public-and-private)
    
*   [Examples](https://marketplace.gohighlevel.com/docs/MarketplacePolicies/PrivateAppInstallLimits#examples)
    
*   [Legacy scope](https://marketplace.gohighlevel.com/docs/MarketplacePolicies/PrivateAppInstallLimits#legacy-scope)
    
*   [Optional: Bulk Installation (Public apps)](https://marketplace.gohighlevel.com/docs/MarketplacePolicies/PrivateAppInstallLimits#optional-bulk-installation-public-apps)
    
*   [FAQs](https://marketplace.gohighlevel.com/docs/MarketplacePolicies/PrivateAppInstallLimits#faqs)
    
*   [Versioning & change log](https://marketplace.gohighlevel.com/docs/MarketplacePolicies/PrivateAppInstallLimits#versioning--change-log)
    
*   [Change management](https://marketplace.gohighlevel.com/docs/MarketplacePolicies/PrivateAppInstallLimits#change-management)
