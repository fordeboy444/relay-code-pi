...
- **URL:** https://marketplace.gohighlevel.com/docs/webhook/RecordDelete
- **Summary:** The `Delete Record` is triggered whenever a record or business (company) is deleted from the system.

[Skip to main content](https://marketplace.gohighlevel.com/docs/webhook/RecordDelete#__docusaurus_skipToContent_fallback)
