...
- **URL:** https://marketplace.gohighlevel.com/docs/webhook/ProductCreate
- **Summary:** Called whenever a product is created

[Skip to main content](https://marketplace.gohighlevel.com/docs/webhook/ProductCreate#__docusaurus_skipToContent_fallback)
