...
- **Summary:** Called whenever a price is updated

[Skip to main content](https://marketplace.gohighlevel.com/docs/webhook/PriceUpdate#__docusaurus_skipToContent_fallback)
