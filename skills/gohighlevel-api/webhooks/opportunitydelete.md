...
- **URL:** https://marketplace.gohighlevel.com/docs/webhook/OpportunityDelete
- **Summary:** Called whenever an opportunity is deleted

[Skip to main content](https://marketplace.gohighlevel.com/docs/webhook/OpportunityDelete#__docusaurus_skipToContent_fallback)
