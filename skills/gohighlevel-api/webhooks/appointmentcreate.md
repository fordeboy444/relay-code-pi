# Schema[​](https://marketplace.gohighlevel.com/docs/webhook/AppointmentCreate#schema "Direct link to Schema")

- **URL:** https://marketplace.gohighlevel.com/docs/webhook/AppointmentCreate
- **Summary:** Called whenever an appointment is created

[Skip to main content](https://marketplace.gohighlevel.com/docs/webhook/AppointmentCreate#__docusaurus_skipToContent_fallback)
...
#### Example[​](https://marketplace.gohighlevel.com/docs/webhook/AppointmentCreate#example "Direct link to Example")
