...
- **URL:** https://marketplace.gohighlevel.com/docs/webhook/NoteDelete
- **Summary:** Called whenever a note is deleted

[Skip to main content](https://marketplace.gohighlevel.com/docs/webhook/NoteDelete#__docusaurus_skipToContent_fallback)
