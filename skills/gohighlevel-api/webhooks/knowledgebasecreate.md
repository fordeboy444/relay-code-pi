...
- **URL:** https://marketplace.gohighlevel.com/docs/webhook/KnowledgeBaseCreate
- **Summary:** Called whenever a knowledge base is created

[Skip to main content](https://marketplace.gohighlevel.com/docs/webhook/KnowledgeBaseCreate#__docusaurus_skipToContent_fallback)
...
#### Example[​](https://marketplace.gohighlevel.com/docs/webhook/KnowledgeBaseCreate#example "Direct link to Example")
    ...
    {  "type": "KnowledgeBaseCreate",  "locationId": "ve9EPM428h8vShlRW1KT",  "id": "6578278e879ad2646715ba9c",  "name": "Support Knowledge Base",  "description": "FAQs and docs for customer support",  "deleted": false}
