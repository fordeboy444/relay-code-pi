...
- **Summary:** The Webhook Logs Dashboard provides comprehensive monitoring and troubleshooting capabilities for webhook deliveries in your marketplace application. This guide covers how to access, navigate, and effectively use the dashboard to monitor your webhook integrations.

[Skip to main content](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#__docusaurus_skipToContent_fallback)
...
1.  [Overview](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#overview)
    
2.  [Accessing Webhook Logs](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#accessing-webhook-logs)
    
3.  [Understanding the Dashboard](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#understanding-the-dashboard)
    
4.  [Using Date & Time Filters](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#using-date--time-filters)
    
5.  [Searching Logs](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#searching-logs)
    
6.  [Filtering by Event Name](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#filtering-by-event-name)
    
7.  [Filtering by Status Code](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#filtering-by-status-code)
    
8.  [Navigating Through Pages](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#navigating-through-pages)
    
9.  [Viewing Webhook Details](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#viewing-webhook-details)
    
10.  [Triggering a Manual Retry](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#triggering-a-manual-retry)
    
11.  [Clearing All Filters](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#clearing-all-filters)
...
*   **Resend button**: Manually redeliver the webhook when enabled (see [Triggering a Manual Retry](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#triggering-a-manual-retry)
    )
*   Useful for:
    *   Debugging issues
...
*   [Table of Contents](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#table-of-contents)
    
*   [Overview](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#overview)
    
*   [Accessing Webhook Logs](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#accessing-webhook-logs)
    *   [Navigation Steps](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#navigation-steps)
        
    *   [URL Pattern](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#url-pattern)
        
*   [Understanding the Dashboard](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#understanding-the-dashboard)
    *   [Statistics Cards](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#statistics-cards)
        
    *   [Logs Table](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#logs-table)
        
*   [Using Date & Time Filters](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#using-date--time-filters)
    *   [Date & Time Pickers](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#date--time-pickers)
        
    *   [Changing Timezone](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#changing-timezone)
        
*   [Searching Logs](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#searching-logs)
    *   [Global Search Bar](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#global-search-bar)
        
*   [Filtering by Event Name](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#filtering-by-event-name)
    *   [Opening the Filter](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#opening-the-filter)
        
    *   [Sorting Options](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#sorting-options)
        
    *   [Filter by Condition](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#filter-by-condition)
        
    *   [Filter by Values (Checkboxes)](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#filter-by-values-checkboxes)
        
    *   [Clearing Event Name Filters](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#clearing-event-name-filters)
        
*   [Filtering by Status Code](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#filtering-by-status-code)
    *   [Opening the Filter](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#opening-the-filter-1)
        
    *   [Quick Filter Options](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#quick-filter-options)
        
    *   [Filter by Specific Status Codes](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#filter-by-specific-status-codes)
        
*   [Navigating Through Pages](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#navigating-through-pages)
    *   [Pagination Controls](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#pagination-controls)
        
    *   [Changing Rows Per Page](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#changing-rows-per-page)
        
    *   [Moving Between Pages](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#moving-between-pages)
        
*   [Viewing Webhook Details](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#viewing-webhook-details)
    *   [Opening the Details Modal](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#opening-the-details-modal)
        
    *   [What You'll See](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#what-youll-see)
        
    *   [Using the Payload](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#using-the-payload)
        
*   [Triggering a Manual Retry](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#triggering-a-manual-retry)
    *   [How It Works](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#how-it-works)
        
    *   [When Is Resend Available?](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#when-is-resend-available)
        
    *   [What Happens After a Manual Retry?](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#what-happens-after-a-manual-retry)
        
*   [Clearing All Filters](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#clearing-all-filters)
    *   [When to Clear Filters](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#when-to-clear-filters)
        
    *   [How to Clear](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#how-to-clear)
        
    *   [What Gets Cleared](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#what-gets-cleared)
        
    *   [What Stays](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#what-stays)
        
*   [Common Use Cases](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#common-use-cases)
    *   [Use Case 1: Finding a Specific Webhook](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#use-case-1-finding-a-specific-webhook)
        
    *   [Use Case 2: Troubleshooting Failed Webhooks](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#use-case-2-troubleshooting-failed-webhooks)
        
    *   [Use Case 3: Checking Retry Behavior](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#use-case-3-checking-retry-behavior)
        
    *   [Use Case 4: Monitoring Event Volume](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#use-case-4-monitoring-event-volume)
        
    *   [Use Case 5: Focusing on Specific Events](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#use-case-5-focusing-on-specific-events)
        
    *   [Use Case 6: Investigating Issues at Specific Time](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#use-case-6-investigating-issues-at-specific-time)
        
    *   [Use Case 7: Comparing Success vs Failure](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#use-case-7-comparing-success-vs-failure)
        
    *   [Use Case 8: Post-Deployment Verification](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#use-case-8-post-deployment-verification)
        
    *   [Use Case 9: Manually Retrying a Failed Webhook](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#use-case-9-manually-retrying-a-failed-webhook)
        
*   [FAQ](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#faq)
    
*   [Need More Help?](https://marketplace.gohighlevel.com/docs/webhook/WebhookLogsDashboard#need-more-help)
