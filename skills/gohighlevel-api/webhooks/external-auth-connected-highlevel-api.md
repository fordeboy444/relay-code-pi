...
- **Summary:** Called whenever external authentication (OAuth2 or Basic) is connected successfully for an app/location/company. {  "type": "object",  "properties": {    "type": { "type": "string", "enum": ["EXTERNAL_AUTH_CONNECTED"] },    "appId": { "type": "string" },    "locationId": { "type": "string" },   ...

[Skip to main content](https://marketplace.gohighlevel.com/docs/webhook/ExternalAuthConnected#__docusaurus_skipToContent_fallback)
