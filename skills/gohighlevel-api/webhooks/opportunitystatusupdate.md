...
- **URL:** https://marketplace.gohighlevel.com/docs/webhook/OpportunityStatusUpdate
- **Summary:** Called whenever an opportunity's status field is updated

[Skip to main content](https://marketplace.gohighlevel.com/docs/webhook/OpportunityStatusUpdate#__docusaurus_skipToContent_fallback)
