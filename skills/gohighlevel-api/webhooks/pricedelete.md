# Schema[​](https://marketplace.gohighlevel.com/docs/webhook/PriceDelete#schema "Direct link to Schema")

- **URL:** https://marketplace.gohighlevel.com/docs/webhook/PriceDelete
- **Summary:** Called whenever a price is deleted

[Skip to main content](https://marketplace.gohighlevel.com/docs/webhook/PriceDelete#__docusaurus_skipToContent_fallback)
...
#### Example[​](https://marketplace.gohighlevel.com/docs/webhook/PriceDelete#example "Direct link to Example")
