...
- **URL:** https://marketplace.gohighlevel.com/docs/webhook/OpportunityStageUpdate
- **Summary:** Called whenever an opportunity's stage field is updated

[Skip to main content](https://marketplace.gohighlevel.com/docs/webhook/OpportunityStageUpdate#__docusaurus_skipToContent_fallback)
