...
- **Summary:** The **Object Schema Create** is triggered whenever a custom object is created.

[Skip to main content](https://marketplace.gohighlevel.com/docs/webhook/ObjectSchemaCreate#__docusaurus_skipToContent_fallback)
...
*   [Overview](https://marketplace.gohighlevel.com/docs/webhook/ObjectSchemaCreate#overview)
    
*   [Schema](https://marketplace.gohighlevel.com/docs/webhook/ObjectSchemaCreate#schema)
    
*   [Field Descriptions](https://marketplace.gohighlevel.com/docs/webhook/ObjectSchemaCreate#field-descriptions)
    *   [`labels`](https://marketplace.gohighlevel.com/docs/webhook/ObjectSchemaCreate#labels)
        
    *   [`description`](https://marketplace.gohighlevel.com/docs/webhook/ObjectSchemaCreate#description)
        
    *   [`searchableProperties`](https://marketplace.gohighlevel.com/docs/webhook/ObjectSchemaCreate#searchableproperties)
        
    *   [`primaryDisplayProperty`](https://marketplace.gohighlevel.com/docs/webhook/ObjectSchemaCreate#primarydisplayproperty)
        
    *   [`key`](https://marketplace.gohighlevel.com/docs/webhook/ObjectSchemaCreate#key)
        
    *   [`locationId`](https://marketplace.gohighlevel.com/docs/webhook/ObjectSchemaCreate#locationid)
        
    *   [`createdBy`](https://marketplace.gohighlevel.com/docs/webhook/ObjectSchemaCreate#createdby)
        
    *   [`updatedBy`](https://marketplace.gohighlevel.com/docs/webhook/ObjectSchemaCreate#updatedby)
        
    *   [`timestamp`](https://marketplace.gohighlevel.com/docs/webhook/ObjectSchemaCreate#timestamp)
        
    *   [`objectType`](https://marketplace.gohighlevel.com/docs/webhook/ObjectSchemaCreate#objecttype)
        
*   [Example Payload](https://marketplace.gohighlevel.com/docs/webhook/ObjectSchemaCreate#example-payload)
    
*   [Additional Notes](https://marketplace.gohighlevel.com/docs/webhook/ObjectSchemaCreate#additional-notes)
