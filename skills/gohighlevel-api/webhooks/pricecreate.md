# Schema[​](https://marketplace.gohighlevel.com/docs/webhook/PriceCreate#schema "Direct link to Schema")

- **URL:** https://marketplace.gohighlevel.com/docs/webhook/PriceCreate
- **Summary:** Called whenever a price is created

[Skip to main content](https://marketplace.gohighlevel.com/docs/webhook/PriceCreate#__docusaurus_skipToContent_fallback)
...
#### Example[​](https://marketplace.gohighlevel.com/docs/webhook/PriceCreate#example "Direct link to Example")
