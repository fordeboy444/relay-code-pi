...
- **URL:** https://marketplace.gohighlevel.com/docs/webhook/OpportunityMonetaryValueUpdate
- **Summary:** Called whenever an opportunity's monetary value field is updated

[Skip to main content](https://marketplace.gohighlevel.com/docs/webhook/OpportunityMonetaryValueUpdate#__docusaurus_skipToContent_fallback)
