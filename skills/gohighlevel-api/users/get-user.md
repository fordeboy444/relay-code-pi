...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/users/get-user
- **Summary:** Get User

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/users/get-user#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/users/ve9EPM428h8vShlRW1KT' \-H 'Accept: application/json' \-H 'Version: v3' \-H 'Authorization: Bearer <Authorization>'
