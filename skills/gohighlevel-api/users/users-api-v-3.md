...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/users/users-api-v-3
- **Summary:** Documentation for users API

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/users/users-api-v-3#__docusaurus_skipToContent_fallback)
...
*   [API Version v3](https://marketplace.gohighlevel.com/docs/ghl/users/users-api-v-3#api-version-v3)
