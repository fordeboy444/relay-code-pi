...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/users/create-user
- **Summary:** Create User

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/users/create-user#__docusaurus_skipToContent_fallback)
