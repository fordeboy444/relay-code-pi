...
- **Summary:** HighLevel provides a secure mechanism for accessing authenticated user information through signed tokens. This guide explains how you can generate and use Shared Secret key to access user context in secured manner.

[Skip to main content](https://marketplace.gohighlevel.com/docs/other/user-context-marketplace-apps#__docusaurus_skipToContent_fallback)
...
When accessing from an Agency context, the decrypted data will have the following structure:
    ...
    {  "userId": "MKQJ7wOVVmNOMvrnKKKK", // Unique identifier for the user  "companyId": "GNb7aIv4rQFVb9iwNl5K", // Unique identifier for the company/agency  "role": "admin", // User's role in the system  "type": "agency", // Indicates this is an agency user  "userName": "John Doe", // Full name of the user  "email": "johndoe@gmail.com", // User's email address  "isAgencyOwner": true, // If the loggedIn user is agency owner  "versionId": "695505b431a9710730ee67d7",  "appStatus": "live",  "whitelabelDetails": {      "domain": "example.com",      "logoUrl": "example.com"    }}
...
*   [Setting Up Shared Secret](https://marketplace.gohighlevel.com/docs/other/user-context-marketplace-apps#setting-up-shared-secret)
    *   [Generating a Shared Secret Key](https://marketplace.gohighlevel.com/docs/other/user-context-marketplace-apps#generating-a-shared-secret-key)
        
*   [Frontend Implementation Methods](https://marketplace.gohighlevel.com/docs/other/user-context-marketplace-apps#frontend-implementation-methods)
    *   [1\. Custom JavaScript Implementation](https://marketplace.gohighlevel.com/docs/other/user-context-marketplace-apps#1-custom-javascript-implementation)
        
    *   [2\. Custom Pages Implementation](https://marketplace.gohighlevel.com/docs/other/user-context-marketplace-apps#2-custom-pages-implementation)
        
*   [Backend Implementation](https://marketplace.gohighlevel.com/docs/other/user-context-marketplace-apps#backend-implementation)
    
*   [Decrypted Data Structure](https://marketplace.gohighlevel.com/docs/other/user-context-marketplace-apps#decrypted-data-structure)
    *   [Agency Context](https://marketplace.gohighlevel.com/docs/other/user-context-marketplace-apps#agency-context)
        
    *   [Location Context](https://marketplace.gohighlevel.com/docs/other/user-context-marketplace-apps#location-context)
        
    *   [Field Descriptions](https://marketplace.gohighlevel.com/docs/other/user-context-marketplace-apps#field-descriptions)
        
    *   [Reference Implementation](https://marketplace.gohighlevel.com/docs/other/user-context-marketplace-apps#reference-implementation)
        
    *   [Security Considerations](https://marketplace.gohighlevel.com/docs/other/user-context-marketplace-apps#security-considerations)
