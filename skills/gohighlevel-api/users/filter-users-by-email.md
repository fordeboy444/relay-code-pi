...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/users/filter-users-by-email
- **Summary:** Filter users by company ID, deleted status, and email array

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/users/filter-users-by-email#__docusaurus_skipToContent_fallback)
...
**Example:** `all`
    ...
    {  "companyId": "5DP41231LkQsiKESj6rh",  "emails": "user1@example.com,user2@example.com",  "deleted": false,  "skip": "1",  "limit": "10",  "projection": "all"}
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/users/search/filter-by-email' \-H 'Content-Type: application/json' \-H 'Accept: application/json' \-H 'Version: v3' \-H 'Authorization: Bearer <Authorization>' \--data-raw '{  "companyId": "5DP41231LkQsiKESj6rh",  "emails": "user1@example.com,user2@example.com",  "deleted": false,  "skip": "1",  "limit": "10",  "projection": "all"}'
