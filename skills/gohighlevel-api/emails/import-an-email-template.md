...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/emails/import-email-template
- **Summary:** Import a template from a provider URL

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/emails/import-email-template#__docusaurus_skipToContent_fallback)
...
https://services.leadconnectorhq.com/emails/locations/:locationId/templates/import
...
**Example:** `507f1f77bcf86cd799439011`
    ...
    {  "importProvider": "mailchimp",  "importUrl": "https://templates.example.com/public/template-123",  "name": "Imported Template",  "parentFolderId": "67f15c2ae99226d5bcccb8f0",  "userId": "507f1f77bcf86cd799439011"}
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/emails/locations/ve9EPM428h8vShlRW1KT/templates/import' \-H 'Content-Type: application/json' \-H 'Accept: application/json' \-H 'Version: v3' \-H 'Authorization: Bearer <Authorization>' \-d '{  "importProvider": "mailchimp",  "importUrl": "https://templates.example.com/public/template-123",  "name": "Imported Template",  "parentFolderId": "67f15c2ae99226d5bcccb8f0",  "userId": "507f1f77bcf86cd799439011"}'
