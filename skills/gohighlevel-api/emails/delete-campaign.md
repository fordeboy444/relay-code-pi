...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/emails/delete-campaign
- **Summary:** Delete a campaign

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/emails/delete-campaign#__docusaurus_skipToContent_fallback)
...
Request[​](https://marketplace.gohighlevel.com/docs/ghl/emails/delete-campaign#request "Direct link to request")
...
Responses[​](https://marketplace.gohighlevel.com/docs/ghl/emails/delete-campaign#responses "Direct link to Responses")
...
*   CURL
    ...
    curl -L -X DELETE 'https://services.leadconnectorhq.com/emails/locations/ve9EPM428h8vShlRW1KT/campaigns/emails/zYy3YOUuHxgomU1uYJty' \-H 'Accept: application/json' \-H 'Version: v3' \-H 'Authorization: Bearer <Authorization>'
