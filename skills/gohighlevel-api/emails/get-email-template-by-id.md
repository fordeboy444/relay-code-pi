...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/emails/get-email-template
- **Summary:** Get a single email template by its ID

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/emails/get-email-template#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/emails/locations/ve9EPM428h8vShlRW1KT/templates/507f1f77bcf86cd799439011' \-H 'Accept: application/json' \-H 'Version: v3' \-H 'Authorization: Bearer <Authorization>'
