...
- **Summary:** We’re excited to announce that the LeadConnector MCP (Model Context Protocol) server is live and ready for use! It opens up a world where advanced AI assistants can talk directly to your CRM data and tools. Think of it as a bridge: you can now query, automate, and orchestrate everything in your LeadConnector account with AI.

[Skip to main content](https://marketplace.gohighlevel.com/docs/other/mcp#__docusaurus_skipToContent_fallback)
...
What is MCP?[​](https://marketplace.gohighlevel.com/docs/other/mcp#what-is-mcp "Direct link to What is MCP?")
...
Authentication (both endpoints)[​](https://marketplace.gohighlevel.com/docs/other/mcp#authentication-both-endpoints "Direct link to Authentication (both endpoints)")
...
| **Clients** | Per-client; **Claude live today**, others [planned](https://marketplace.gohighlevel.com/docs/other/mcp#roadmap) | Any HTTP-based MCP client (Cursor, Windsurf, n8n, custom agents, and more) |
...
**Live today:** `https://services.leadconnectorhq.com/mcp/anthropic/v2` (Claude). Other clients are on the [roadmap](https://marketplace.gohighlevel.com/docs/other/mcp#roadmap)
.
...
A small, unified toolset[​](https://marketplace.gohighlevel.com/docs/other/mcp#a-small-unified-toolset "Direct link to A small, unified toolset")
...
A single prompt in action[​](https://marketplace.gohighlevel.com/docs/other/mcp#a-single-prompt-in-action "Direct link to A single prompt in action")

Once connected, you don’t need to know the LeadConnector API — you just ask. For example:

> _“Find the contact with email [jane@example.com](mailto:jane@example.com)
> , add the tag ‘vip-2026’, and create a new opportunity in the ‘Sales Pipeline’ for them worth $5,000.”_
...
Working across sub-accounts (agencies)[​](https://marketplace.gohighlevel.com/docs/other/mcp#working-across-sub-accounts-agencies "Direct link to Working across sub-accounts (agencies)")
...
What you can do[​](https://marketplace.gohighlevel.com/docs/other/mcp#what-you-can-do "Direct link to What you can do")
...
Connect Claude (`/mcp/anthropic/v2`)[​](https://marketplace.gohighlevel.com/docs/other/mcp#connect-claude-mcpanthropicv2 "Direct link to connect-claude-mcpanthropicv2")
...
### Claude.ai[​](https://marketplace.gohighlevel.com/docs/other/mcp#claudeai "Direct link to Claude.ai")
...
### Claude Code (CLI)[​](https://marketplace.gohighlevel.com/docs/other/mcp#claude-code-cli "Direct link to Claude Code (CLI)")
...
Or add it to `.mcp.json` at your project root:
    ...
    {  "mcpServers": {    "leadconnector": {      "type": "http",      "url": "https://services.leadconnectorhq.com/mcp/anthropic/v2"    }  }}

On first use, Claude Code opens a browser for LeadConnector authorization. Verify with `claude mcp list`.

### Claude Cowork[​](https://marketplace.gohighlevel.com/docs/other/mcp#claude-cowork "Direct link to Claude Cowork")
...
> **Prefer a token?** Instead of OAuth, you can pass a Private Integration Token in the `Authorization` header (`Bearer pit-your-token`) — see the [PIT setup](https://marketplace.gohighlevel.com/docs/other/mcp#authentication-both-endpoints)
>  note above.

Permissions & security[​](https://marketplace.gohighlevel.com/docs/other/mcp#permissions--security "Direct link to Permissions & security")
...
> For the widest coverage, use the [recommended per-client endpoint](https://marketplace.gohighlevel.com/docs/other/mcp#recommended-the-per-client-endpoint-mcpclientv2)
>  above.
...
**Connect with a Private Integration Token:** create a token under **Settings → Private Integrations** (selecting the scopes your AI needs), then add the endpoint and headers to your client. The `locationId` header is optional — it can also be provided in prompts.
    ...
    {  "mcpServers": {    "leadconnector-mcp": {      "url": "https://services.leadconnectorhq.com/mcp/",      "headers": {        "Authorization": "Bearer pit-your-token",        "locationId": "your-location-id"      }    }  }}

Roadmap[​](https://marketplace.gohighlevel.com/docs/other/mcp#roadmap "Direct link to Roadmap")
...
Until a client’s dedicated endpoint ships, it can connect today via the original [`/mcp/` endpoint](https://marketplace.gohighlevel.com/docs/other/mcp#also-available-the-original-endpoint-mcp)
 (OAuth or PIT). Check back here as each becomes available.

Try it out & feedback[​](https://marketplace.gohighlevel.com/docs/other/mcp#try-it-out--feedback "Direct link to Try it out & feedback")
...
*   [What is MCP?](https://marketplace.gohighlevel.com/docs/other/mcp#what-is-mcp)
    
*   [Authentication (both endpoints)](https://marketplace.gohighlevel.com/docs/other/mcp#authentication-both-endpoints)
    
*   [Which endpoint to use](https://marketplace.gohighlevel.com/docs/other/mcp#which-endpoint-to-use)
    
*   [A small, unified toolset](https://marketplace.gohighlevel.com/docs/other/mcp#a-small-unified-toolset)
    
*   [A single prompt in action](https://marketplace.gohighlevel.com/docs/other/mcp#a-single-prompt-in-action)
    
*   [Working across sub-accounts (agencies)](https://marketplace.gohighlevel.com/docs/other/mcp#working-across-sub-accounts-agencies)
    
*   [What you can do](https://marketplace.gohighlevel.com/docs/other/mcp#what-you-can-do)
    
*   [Connect Claude (`/mcp/anthropic/v2`)](https://marketplace.gohighlevel.com/docs/other/mcp#connect-claude-mcpanthropicv2)
    *   [Claude.ai](https://marketplace.gohighlevel.com/docs/other/mcp#claudeai)
        
    *   [Claude Code (CLI)](https://marketplace.gohighlevel.com/docs/other/mcp#claude-code-cli)
        
    *   [Claude Cowork](https://marketplace.gohighlevel.com/docs/other/mcp#claude-cowork)
        
*   [Permissions & security](https://marketplace.gohighlevel.com/docs/other/mcp#permissions--security)
    
*   [Roadmap](https://marketplace.gohighlevel.com/docs/other/mcp#roadmap)
    
*   [Try it out & feedback](https://marketplace.gohighlevel.com/docs/other/mcp#try-it-out--feedback)
