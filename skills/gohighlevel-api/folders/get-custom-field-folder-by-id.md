...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/custom-fields/get-custom-field-by-id
- **Summary:** Get Custom Field / Folder By Id https://services.leadconnectorhq.com/custom-fields/:id Get Custom Field / Folder By Id.

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/custom-fields/get-custom-field-by-id#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/custom-fields/:id' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>'
