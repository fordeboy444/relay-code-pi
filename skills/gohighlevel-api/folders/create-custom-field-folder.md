...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/custom-fields/create-custom-field-folder
- **Summary:** Create Custom Field Folder https://services.leadconnectorhq.com/custom-fields/folder Create Custom Field Folder The key for your custom object.

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/custom-fields/create-custom-field-folder#__docusaurus_skipToContent_fallback)
...
**Example:** `ve9EPM428h8vShlRW1KT`
    ...
    {  "objectKey": "custom_object.pet",  "name": "Name",  "locationId": "ve9EPM428h8vShlRW1KT"}
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/custom-fields/folder' \-H 'Content-Type: application/json' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>' \-d '{  "objectKey": "custom_object.pet",  "name": "Name",  "locationId": "ve9EPM428h8vShlRW1KT"}'
