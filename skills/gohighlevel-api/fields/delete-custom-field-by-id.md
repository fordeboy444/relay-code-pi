...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/custom-fields/delete-custom-field
- **Summary:** Delete Custom Field By Id

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/custom-fields/delete-custom-field#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L -X DELETE 'https://services.leadconnectorhq.com/custom-fields/:id' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>'
