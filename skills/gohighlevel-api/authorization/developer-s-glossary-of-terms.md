...
- **Summary:** - Developer's Marketplace: The Developer's Marketplace is a platform within HighLevel that allows developers to build and integrate their applications and tools using the HighLevel API. HighLevel Developer Documentation

[Skip to main content](https://marketplace.gohighlevel.com/docs/Authorization/DeveloperGlossary#__docusaurus_skipToContent_fallback)
...
*   **Scopes:** Scopes define the specific permissions and access rights an app requires to interact with HighLevel. When creating an app, developers specify the necessary scopes that align with their app's functionalities. Scopes can include reading, writing, or managing permissions for different resources within HighLevel. [OAuth 2.0 Scopes](https://oauth.net/2/scope/)
     and this resource is for [HighLevel's OAuth Scopes.](https://marketplace.gohighlevel.com/docs/Authorization/Scopes)
