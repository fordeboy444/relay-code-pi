...
- **URL:** https://marketplace.gohighlevel.com/docs/Authorization/AccessTokenUseCase
- **Summary:** The type of Access Token that is generated depends on who is installing the app (an agency or a sub-account) and the app's distribution settings.

[Skip to main content](https://marketplace.gohighlevel.com/docs/Authorization/AccessTokenUseCase#__docusaurus_skipToContent_fallback)
