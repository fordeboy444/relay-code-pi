...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/conversations/get-message
- **Summary:** Get message by message id.

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/conversations/get-message#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/conversations/messages/:id' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>'
