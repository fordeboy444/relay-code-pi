...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/locations/create-location
- **Summary:** Create Sub-Account (Formerly Location) https://services.leadconnectorhq.com/locations/ Create a new Sub-Account (Formerly Location) based on the data provided This feature is only available on Agency Pro ($497) plan.

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location#__docusaurus_skipToContent_fallback)
