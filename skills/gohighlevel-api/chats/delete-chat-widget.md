...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/chat-widget/delete
- **Summary:** Soft-deletes a chat widget. If it was the default, another widget may be promoted.

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/chat-widget/delete#__docusaurus_skipToContent_fallback)
...
https://services.leadconnectorhq.com/chat-widget/:locationId/:id
...
*   CURL
    ...
    curl -L -X DELETE 'https://services.leadconnectorhq.com/chat-widget/ve9EPM428h8vShlRWsss/ve9EPM428h8vShlRWsss' \-H 'Version: v3' \-H 'Authorization: Bearer <Authorization>'
