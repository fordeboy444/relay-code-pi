...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/chat-widget/update-chat-widget
- **Summary:** Full update of a chat widget resource.

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/chat-widget/update-chat-widget#__docusaurus_skipToContent_fallback)
