...
**Example:** `Created Like`

    {  "success": true,  "statusCode": 201,  "message": "Created Like"}
...
*   CURL
    ...
    curl -L -X POST 'https://services.leadconnectorhq.com/social-media-posting/comments/facebook/507f1f77bcf86cd799439011/like?locationId=1234' \-H 'Accept: application/json' \-H 'Version: v3'
