...
- **Summary:** This guide aims to help developers create custom widgets for use in funnel builder and integrate them seamlessly. We will cover how to create, set up, and render custom widgets using HTML, CSS, and JavaScript or any JS frameworks like Angular, React, Vue along with communication between your custom widget application and the funnel builder.

[Skip to main content](https://marketplace.gohighlevel.com/docs/marketplace-modules/Widgets#__docusaurus_skipToContent_fallback)
...
*   [Prerequisites](https://marketplace.gohighlevel.com/docs/marketplace-modules/Widgets#prerequisites)
    
*   [Overview](https://marketplace.gohighlevel.com/docs/marketplace-modules/Widgets#overview)
    
*   [Step-by-Step Guide](https://marketplace.gohighlevel.com/docs/marketplace-modules/Widgets#step-by-step-guide)
    
*   [Checklist](https://marketplace.gohighlevel.com/docs/marketplace-modules/Widgets#checklist)
    
*   [Upload Format Supported](https://marketplace.gohighlevel.com/docs/marketplace-modules/Widgets#upload-format-supported)
    
*   [Developer Resources](https://marketplace.gohighlevel.com/docs/marketplace-modules/Widgets#developer-resources)
