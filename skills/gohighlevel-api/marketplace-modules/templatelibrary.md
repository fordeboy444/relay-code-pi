...
- **URL:** https://marketplace.gohighlevel.com/docs/marketplace-modules/TemplateLibrary
...
[Skip to main content](https://marketplace.gohighlevel.com/docs/marketplace-modules/TemplateLibrary#__docusaurus_skipToContent_fallback)
...
If you want to **sell a template**, the process begins in the Template Library and continues in the **Seller Portal** (the developer/marketplace listing interface). The listing is created using details pre-filled from the selected template.
...
1.  Go to **My Templates** in the Template Library
2.  Complete all required template details and publish it (if not already done)
...
1.  **Basic Information** _(required)_
2.  **Support Information** _(required)_
...
*   Refresh the original template from the Template Library
*   Add **release notes** (visible to agencies) describing the changes

This will automatically resubmit the app for review. Once approved:
...
1.  Withdraw the app from review in the Developer Portal
2.  Make the necessary updates
3.  Complete the listing steps again
4.  Resubmit for a new review cycle
...
[Template Library Marketplace Integration](https://help.leadconnectorhq.com/support/solutions/articles/155000007748-template-library-marketplace-integration)
 help article.
...
2.  Click **Preview**
3.  Click **Install**
4.  If paid, complete the payment flow
...
1.  Open a template
2.  Click **Preview**
3.  Click **⋮ (three dots)** → **Sell on Marketplace**
...
*   [Seller Portal: Account Setup, Listing, and Review](https://marketplace.gohighlevel.com/docs/marketplace-modules/TemplateLibrary#seller-portal-account-setup-listing-and-review)
    *   [Developer Account](https://marketplace.gohighlevel.com/docs/marketplace-modules/TemplateLibrary#developer-account)
        
    *   [Completing Your Listing](https://marketplace.gohighlevel.com/docs/marketplace-modules/TemplateLibrary#completing-your-listing)
        
    *   [Scope of Template Marketplace Apps](https://marketplace.gohighlevel.com/docs/marketplace-modules/TemplateLibrary#scope-of-template-marketplace-apps)
        
    *   [Review Process](https://marketplace.gohighlevel.com/docs/marketplace-modules/TemplateLibrary#review-process)
        
*   [Updating a Listed Template](https://marketplace.gohighlevel.com/docs/marketplace-modules/TemplateLibrary#updating-a-listed-template)
    *   [Minor Updates](https://marketplace.gohighlevel.com/docs/marketplace-modules/TemplateLibrary#minor-updates)
        
    *   [Major Updates](https://marketplace.gohighlevel.com/docs/marketplace-modules/TemplateLibrary#major-updates)
        
*   [End-User Experience (Overview)](https://marketplace.gohighlevel.com/docs/marketplace-modules/TemplateLibrary#end-user-experience-overview)
    *   [Browsing Templates](https://marketplace.gohighlevel.com/docs/marketplace-modules/TemplateLibrary#browsing-templates)
        
    *   [Discovering Templates](https://marketplace.gohighlevel.com/docs/marketplace-modules/TemplateLibrary#discovering-templates)
        
    *   [Installing Templates](https://marketplace.gohighlevel.com/docs/marketplace-modules/TemplateLibrary#installing-templates)
        
    *   [Selling Templates](https://marketplace.gohighlevel.com/docs/marketplace-modules/TemplateLibrary#selling-templates)
        
    *   [Pricing Model (Buyers)](https://marketplace.gohighlevel.com/docs/marketplace-modules/TemplateLibrary#pricing-model-buyers)
        
*   [Supported Template Types](https://marketplace.gohighlevel.com/docs/marketplace-modules/TemplateLibrary#supported-template-types)
