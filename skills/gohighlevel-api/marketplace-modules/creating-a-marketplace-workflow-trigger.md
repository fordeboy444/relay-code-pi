...
- **Summary:** Marketplace Workflow Triggers are the customizable workflow triggers managed in Marketplace. You will be able to create custom triggers to push data from your application/API to a workflow.

[Skip to main content](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomTriggers#__docusaurus_skipToContent_fallback)

Version: v3

On this page

Marketplace Workflow Triggers are the customizable workflow triggers managed in [Marketplace](https://marketplace.gohighlevel.com/)
...
*   [Create a New Trigger](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomTriggers#create-a-new-trigger)
    
*   [Define Trigger Information](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomTriggers#define-trigger-information)
    
*   [Configure Trigger Data](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomTriggers#configure-trigger-data)
    
*   [Manage Filters](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomTriggers#manage-filters)
    
*   [Manage Custom Variables](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomTriggers#manage-custom-variables)
    
*   [Set Up Subscription URL](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomTriggers#set-up-subscription-url)
    
*   [Submit for Review](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomTriggers#submit-for-review)
    
*   [Version Management](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomTriggers#version-management)
    
*   [Delete Trigger](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomTriggers#delete-trigger)
    
*   [Can Workflows Execute Without Contact?](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomTriggers#can-workflows-execute-without-contact)
