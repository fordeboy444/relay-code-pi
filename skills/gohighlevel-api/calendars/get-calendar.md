...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/calendars/get-calendar
- **Summary:** Get calendar by ID

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/calendars/get-calendar#__docusaurus_skipToContent_fallback)
...
Request[​](https://marketplace.gohighlevel.com/docs/ghl/calendars/get-calendar#request "Direct link to request")
...
Responses[​](https://marketplace.gohighlevel.com/docs/ghl/calendars/get-calendar#responses "Direct link to Responses")
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/calendars/ocQHyuzHvysMo5N5VsXc' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>'
