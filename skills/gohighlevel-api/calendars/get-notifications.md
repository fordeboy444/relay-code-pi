...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/calendars/get-event-notification
- **Summary:** Get calendar notifications based on query

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/calendars/get-event-notification#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/calendars/:calendarId/notifications?limit=100' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>'
