...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/calendars/fetch-calendar-resources
- **Summary:** List calendar resources by resource type and location ID (Services V1)

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/calendars/fetch-calendar-resources#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/calendars/resources/:resourceType' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>'
