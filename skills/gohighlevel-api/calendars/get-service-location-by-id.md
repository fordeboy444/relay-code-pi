...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/calendars/get-service-location-by-id
- **Summary:** Get service location by ID

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/calendars/get-service-location-by-id#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/calendars/services/locations/IkqiJlXJ7o9h61tCHHod' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>'
