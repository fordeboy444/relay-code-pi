...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/calendars/create-block-slot
- **Summary:** Create block slot

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/calendars/create-block-slot#__docusaurus_skipToContent_fallback)
