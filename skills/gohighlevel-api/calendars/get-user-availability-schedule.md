...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/calendars/get-schedule-by-id
...
[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/calendars/get-schedule-by-id#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/calendars/schedules/IkqiJlXJ7o9h61tCHHod' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>'
