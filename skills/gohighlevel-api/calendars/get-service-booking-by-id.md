...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/calendars/get-service-booking-by-id
- **Summary:** Get a specific service booking by ID

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/calendars/get-service-booking-by-id#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/calendars/services/bookings/IkqiJlXJ7o9h61tCHHod' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>'
