...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/calendars/delete-calendar
- **Summary:** Delete calendar by ID

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/calendars/delete-calendar#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L -X DELETE 'https://services.leadconnectorhq.com/calendars/ocQHyuzHvysMo5N5VsXc' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>'
