...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/calendars/delete-event-notification
- **Summary:** Delete notification

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/calendars/delete-event-notification#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L -X DELETE 'https://services.leadconnectorhq.com/calendars/:calendarId/notifications/:notificationId' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>'
