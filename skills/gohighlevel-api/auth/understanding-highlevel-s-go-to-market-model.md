...
[Skip to main content](https://marketplace.gohighlevel.com/docs/oauth/AgencyVsSubAccount#__docusaurus_skipToContent_fallback)
...
*   [1\. Agencies as HighLevel’s Primary Customers](https://marketplace.gohighlevel.com/docs/oauth/AgencyVsSubAccount#1-agencies-as-highlevels-primary-customers)
    *   [License Holders](https://marketplace.gohighlevel.com/docs/oauth/AgencyVsSubAccount#license-holders)
        
    *   [Revenue Streams](https://marketplace.gohighlevel.com/docs/oauth/AgencyVsSubAccount#revenue-streams)
        
    *   [Scale Through Reselling](https://marketplace.gohighlevel.com/docs/oauth/AgencyVsSubAccount#scale-through-reselling)
        
*   [2\. White-Labeling: Agencies as the Face of the Platform](https://marketplace.gohighlevel.com/docs/oauth/AgencyVsSubAccount#2-white-labeling-agencies-as-the-face-of-the-platform)
    *   [Custom Branding](https://marketplace.gohighlevel.com/docs/oauth/AgencyVsSubAccount#custom-branding)
        
    *   [Custom Domains](https://marketplace.gohighlevel.com/docs/oauth/AgencyVsSubAccount#custom-domains)
        
    *   [UI Obfuscation](https://marketplace.gohighlevel.com/docs/oauth/AgencyVsSubAccount#ui-obfuscation)
        
*   [3\. What This Means for App Developers](https://marketplace.gohighlevel.com/docs/oauth/AgencyVsSubAccount#3-what-this-means-for-app-developers)
    *   [Your Buyer Is the Agency](https://marketplace.gohighlevel.com/docs/oauth/AgencyVsSubAccount#your-buyer-is-the-agency)
        
    *   [Revenue Share & Billing](https://marketplace.gohighlevel.com/docs/oauth/AgencyVsSubAccount#revenue-share--billing)
        
*   [4\. Tips for Thriving in the HighLevel Ecosystem](https://marketplace.gohighlevel.com/docs/oauth/AgencyVsSubAccount#4-tips-for-thriving-in-the-highlevel-ecosystem)
