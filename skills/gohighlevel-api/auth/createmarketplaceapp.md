...
- **URL:** https://marketplace.gohighlevel.com/docs/oauth/CreateMarketplaceApp
- **Summary:** This section walks you through creating a Marketplace App in HighLevel—from creating the app record in the Developer Portal, to completing your listing, generating OAuth credentials, and installing the app for testing. 1) Sign in to your Developer Account​ Sign in to your Developer Account") 1.

[Skip to main content](https://marketplace.gohighlevel.com/docs/oauth/CreateMarketplaceApp#__docusaurus_skipToContent_fallback)
...
*   [1) Sign in to your Developer Account](https://marketplace.gohighlevel.com/docs/oauth/CreateMarketplaceApp#1-sign-in-to-your-developer-account)
    
*   [2) Configure basic app details](https://marketplace.gohighlevel.com/docs/oauth/CreateMarketplaceApp#2-configure-basic-app-details)
    *   [App Name](https://marketplace.gohighlevel.com/docs/oauth/CreateMarketplaceApp#app-name)
        
    *   [App Type: Private vs Public](https://marketplace.gohighlevel.com/docs/oauth/CreateMarketplaceApp#app-type-private-vs-public)
        
    *   [Target User](https://marketplace.gohighlevel.com/docs/oauth/CreateMarketplaceApp#target-user)
        
    *   [Who Can Install](https://marketplace.gohighlevel.com/docs/oauth/CreateMarketplaceApp#who-can-install)
        
    *   [Listing Type](https://marketplace.gohighlevel.com/docs/oauth/CreateMarketplaceApp#listing-type)
        
*   [3) Understand the app workspace](https://marketplace.gohighlevel.com/docs/oauth/CreateMarketplaceApp#3-understand-the-app-workspace)
    
*   [4) Build section](https://marketplace.gohighlevel.com/docs/oauth/CreateMarketplaceApp#4-build-section)
    *   [4.1 Profile](https://marketplace.gohighlevel.com/docs/oauth/CreateMarketplaceApp#41-profile)
        
    *   [4.2 Pricing](https://marketplace.gohighlevel.com/docs/oauth/CreateMarketplaceApp#42-pricing)
        
    *   [4.3 Modules](https://marketplace.gohighlevel.com/docs/oauth/CreateMarketplaceApp#43-modules)
        
    *   [4.4 Advanced Settings](https://marketplace.gohighlevel.com/docs/oauth/CreateMarketplaceApp#44-advanced-settings)
        
*   [5) Manage section](https://marketplace.gohighlevel.com/docs/oauth/CreateMarketplaceApp#5-manage-section)
    *   [5.1 Versions](https://marketplace.gohighlevel.com/docs/oauth/CreateMarketplaceApp#51-versions)
        
    *   [5.2 Secrets (Client Keys + Shared Secret Key)](https://marketplace.gohighlevel.com/docs/oauth/CreateMarketplaceApp#52-secrets-client-keys--shared-secret-key)
        
*   [6) Insights section: adoption and usage visibility](https://marketplace.gohighlevel.com/docs/oauth/CreateMarketplaceApp#6-insights-section-adoption-and-usage-visibility)
