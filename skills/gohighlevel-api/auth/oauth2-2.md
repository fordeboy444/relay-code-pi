...
- **Summary:** OAuth 2.0 is a standard protocol that authorizes a client application (like a third-party app) to access specific resources on behalf of a user, without sharing the user’s password. It’s widely used for APIs that need secure, delegated access.

[Skip to main content](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0#__docusaurus_skipToContent_fallback)
...
*   **Scopes:** Scopes define the level of access your app will have — what data it can read or what actions it can perform on behalf of the user. [Click Here](https://marketplace.gohighlevel.com/docs/Authorization/Scopes)
     to find all the available Scopes.
...
*   Exchange the code for an Access Token via the OAuth 2.0 [Get Access Token](https://marketplace.gohighlevel.com/docs/ghl/oauth/get-access-token)
     API.
...
Once you have received the Authorization code on your redirect URl you are expected to use [Get Access Token API](https://marketplace.gohighlevel.com/docs/ghl/oauth/get-access-token)
 endpoint to generate the Acces Token which you can then use to run the API endpoints.
...
*   [1\. Register an OAuth App](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0#1-register-an-oauth-app)
    
*   [2\. Add the App to Your Desired Location](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0#2-add-the-app-to-your-desired-location)
    
*   [3\. Get the Installation URL](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0#3-get-the-installation-url)
    
*   [4\. Listening to Webhook Events](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0#4-listening-to-webhook-events)
    *   [Important: App Install Webhook](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0#important-app-install-webhook)
        
*   [5\. Exchange Authorization Code for Access Token](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0#5-exchange-authorization-code-for-access-token)
    
*   [6\. Refresh Token Usage](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0#6-refresh-token-usage)
    
*   [7\. Types of Access Token](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0#7-types-of-access-token)
    
*   [8\. Create Sub-Account Token from Agency Token](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0#8-create-sub-account-token-from-agency-token)
