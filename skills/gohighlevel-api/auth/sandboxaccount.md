...
- **Summary:** A Sandbox account is a non-production HighLevel environment created for Marketplace developers.

[Skip to main content](https://marketplace.gohighlevel.com/docs/oauth/SandboxAccount#__docusaurus_skipToContent_fallback)
...
*   [Overview](https://marketplace.gohighlevel.com/docs/oauth/SandboxAccount#overview)
    
*   [What is a Sandbox Account?](https://marketplace.gohighlevel.com/docs/oauth/SandboxAccount#what-is-a-sandbox-account)
    
*   [Eligibility: Who Can Create a Sandbox Account?](https://marketplace.gohighlevel.com/docs/oauth/SandboxAccount#eligibility-who-can-create-a-sandbox-account)
    
*   [How to Create a Sandbox Account](https://marketplace.gohighlevel.com/docs/oauth/SandboxAccount#how-to-create-a-sandbox-account)
    *   [Steps](https://marketplace.gohighlevel.com/docs/oauth/SandboxAccount#steps)
        
    *   [Result](https://marketplace.gohighlevel.com/docs/oauth/SandboxAccount#result)
        
*   [How to Access the Sandbox Account](https://marketplace.gohighlevel.com/docs/oauth/SandboxAccount#how-to-access-the-sandbox-account)
    
*   [Sandbox Account Lifetime (Active Duration)](https://marketplace.gohighlevel.com/docs/oauth/SandboxAccount#sandbox-account-lifetime-active-duration)
    
*   [How to Use Sandbox for App Development](https://marketplace.gohighlevel.com/docs/oauth/SandboxAccount#how-to-use-sandbox-for-app-development)
