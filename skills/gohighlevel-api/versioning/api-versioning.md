...
- **URL:** https://marketplace.gohighlevel.com/docs/Versioning
- **Summary:** The HighLevel Public API is versioned to ensure developers have a stable surface to build on while the platform continues to evolve. The version is specified per-request using the Version request header.

[Skip to main content](https://marketplace.gohighlevel.com/docs/Versioning#__docusaurus_skipToContent_fallback)
...
*   [Versioning Schemes](https://marketplace.gohighlevel.com/docs/Versioning#versioning-schemes)
    
*   [Supported Versions](https://marketplace.gohighlevel.com/docs/Versioning#supported-versions)
