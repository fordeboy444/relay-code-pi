...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice
- **Summary:** API to create an invoice

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice#__docusaurus_skipToContent_fallback)
