...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/payments/list-coupons
- **Summary:** The 'List Coupons' API allows you to retrieve a list of all coupons available in your location. Use this endpoint to view all promotional offers and special discounts for your customers.

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/payments/list-coupons#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/payments/coupon/list?altId=BQdAwxa0ky1iK2sstLGJ&altType=location&limit=100&status=active&search=DEAL50' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>'
...
status — query\---scheduledactiveexpired
