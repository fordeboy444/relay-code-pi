...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/social-planner/update-queue-item
- **Summary:** Updates the content or variations of a specific item within a category queue.

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/social-planner/update-queue-item#__docusaurus_skipToContent_fallback)
...
**Example:** `Queue item updated successfully`
