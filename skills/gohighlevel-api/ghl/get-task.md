...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/contacts/get-task
- **Summary:** Get Task

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/contacts/get-task#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/contacts/ve9EPM428h8vShlRW1KT/tasks/ocQHyuzHvysMo5N5VsXc' \-H 'Accept: application/json' \-H 'Version: v3' \-H 'Authorization: Bearer <Authorization>'
