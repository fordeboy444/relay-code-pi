...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate
- **Summary:** Create a new invoice from an existing estimate

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate#__docusaurus_skipToContent_fallback)
...
**Example:** `v2`
    ...
    {  "altId": "6578278e879ad2646715ba9c",  "altType": "location",  "markAsInvoiced": true,  "version": "v2"}
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/invoices/estimate/5f9d6d8b1b2d2c001f2d9e4b/invoice' \-H 'Content-Type: application/json' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>' \-d '{  "altId": "6578278e879ad2646715ba9c",  "altType": "location",  "markAsInvoiced": true,  "version": "v2"}'
