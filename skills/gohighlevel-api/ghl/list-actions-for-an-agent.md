...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/conversation-ai/list-actions
- **Summary:** List for actions for an agent

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/conversation-ai/list-actions#__docusaurus_skipToContent_fallback)
...
Request[​](https://marketplace.gohighlevel.com/docs/ghl/conversation-ai/list-actions#request "Direct link to request")
...
Responses[​](https://marketplace.gohighlevel.com/docs/ghl/conversation-ai/list-actions#responses "Direct link to Responses")
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/conversation-ai/agents/:agentId/actions/list' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>'
