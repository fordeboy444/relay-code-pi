...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/invoices/create-new-estimate
- **Summary:** Create a new estimate with the provided details

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-new-estimate#__docusaurus_skipToContent_fallback)
