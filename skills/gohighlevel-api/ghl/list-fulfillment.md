...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment
- **Summary:** List all fulfillment history of an order

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/payments/orders/653f5e0cde5a1314e62a837c/fulfillments?altId=6578278e879ad2646715ba9c' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>'
