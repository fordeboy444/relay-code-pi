...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/invoices/preview-estimate-template
- **Summary:** Get a preview of an estimate template

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/invoices/preview-estimate-template#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/invoices/estimate/template/preview?altId=6578278e879ad2646715ba9c&templateId=5f9d6d8b1b2d2c001f2d9e4b' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>'
