...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/saas-api/list-location-wallet-transactions
- **Summary:** Fetch paginated wallet transactions for a sub-account (location). Supports skip/limit pagination, date-range and charge-type filters, timezone normalization, and additional non-indexed filters in the request body.

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/saas-api/list-location-wallet-transactions#__docusaurus_skipToContent_fallback)
...
https://services.leadconnectorhq.com/saas/locations/:locationId/wallet-transactions
...
Request[​](https://marketplace.gohighlevel.com/docs/ghl/saas-api/list-location-wallet-transactions#request "Direct link to request")
...
Location ID to list transactions for
...
Responses[​](https://marketplace.gohighlevel.com/docs/ghl/saas-api/list-location-wallet-transactions#responses "Direct link to Responses")
...
**type:** http**scopes:** `saas/location.read`**scheme:** bearer**bearerFormat:** JWT**in:** header**description:** Use the Access Token generated with user type as Agency (OR) Private Integration Token of Agency.
