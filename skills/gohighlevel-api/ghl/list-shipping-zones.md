...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/store/list-shipping-zones
- **Summary:** The 'List Shipping Zone' API allows to retrieve a list of shipping zone.

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/store/list-shipping-zones#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/store/shipping-zone?altId=6578278e879ad2646715ba9c&withShippingRate=true' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>'
