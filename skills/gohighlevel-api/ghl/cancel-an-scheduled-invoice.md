...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/invoices/cancel-invoice-schedule
- **Summary:** API to cancel a scheduled invoice by schedule id

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/invoices/cancel-invoice-schedule#__docusaurus_skipToContent_fallback)
...
Request[​](https://marketplace.gohighlevel.com/docs/ghl/invoices/cancel-invoice-schedule#request "Direct link to request")
...
Responses[​](https://marketplace.gohighlevel.com/docs/ghl/invoices/cancel-invoice-schedule#responses "Direct link to Responses")
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/invoices/schedule/6578278e879ad2646715ba9c/cancel' \-H 'Content-Type: application/json' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>' \-d '{  "altId": "6578278e879ad2646715ba9c",  "altType": "location"}'
