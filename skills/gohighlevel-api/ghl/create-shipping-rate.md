...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/store/create-shipping-rate
- **Summary:** The 'Create Shipping Rate' API allows adding a new shipping rate.

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/store/create-shipping-rate#__docusaurus_skipToContent_fallback)
