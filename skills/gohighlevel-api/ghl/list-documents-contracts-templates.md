...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/proposals/list-documents-contracts-templates
- **Summary:** List document contract templates for a location

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/proposals/list-documents-contracts-templates#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/proposals/templates?locationId=jhg64gjhb436fv&dateFrom=2025-02-03T18%3A30%3A00.000Z&dateTo=2025-02-14T18%3A29%3A59.999Z&type=proposal%2Cestimate&name=Template%20Name&isPublicDocument=false&userId=1234567890&limit=10&skip=0' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>'
...
isPublicDocument — query\---truefalse
