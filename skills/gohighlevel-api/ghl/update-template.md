...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/invoices/update-invoice-template
- **Summary:** API to update an template by template id

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/invoices/update-invoice-template#__docusaurus_skipToContent_fallback)
...
Request[​](https://marketplace.gohighlevel.com/docs/ghl/invoices/update-invoice-template#request "Direct link to request")
