...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/store/get-shipping-zones
- **Summary:** The 'List Shipping Zone' API allows to retrieve a paginated list of shipping zone.

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/store/get-shipping-zones#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/store/shipping-zone/6578278e879ad2646715ba9c?altId=6578278e879ad2646715ba9c&withShippingRate=true' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>'
...
withShippingRate — query\---truefalse
