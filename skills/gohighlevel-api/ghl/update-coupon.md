...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/payments/update-coupon
- **Summary:** The 'Update Coupon' API enables you to modify existing coupon details such as discount values, validity periods, usage limits, and other promotional parameters. Use this endpoint to adjust or extend promotional offers for your customers.

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/payments/update-coupon#__docusaurus_skipToContent_fallback)
