...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/invoices/get-invoice-schedule
- **Summary:** API to get an schedule by schedule id

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/invoices/get-invoice-schedule#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/invoices/schedule/6578278e879ad2646715ba9c?altId=6578278e879ad2646715ba9c&altType=location' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>'
