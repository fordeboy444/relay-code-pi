...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/locations/update-recurring-task
- **Summary:** Update Recurring Task

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/locations/update-recurring-task#__docusaurus_skipToContent_fallback)
...
**Example:** `true`
    ...
    {  "title": "Task Name",  "description": "Task Description",  "contactIds": [    "sx6wyHhbFdRXh302Lunr"  ],  "owners": [    "sx6wyHhbFdRXh302Lunr"  ],  "rruleOptions": {    "intervalType": "hourly",    "interval": 1,    "startDate": "2025-07-23T10:00:00.000Z",    "dueAfterSeconds": 600  },  "ignoreTaskCreation": true}
...
*   CURL
    ...
    curl -L -X PUT 'https://services.leadconnectorhq.com/locations/sx6wyHhbFdRXh302Lunr/recurring-tasks/sx6wyHhbFdRXh302Lunr' \-H 'Content-Type: application/json' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>' \-d '{  "title": "Task Name",  "description": "Task Description",  "contactIds": [    "sx6wyHhbFdRXh302Lunr"  ],  "owners": [    "sx6wyHhbFdRXh302Lunr"  ],  "rruleOptions": {    "intervalType": "monthly",    "interval": 2,    "startDate": "2021-09-30T00:00:00.000Z",    "endDate": "2021-09-30T00:00:00.000Z",    "dayOfMonth": 15,    "dayOfWeek": "MO",    "monthOfYear": 1,    "count": 10,    "createTaskIfOverDue": true,    "dueAfterSeconds": 23404000  },  "ignoreTaskCreation": true}'
...
{
  "title": "Task Name",  "description": "Task Description",  "contactIds": \[    "sx6wyHhbFdRXh302Lunr"  \],  "owners": \[    "sx6wyHhbFdRXh302Lunr"  \],  "rruleOptions": {    "intervalType": "monthly",    "interval": 2,    "startDate": "2021-09-30T00:00:00.000Z",    "endDate": "2021-09-30T00:00:00.000Z",    "dayOfMonth": 15,    "dayOfWeek": "MO",    "monthOfYear": 1,    "count": 10,    "createTaskIfOverDue": true,    "dueAfterSeconds": 23404000  },  "ignoreTaskCreation": true
}
Send API Request
