...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-template
- **Summary:** API to create a template

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-template#__docusaurus_skipToContent_fallback)
