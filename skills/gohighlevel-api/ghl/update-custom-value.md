...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/locations/update-custom-value
- **Summary:** Update Custom Value

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/locations/update-custom-value#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L -X PUT 'https://services.leadconnectorhq.com/locations/ve9EPM428h8vShlRW1KT/customValues/kOBjMVAJhFuUeYIojVet' \-H 'Content-Type: application/json' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>' \-d '{  "name": "Custom Field Name",  "value": "Value"}'
