...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/social-planner/reset-queue-item
- **Summary:** Resets a specific queue item to its original state, discarding any modifications made.

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/social-planner/reset-queue-item#__docusaurus_skipToContent_fallback)
...
**Example:** `60af88475f1b2c001f5d5f4b`
    ...
    {  "locationId": "609e126a1c4ae1001291e1b5",  "sessionId": "60af88475f1b2c001f5d5f4b"}
...
A message indicating the result of the operation. Examples: "Queue item reset successfully", "Dummy queue item deleted successfully".

**Example:** `Queue item reset successfully`
...
**scheduledVariationIndex**number
...
*   CURL
    ...
    curl -L -X PUT 'https://services.leadconnectorhq.com/social-media-posting/category/queues/:queueId/items/:itemId/reset' \-H 'Content-Type: application/json' \-H 'Accept: application/json' \-H 'Version: v3' \-H 'Authorization: Bearer <Authorization>' \-d '{  "locationId": "609e126a1c4ae1001291e1b5",  "sessionId": "60af88475f1b2c001f5d5f4b"}'
