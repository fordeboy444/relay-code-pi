...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/conversation-ai/update-action
- **Summary:** Updates an existing action's configuration. This includes modifying the action name, description, trigger conditions, and behavior settings.

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/conversation-ai/update-action#__docusaurus_skipToContent_fallback)
...
Request[​](https://marketplace.gohighlevel.com/docs/ghl/conversation-ai/update-action#request "Direct link to request")
...
Responses[​](https://marketplace.gohighlevel.com/docs/ghl/conversation-ai/update-action#responses "Direct link to Responses")
