...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/store/create-shipping-zone
- **Summary:** The 'Create Shipping Zone' API allows adding a new shipping zone.

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/store/create-shipping-zone#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/store/shipping-zone' \-H 'Content-Type: application/json' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>' \-d '{  "altId": "6578278e879ad2646715ba9c",  "altType": "location",  "name": "North zone",  "countries": [    {      "code": "US",      "states": [        {          "code": "VA"        }      ]    }  ]}'
