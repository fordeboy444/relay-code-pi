...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/invoices/delete-estimate-template
- **Summary:** Delete an existing estimate template

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/invoices/delete-estimate-template#__docusaurus_skipToContent_fallback)
...
Request[​](https://marketplace.gohighlevel.com/docs/ghl/invoices/delete-estimate-template#request "Direct link to request")
...
**Possible values:** \[`location`\]
    ...
    {  "altId": "6578278e879ad2646715ba9c",  "altType": "location"}

Responses[​](https://marketplace.gohighlevel.com/docs/ghl/invoices/delete-estimate-template#responses "Direct link to Responses")
...
*   CURL
    ...
    curl -L -X DELETE 'https://services.leadconnectorhq.com/invoices/estimate/template/5f9d6d8b1b2d2c001f2d9e4b' \-H 'Content-Type: application/json' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>' \-d '{  "altId": "6578278e879ad2646715ba9c",  "altType": "location"}'
