...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/store/update-shipping-zone
- **Summary:** The 'update Shipping Zone' API allows update a shipping zone to the system.

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/store/update-shipping-zone#__docusaurus_skipToContent_fallback)
...
*   \]
    ...
    {  "altId": "6578278e879ad2646715ba9c",  "altType": "location",  "name": "North zone",  "countries": [    {      "code": "US",      "states": [        {          "code": "VA"        }      ]    }  ]}
...
*   CURL
    ...
    curl -L -X PUT 'https://services.leadconnectorhq.com/store/shipping-zone/6578278e879ad2646715ba9c' \-H 'Content-Type: application/json' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>' \-d '{  "altId": "6578278e879ad2646715ba9c",  "altType": "location",  "name": "North zone",  "countries": [    {      "code": "US",      "states": [        {          "code": "VA"        }      ]    }  ]}'
