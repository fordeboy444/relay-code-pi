...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/invoices/schedule-invoice-schedule
- **Summary:** API to schedule an schedule invoice to start sending to the customer

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/invoices/schedule-invoice-schedule#__docusaurus_skipToContent_fallback)
...
Request[​](https://marketplace.gohighlevel.com/docs/ghl/invoices/schedule-invoice-schedule#request "Direct link to request")
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/invoices/schedule/6578278e879ad2646715ba9c/schedule' \-H 'Content-Type: application/json' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>' \-d '{  "altId": "6578278e879ad2646715ba9c",  "altType": "location",  "liveMode": true,  "autoPayment": {    "enable": true,    "type": "string",    "paymentMethodId": "string",    "customerId": "string",    "card": {      "brand": "string",      "last4": "string"    },    "usBankAccount": {      "bank_name": "string",      "last4": "string"    },    "sepaDirectDebit": {      "bank_code": "string",      "last4": "string",      "branch_code": "string"    },    "bacsDirectDebit": {      "sort_code": "string",      "last4": "string"    },    "becsDirectDebit": {      "bsb_number": "string",      "last4": "string"    },    "cardId": "string",    "provider": {}  }}'
