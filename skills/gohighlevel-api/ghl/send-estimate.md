...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/invoices/send-estimate
- **Summary:** API to send estimate by estimate id

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/invoices/send-estimate#__docusaurus_skipToContent_fallback)
...
**Example:** `Estimate`
    ...
    {  "altId": "6578278e879ad2646715ba9c",  "altType": "location",  "action": "sms_and_email",  "liveMode": true,  "userId": "6578278e879ad2646715ba9c",  "sentFrom": {    "fromName": "Alex",    "fromEmail": "alex@example.com"  },  "estimateName": "Estimate"}
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/invoices/estimate/5f9d6d8b1b2d2c001f2d9e4b/send' \-H 'Content-Type: application/json' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>' \--data-raw '{  "altId": "6578278e879ad2646715ba9c",  "altType": "location",  "action": "sms_and_email",  "liveMode": true,  "userId": "6578278e879ad2646715ba9c",  "sentFrom": {    "fromName": "Alex",    "fromEmail": "alex@example.com"  },  "estimateName": "Estimate"}'
