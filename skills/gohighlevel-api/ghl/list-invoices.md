...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/invoices/list-invoices
- **Summary:** API to get list of invoices

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/invoices/list-invoices#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/invoices/?altId=6578278e879ad2646715ba9c&altType=location&startAt=2023-01-01&endAt=2023-01-01&search=Alex&paymentMode=live&contactId=AmuzcoPBpgKeccNsFlib&limit=10&offset=10&sortField=issueDate&sortOrder=descend' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>'
...
sortField — query\---issueDate

sortOrder — query\---ascenddescend
