...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/social-planner/create-queue-item
- **Summary:** Adds a new post item to a queue. Use sessionId for edit session or directToQueue for immediate addition.

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/social-planner/create-queue-item#__docusaurus_skipToContent_fallback)
...
\
**Example:** `https://example.com/blog/post-title`\
\
**metaImage**object\
\
URL of the image to display in link preview.\
\
**Example:** `https://example.com/images/preview.png`\
\
**ogTitle**object\
\
Title to display in link preview.\
\
**Example:** `Check out our latest blog post!`\
\
*   \]
...
**Example:** `Queue item created successfully`
...
**Example:** `60af88475f1b2c001f5d5f4d`
...
**Possible values:** \[`composer`, `csv`, `recurring`, `review`, `rss`, `template-library`, `category-queue`, `native`\]
...
**Example:** `60af88475f1b2c001f5d5f4e`
