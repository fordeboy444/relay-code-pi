...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/invoices/void-invoice
- **Summary:** API to delete invoice by invoice id

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/invoices/void-invoice#__docusaurus_skipToContent_fallback)
...
Request[​](https://marketplace.gohighlevel.com/docs/ghl/invoices/void-invoice#request "Direct link to request")
...
Responses[​](https://marketplace.gohighlevel.com/docs/ghl/invoices/void-invoice#responses "Direct link to Responses")
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/invoices/6578278e879ad2646715ba9c/void' \-H 'Content-Type: application/json' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>' \-d '{  "altId": "6578278e879ad2646715ba9c",  "altType": "location"}'
