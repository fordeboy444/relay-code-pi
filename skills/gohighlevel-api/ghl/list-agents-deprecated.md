...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/agent-studio/get-agents-deprecated
- **Summary:** **Deprecated endpoint - use GET /agent instead.**

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/agent-studio/get-agents-deprecated#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/agent-studio/public-api/agents?locationId=C2QujeCh8ZnC7al2InWR&limit=20&offset=0&source=api' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>'
