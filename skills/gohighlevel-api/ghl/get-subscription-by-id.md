...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/payments/get-subscription-by-id
- **Summary:** The 'Get Subscription by ID' API allows to retrieve information for a specific subscription using its unique identifier. Use this endpoint to fetch details for a single subscription based on the provided subscription ID.

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/payments/get-subscription-by-id#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/payments/subscriptions/6322e9c9e39fc14ab3ed7042?altId=3SwdhCu3svxI8AKsPJt6&altType=location' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>'
