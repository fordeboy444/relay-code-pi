# Voice AI API | HighLevel API

- **URL:** https://marketplace.gohighlevel.com/docs/ghl/voice-ai/voice-ai-api
- **Summary:** Documentation for Voice AI API

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/voice-ai-api#__docusaurus_skipToContent_fallback)
...
Authentication[​](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/voice-ai-api#authentication "Direct link to Authentication")
