...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings
- **Summary:** Get store settings by altId and altType.

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/store/store-setting?altId=6578278e879ad2646715ba9c' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>'
