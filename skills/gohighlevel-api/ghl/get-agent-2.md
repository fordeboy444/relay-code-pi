...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-agent
- **Summary:** Retrieve detailed configuration and settings for a specific voice AI agent

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-agent#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/voice-ai/agents/507f1f77bcf86cd799439011?locationId=LOC123456789ABCDEF' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>'
