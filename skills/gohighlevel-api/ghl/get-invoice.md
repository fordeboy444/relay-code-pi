...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/invoices/get-invoice
- **Summary:** API to get invoice by invoice id

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/invoices/get-invoice#__docusaurus_skipToContent_fallback)
...
Request[​](https://marketplace.gohighlevel.com/docs/ghl/invoices/get-invoice#request "Direct link to request")
...
Responses[​](https://marketplace.gohighlevel.com/docs/ghl/invoices/get-invoice#responses "Direct link to Responses")
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/invoices/6578278e879ad2646715ba9c?altId=6578278e879ad2646715ba9c&altType=location' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>'
