...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/invoices/delete-estimate
- **Summary:** Delete an existing estimate

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/invoices/delete-estimate#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L -X DELETE 'https://services.leadconnectorhq.com/invoices/estimate/5f9d6d8b1b2d2c001f2d9e4b' \-H 'Content-Type: application/json' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>' \-d '{  "altId": "6578278e879ad2646715ba9c",  "altType": "location"}'
