...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/invoices/update-invoice-schedule
- **Summary:** API to update an schedule by schedule id

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/invoices/update-invoice-schedule#__docusaurus_skipToContent_fallback)
