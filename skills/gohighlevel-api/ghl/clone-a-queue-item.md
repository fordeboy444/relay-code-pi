...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/social-planner/clone-queue-item
- **Summary:** Duplicates an existing queue item at a specified order position. Requires an active edit session.

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/social-planner/clone-queue-item#__docusaurus_skipToContent_fallback)
...
**Example:** `1.5`
    ...
    {  "locationId": "609e126a1c4ae1001291e1b5",  "sessionId": "60af88475f1b2c001f5d5f4b",  "order": 1.5}
...
**Example:** `Queue item cloned successfully`
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/social-media-posting/category/queues/:queueId/items/:itemId/clone' \-H 'Content-Type: application/json' \-H 'Accept: application/json' \-H 'Version: v3' \-H 'Authorization: Bearer <Authorization>' \-d '{  "locationId": "609e126a1c4ae1001291e1b5",  "sessionId": "60af88475f1b2c001f5d5f4b",  "order": 1.5}'
