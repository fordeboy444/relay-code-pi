...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/invoices/update-and-schedule-invoice-schedule
- **Summary:** API to update scheduled recurring invoice

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/invoices/update-and-schedule-invoice-schedule#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L -X POST 'https://services.leadconnectorhq.com/invoices/schedule/6578278e879ad2646715ba9c/updateAndSchedule' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>'
