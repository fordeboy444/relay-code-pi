...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/custom-menus/update-custom-menu
- **Summary:** Updates an existing custom menu for a given company. Requires authentication and proper permissions.

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/custom-menus/update-custom-menu#__docusaurus_skipToContent_fallback)
