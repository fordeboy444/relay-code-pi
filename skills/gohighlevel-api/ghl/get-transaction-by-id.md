...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/payments/get-transaction-by-id
- **Summary:** The 'Get Transaction by ID' API allows to retrieve information for a specific transaction using its unique identifier. Use this endpoint to fetch details for a single transaction based on the provided transaction ID.

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/payments/get-transaction-by-id#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/payments/transactions/61dd0feac077f72010f78804?locationId=3SwdhCu3svxI8AKsPJt6&altId=3SwdhCu3svxI8AKsPJt6&altType=location' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>'
