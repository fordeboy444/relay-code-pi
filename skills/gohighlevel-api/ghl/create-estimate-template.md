...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/invoices/create-estimate-template
- **Summary:** Create a new estimate template

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-estimate-template#__docusaurus_skipToContent_fallback)
