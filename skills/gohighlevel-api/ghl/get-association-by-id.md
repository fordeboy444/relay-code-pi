...
- **URL:** https://marketplace.gohighlevel.com/docs/ghl/associations/get-association-by-id
- **Summary:** Using this api you can get SYSTEM_DEFINED / USER_DEFINED association by id

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/associations/get-association-by-id#__docusaurus_skipToContent_fallback)
...
*   CURL
    ...
    curl -L 'https://services.leadconnectorhq.com/associations/:associationId' \-H 'Accept: application/json' \-H 'Authorization: Bearer <Authorization>'
