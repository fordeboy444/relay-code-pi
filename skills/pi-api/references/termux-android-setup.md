...
- **URL:** https://pi.dev/docs/latest/termux
- **Command:** `Termux (Android) Setup`
- **Summary:** Pi runs on Android via Termux, a terminal emulator and Linux environment for Android. 1.
