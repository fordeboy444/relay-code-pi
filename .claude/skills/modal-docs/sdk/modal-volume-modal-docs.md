...
- **URL:** https://modal.com/docs/sdk/py/latest/modal.Volume
- **Summary:** A writeable volume that can be used to share files between one or more Modal functions.
...
sub_path str | PurePosixPath | None

Only mount this sub_path directory from the Volume. If the directory doesn't exist in the Volume, it will be created when the container starts up.
...
version "modal_proto.api_pb2.VolumeFsVersion.ValueType | None"
...
Note - this function is primarily intended to be used outside of a Modal App. For more information on downloading files from a Modal Volume, see [the guide](https://modal.com/docs/guide/volumes)
.
...
[modal.Volume](https://modal.com/docs/sdk/py/latest/modal.Volume#modalvolume)
[hydrate](https://modal.com/docs/sdk/py/latest/modal.Volume#hydrate)
[objects](https://modal.com/docs/sdk/py/latest/modal.Volume#objects)
[create](https://modal.com/docs/sdk/py/latest/modal.Volume#objectscreate)
[list](https://modal.com/docs/sdk/py/latest/modal.Volume#objectslist)
[delete](https://modal.com/docs/sdk/py/latest/modal.Volume#objectsdelete)
[name](https://modal.com/docs/sdk/py/latest/modal.Volume#name)
[with_mount_options](https://modal.com/docs/sdk/py/latest/modal.Volume#with_mount_options)
[from_name](https://modal.com/docs/sdk/py/latest/modal.Volume#from_name)
[from_id](https://modal.com/docs/sdk/py/latest/modal.Volume#from_id)
[ephemeral](https://modal.com/docs/sdk/py/latest/modal.Volume#ephemeral)
[info](https://modal.com/docs/sdk/py/latest/modal.Volume#info)
[commit](https://modal.com/docs/sdk/py/latest/modal.Volume#commit)
[reload](https://modal.com/docs/sdk/py/latest/modal.Volume#reload)
[iterdir](https://modal.com/docs/sdk/py/latest/modal.Volume#iterdir)
[listdir](https://modal.com/docs/sdk/py/latest/modal.Volume#listdir)
[read_file](https://modal.com/docs/sdk/py/latest/modal.Volume#read_file)
[remove_file](https://modal.com/docs/sdk/py/latest/modal.Volume#remove_file)
[copy_files](https://modal.com/docs/sdk/py/latest/modal.Volume#copy_files)
[batch_upload](https://modal.com/docs/sdk/py/latest/modal.Volume#batch_upload)
[rename](https://modal.com/docs/sdk/py/latest/modal.Volume#rename)
