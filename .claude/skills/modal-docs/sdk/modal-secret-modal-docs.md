...
- **URL:** https://modal.com/docs/sdk/py/latest/modal.Secret
- **Summary:** Secrets provide a dictionary of environment variables for images.
...
See [the secrets guide page](https://modal.com/docs/guide/secrets)
...
[modal.Secret](https://modal.com/docs/sdk/py/latest/modal.Secret#modalsecret)
[hydrate](https://modal.com/docs/sdk/py/latest/modal.Secret#hydrate)
[objects](https://modal.com/docs/sdk/py/latest/modal.Secret#objects)
[create](https://modal.com/docs/sdk/py/latest/modal.Secret#objectscreate)
[list](https://modal.com/docs/sdk/py/latest/modal.Secret#objectslist)
[delete](https://modal.com/docs/sdk/py/latest/modal.Secret#objectsdelete)
[name](https://modal.com/docs/sdk/py/latest/modal.Secret#name)
[from_dict](https://modal.com/docs/sdk/py/latest/modal.Secret#from_dict)
[from_local_environ](https://modal.com/docs/sdk/py/latest/modal.Secret#from_local_environ)
[from_dotenv](https://modal.com/docs/sdk/py/latest/modal.Secret#from_dotenv)
[from_name](https://modal.com/docs/sdk/py/latest/modal.Secret#from_name)
[info](https://modal.com/docs/sdk/py/latest/modal.Secret#info)
[update](https://modal.com/docs/sdk/py/latest/modal.Secret#update)
