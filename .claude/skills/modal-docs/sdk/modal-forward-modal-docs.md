# modal.forward | Modal Docs

- **URL:** https://modal.com/docs/sdk/py/latest/modal.forward
- **Summary:** Expose a port publicly from inside a running Modal container, with TLS.
...
[modal.forward](https://modal.com/docs/sdk/py/latest/modal.forward#modalforward)
