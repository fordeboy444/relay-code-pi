# modal.Period | Modal Docs

- **URL:** https://modal.com/docs/sdk/py/latest/modal.Period
- **Summary:** Create a schedule that runs every given time interval.
...
This behaves similar to the [dateutil](https://dateutil.readthedocs.io/en/latest/relativedelta.html)
 package.
...
[modal.Period](https://modal.com/docs/sdk/py/latest/modal.Period#modalperiod)
