...
- **URL:** https://modal.com/docs/sdk/py/latest/modal.FunctionCall
- **Summary:** A reference to an executed function call.
...
\
See [`modal.call_graph`](https://modal.com/docs/sdk/py/latest/modal.call_graph)\
 reference page for documentation on the structure of the returned `InputInfo` items.\
\
**Returns**\
\
...
\
[modal.FunctionCall](https://modal.com/docs/sdk/py/latest/modal.FunctionCall#modalfunctioncall)\
[hydrate](https://modal.com/docs/sdk/py/latest/modal.FunctionCall#hydrate)\
[num_inputs](https://modal.com/docs/sdk/py/latest/modal.FunctionCall#num_inputs)\
[get](https://modal.com/docs/sdk/py/latest/modal.FunctionCall#get)\
[iter](https://modal.com/docs/sdk/py/latest/modal.FunctionCall#iter)\
[get_call_graph](https://modal.com/docs/sdk/py/latest/modal.FunctionCall#get_call_graph)\
[cancel](https://modal.com/docs/sdk/py/latest/modal.FunctionCall#cancel)\
[from_id](https://modal.com/docs/sdk/py/latest/modal.FunctionCall#from_id)\
[gather](https://modal.com/docs/sdk/py/latest/modal.FunctionCall#gather)
