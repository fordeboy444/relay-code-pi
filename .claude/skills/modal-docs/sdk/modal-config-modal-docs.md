...
- **URL:** https://modal.com/docs/sdk/py/latest/modal.config
- **Summary:** Modal intentionally keeps configurability to a minimum.
...
*   `log_pattern` (in the .toml file) / `MODAL_LOG_PATTERN` (as an env var). Defaults to `"[modal-client] %(asctime)s %(message)s"` The log formatting pattern that will be used by the modal client itself. See [https://docs.python.org/3/library/logging.html#logrecord-attributes](https://docs.python.org/3/library/logging.html#logrecord-attributes)
     for available log attributes.
*   `dev_suffix` (in the .toml file) / `MODAL_DEV_SUFFIX` (as an env var). Overrides the default `-dev` suffix added to URLs generated for Web Functions when the App is ephemeral (i.e., created via `modal serve`). Must be a short alphanumeric string.
...
[modal.config](https://modal.com/docs/sdk/py/latest/modal.config#modalconfig)
[.modal.toml](https://modal.com/docs/sdk/py/latest/modal.config#modaltoml)
[Setting tokens using the CLI](https://modal.com/docs/sdk/py/latest/modal.config#setting-tokens-using-the-cli)
[Other configuration options](https://modal.com/docs/sdk/py/latest/modal.config#other-configuration-options)
[Meta-configuration](https://modal.com/docs/sdk/py/latest/modal.config#meta-configuration)
[Config](https://modal.com/docs/sdk/py/latest/modal.config#modalconfigconfig)
[get](https://modal.com/docs/sdk/py/latest/modal.config#get)
[override_locally](https://modal.com/docs/sdk/py/latest/modal.config#override_locally)
[to_dict](https://modal.com/docs/sdk/py/latest/modal.config#to_dict)
[config_profiles](https://modal.com/docs/sdk/py/latest/modal.config#modalconfigconfig_profiles)
[config_set_active_profile](https://modal.com/docs/sdk/py/latest/modal.config#modalconfigconfig_set_active_profile)
