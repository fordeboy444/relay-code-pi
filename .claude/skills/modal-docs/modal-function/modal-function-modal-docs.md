...
[modal.Function](https://modal.com/docs/reference/modal.Function#modalfunction)
[hydrate](https://modal.com/docs/reference/modal.Function#hydrate)
[update_autoscaler](https://modal.com/docs/reference/modal.Function#update_autoscaler)
[from_name](https://modal.com/docs/reference/modal.Function#from_name)
[get_web_url](https://modal.com/docs/reference/modal.Function#get_web_url)
[with_options](https://modal.com/docs/reference/modal.Function#with_options)
[with_concurrency](https://modal.com/docs/reference/modal.Function#with_concurrency)
[with_batching](https://modal.com/docs/reference/modal.Function#with_batching)
[remote](https://modal.com/docs/reference/modal.Function#remote)
[remote_gen](https://modal.com/docs/reference/modal.Function#remote_gen)
[local](https://modal.com/docs/reference/modal.Function#local)
[spawn](https://modal.com/docs/reference/modal.Function#spawn)
[get_raw_f](https://modal.com/docs/reference/modal.Function#get_raw_f)
[get_current_stats](https://modal.com/docs/reference/modal.Function#get_current_stats)
[map](https://modal.com/docs/reference/modal.Function#map)
[starmap](https://modal.com/docs/reference/modal.Function#starmap)
[for_each](https://modal.com/docs/reference/modal.Function#for_each)
[spawn_map](https://modal.com/docs/reference/modal.Function#spawn_map)
