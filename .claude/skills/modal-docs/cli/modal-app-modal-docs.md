...
- **URL:** https://modal.com/docs/cli/latest/app
- **Summary:** Manage deployed and running apps.
...
[modal app](https://modal.com/docs/cli/latest/app#modal-app)
[modal app dashboard](https://modal.com/docs/cli/latest/app#modal-app-dashboard)
[modal app history](https://modal.com/docs/cli/latest/app#modal-app-history)
[modal app list](https://modal.com/docs/cli/latest/app#modal-app-list)
[modal app logs](https://modal.com/docs/cli/latest/app#modal-app-logs)
[modal app rollback](https://modal.com/docs/cli/latest/app#modal-app-rollback)
[modal app rollover](https://modal.com/docs/cli/latest/app#modal-app-rollover)
[modal app stop](https://modal.com/docs/cli/latest/app#modal-app-stop)
