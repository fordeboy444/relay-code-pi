# modal container | Modal Docs

- **URL:** https://modal.com/docs/cli/latest/container
- **Summary:** Manage and connect to running containers.
...
This will send the container a SIGINT signal that Modal will handle. Any inputs that are currently running on the container will be cancelled and rescheduled on other containers.
...
[modal container](https://modal.com/docs/cli/latest/container#modal-container)
[modal container exec](https://modal.com/docs/cli/latest/container#modal-container-exec)
[modal container list](https://modal.com/docs/cli/latest/container#modal-container-list)
[modal container logs](https://modal.com/docs/cli/latest/container#modal-container-logs)
[modal container stop](https://modal.com/docs/cli/latest/container#modal-container-stop)
