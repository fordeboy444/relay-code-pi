# modal deploy | Modal Docs

- **URL:** https://modal.com/docs/cli/latest/deploy
- **Summary:** Deploy a Modal application.
...
Examples: modal deploy my_script.py modal deploy -m my_package.my_mod
...
[modal deploy](https://modal.com/docs/cli/latest/deploy#modal-deploy)
