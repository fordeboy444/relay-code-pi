# modal serve | Modal Docs

- **URL:** https://modal.com/docs/cli/latest/serve
- **Summary:** Expose Web Functions with hot-reloading on code changes.
...
[modal serve](https://modal.com/docs/cli/latest/serve#modal-serve)
