...
- **URL:** https://modal.com/docs/cli/latest/billing
- **Summary:** View workspace billing information.
...
This command provides a CLI frontend for the [`Workspace.billing.report`](https://modal.com/docs/sdk/py/latest/modal.Workspace#billingreport)
 API.
...
[modal billing](https://modal.com/docs/cli/latest/billing#modal-billing)
