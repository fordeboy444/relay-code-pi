...
- **URL:** https://modal.com/docs/guide/endpoint-metrics
- **Summary:** Every endpoint reports live inference metrics so you can see how it’s performing under real traffic — latency, throughput, and how many requests are in flight. Open an endpoint from the Endpoints tab and go to the Activity view to see them.
...
*   Endpoint metrics are available in the dashboard. To get repeatable performance numbers under a controlled load, [run a benchmark](https://modal.com/docs/guide/endpoint-benchmarks)
    .

[Endpoint metrics](https://modal.com/docs/guide/endpoint-metrics#endpoint-metrics)
[What the metrics mean](https://modal.com/docs/guide/endpoint-metrics#what-the-metrics-mean)
[Caveats](https://modal.com/docs/guide/endpoint-metrics#caveats)
