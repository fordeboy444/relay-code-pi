...
- **Summary:** Modal can be used as a scalable job queue to handle asynchronous tasks submitted from a web app or any other Python application. This allows you to offload up to 1 million long-running or resource-intensive tasks to Modal, while your main application remains responsive.
...
2.  Submitting a job using [`modal.Function.spawn()`](https://modal.com/docs/sdk/py/latest/modal.Function#spawn)
    
3.  Polling for the job’s result using [`modal.FunctionCall.get()`](https://modal.com/docs/sdk/py/latest/modal.FunctionCall#get)
...
*   `get_job_result` attempts to retrieve the result of a previously submitted job using [`FunctionCall.from_id()`](https://modal.com/docs/sdk/py/latest/modal.FunctionCall#from_id)
     and [`FunctionCall.get()`](https://modal.com/docs/sdk/py/latest/modal.FunctionCall#get)
    . [`FunctionCall.get()`](https://modal.com/docs/sdk/py/latest/modal.FunctionCall#get)
...
[Document OCR Web App](https://modal.com/docs/examples/doc_ocr_webapp)
...
You can customize the behavior of the job queue by configuring the `@app.function()` decorator with options like [`retries`](https://modal.com/docs/guide/retries#function-retries)
, [`timeout`](https://modal.com/docs/guide/timeouts#timeouts)
, and [`max_containers`](https://modal.com/docs/guide/scale#configuring-autoscaling-behavior)
.

[Job processing](https://modal.com/docs/guide/job-queue#job-processing)
[Creating jobs with .spawn()](https://modal.com/docs/guide/job-queue#creating-jobs-with-spawn)
[Integration with web frameworks](https://modal.com/docs/guide/job-queue#integration-with-web-frameworks)
[Scaling and reliability](https://modal.com/docs/guide/job-queue#scaling-and-reliability)
