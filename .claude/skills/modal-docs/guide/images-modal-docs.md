...
[Images](https://modal.com/docs/guide/images#images)
[What are Images?](https://modal.com/docs/guide/images#what-are-images)
[Add Python packages](https://modal.com/docs/guide/images#add-python-packages)
[Add local files with add_local_dir and add_local_file](https://modal.com/docs/guide/images#add-local-files-with-add_local_dir-and-add_local_file)
[Add local Python code with add_local_python_source](https://modal.com/docs/guide/images#add-local-python-code-with-add_local_python_source)
[What if I have different Python packages locally and remotely?](https://modal.com/docs/guide/images#what-if-i-have-different-python-packages-locally-and-remotely)
[Install system packages with .apt_install](https://modal.com/docs/guide/images#install-system-packages-with-apt_install)
[Set environment variables with .env](https://modal.com/docs/guide/images#set-environment-variables-with-env)
[Run shell commands with .run_commands](https://modal.com/docs/guide/images#run-shell-commands-with-run_commands)
[Run a Python function during your build with .run_function](https://modal.com/docs/guide/images#run-a-python-function-during-your-build-with-run_function)
[Attach GPUs during setup](https://modal.com/docs/guide/images#attach-gpus-during-setup)
[Use mamba instead of pip with micromamba_install](https://modal.com/docs/guide/images#use-mamba-instead-of-pip-with-micromamba_install)
[Image caching and rebuilds](https://modal.com/docs/guide/images#image-caching-and-rebuilds)
[Image builder updates](https://modal.com/docs/guide/images#image-builder-updates)
