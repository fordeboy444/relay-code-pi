...
Audit logs give your workspace an append-only record of the sensitive actions that change its state — who did what, when, to which resource, and from where. They are designed for compliance reviews, incident investigation, and answering questions like _“did anyone delete this Secret last Thursday?”_ without asking Modal support.

Audit logs are viewable within the [settings page](https://modal.com/settings/audit-logs)
.
...
| Field | What it is |
| --- | --- |
| `action` | The kind of change that happened — e.g. `secret.create`, `app.deploy`. See the full list [below](https://modal.com/docs/guide/audit-logs#actions)<br>. |
...
[Audit Logs](https://modal.com/docs/guide/audit-logs#audit-logs)
[Fields](https://modal.com/docs/guide/audit-logs#fields)
[Filtering](https://modal.com/docs/guide/audit-logs#filtering)
[Actions](https://modal.com/docs/guide/audit-logs#actions)
