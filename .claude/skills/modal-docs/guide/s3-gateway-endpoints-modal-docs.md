# S3 Gateway endpoints | Modal Docs

- **URL:** https://modal.com/docs/guide/s3-gateway-endpoints
- **Summary:** When running workloads in AWS, our system automatically uses a corresponding S3 Gateway endpoint to ensure low costs, optimal performance, and network reliability between Modal and S3.
...
[S3 Gateway endpoints](https://modal.com/docs/guide/s3-gateway-endpoints#s3-gateway-endpoints)
[Endpoint configuration](https://modal.com/docs/guide/s3-gateway-endpoints#endpoint-configuration)
[Inter-region costs](https://modal.com/docs/guide/s3-gateway-endpoints#inter-region-costs)
