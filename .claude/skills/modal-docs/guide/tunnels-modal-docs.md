...
- **Summary:** Modal allows you to expose live TCP ports on a Modal container. This is done by creating a tunnel that forwards the port to the public Internet.
...
This gives every user who sends a POST request to the Web Function their own Jupyter notebook server, on a fully isolated Modal container.
...
You can then connect over TCP, for example with `nc r3.modal.host 23447`. Unlike encrypted TLS sockets, these cannot be given a non-guessable, cryptographically random URL due to how the TCP protocol works, so they are assigned a random port number instead.
...
[Tunnels](https://modal.com/docs/guide/tunnels#tunnels)
[Build with tunnels](https://modal.com/docs/guide/tunnels#build-with-tunnels)
[Programmable startup](https://modal.com/docs/guide/tunnels#programmable-startup)
[Advanced: Unencrypted TCP tunnels](https://modal.com/docs/guide/tunnels#advanced-unencrypted-tcp-tunnels)
[Pricing](https://modal.com/docs/guide/tunnels#pricing)
[Security](https://modal.com/docs/guide/tunnels#security)
