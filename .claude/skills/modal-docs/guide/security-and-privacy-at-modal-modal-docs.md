...
- **Summary:** The document outlines Modal’s security and privacy commitments.
...
We have successfully completed a [System and Organization Controls (SOC) 2 Type 2 audit](https://modal.com/blog/soc2type2)
. Go to our [Security Portal](https://trust.modal.com/)
...
To use Modal services for HIPAA-compliant workloads, a Business Associate Agreement (BAA) should be established with us prior to submission of any PHI. This is available on our Enterprise plan. Contact us at [security@modal.com](mailto:security@modal.com)
 to get started. At the moment, [Volumes v1](https://modal.com/docs/guide/volumes)
, [Images](https://modal.com/docs/guide/images)
 (excluding [Filesystem and Directory Snapshots](https://modal.com/docs/guide/sandbox-snapshots)
...
Keeping user data secure is a top priority at Modal. We welcome contributions from the security community to identify vulnerabilities in our product and disclose them to us in a responsible manner. We currently run a private bug bounty program through HackerOne. If you have found a vulnerability and wish to participate, please send an email to [security@modal.com](mailto:security@modal.com)
 with your HackerOne username or email and we will invite you to the program.
...
| --- | --- | --- |
| Inputs and outputs | [Functions](https://modal.com/docs/guide)<br> (`.remote`, `.spawn`, `.map`, [Web Functions](https://modal.com/docs/guide/webhooks)<br>, Scheduled Functions) | Up to 7 days, then deleted |
| Request and response payloads | [Server](https://modal.com/docs/guide/servers)<br> and [Auto Endpoints](https://modal.com/docs/guide/endpoints) | Not stored — proxied directly to your container |
| App and container logs | [Functions](https://modal.com/docs/guide)<br>, [Sandboxes](https://modal.com/docs/guide/sandboxes) | Plan-dependent: 1 day on Starter, 30 days on Team, configurable on Enterprise (see [pricing](https://modal.com/pricing)<br>) |
| Audit logs | Workspace (Enterprise) | Per Enterprise contract (see [Audit logs](https://modal.com/docs/guide/audit-logs)<br>) |
| Files | [Volumes](https://modal.com/docs/guide/volumes)<br>, [Images](https://modal.com/docs/guide/images) | Persistent until you delete them |
| Memory snapshots | [Function memory snapshots](https://modal.com/docs/guide/memory-snapshots)<br>, [Sandbox memory snapshots](https://modal.com/docs/guide/sandbox-snapshots) | 7 days after creation |
...
[Security and privacy at Modal](https://modal.com/docs/guide/security#security-and-privacy-at-modal)
...
[Vulnerability remediation](https://modal.com/docs/guide/security#vulnerability-remediation)
[Severity timeframes](https://modal.com/docs/guide/security#severity-timeframes)
[Shared responsibility model](https://modal.com/docs/guide/security#shared-responsibility-model)
