...
- **Summary:** Modal budgets let you cap spend at both the Workspace and Environment level:
...
Only Workspace **Owners** and **Managers** can set, edit, or remove budgets. See [Workspace roles](https://modal.com/docs/guide/workspaces#administering-workspace-membership)
 for role details.
...
You can set, edit, or remove a Workspace budget on the [Usage & Billing](https://modal.com/settings/usage)
 page.
...
You can set, edit, or remove Environment budgets on the [Workspace Management → Environments](https://modal.com/settings/workspace-management/environments)
 page.

[Budgets](https://modal.com/docs/guide/budgets#budgets)
[When to use each budget](https://modal.com/docs/guide/budgets#when-to-use-each-budget)
[How limits apply](https://modal.com/docs/guide/budgets#how-limits-apply)
[Workspace budgets](https://modal.com/docs/guide/budgets#workspace-budgets)
[Environment budgets](https://modal.com/docs/guide/budgets#environment-budgets)
