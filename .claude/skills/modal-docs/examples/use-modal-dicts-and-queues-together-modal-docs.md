# Use Modal Dicts and Queues together | Modal Docs

- **URL:** https://modal.com/docs/examples/dicts_and_queues
- **Summary:** Modal Dicts and Queues store and communicate objects in distributed applications on Modal.

[View on GitHub](https://github.com/modal-labs/modal-examples/blob/main/09_job_queues/dicts_and_queues.py)
...
The Modal Queue acts as a job queue, accepting new pages to crawl as they are discovered by the crawlers and doling them out to be crawled via [`.spawn`](https://modal.com/docs/reference/modal.Function#spawn)
.
...
[Use Modal Dicts and Queues together](https://modal.com/docs/examples/dicts_and_queues#use-modal-dicts-and-queues-together)
