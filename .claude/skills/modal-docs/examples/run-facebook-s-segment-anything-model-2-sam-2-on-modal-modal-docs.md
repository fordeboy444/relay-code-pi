...
This example demonstrates how to deploy Facebook’s [SAM 2](https://github.com/facebookresearch/sam2)
 on Modal. SAM2 is a powerful, flexible image and video segmentation model that can be used for various computer vision tasks like object detection, instance segmentation, and even as a foundation for more complex computer vision applications. SAM2 extends the capabilities of the original SAM to include video segmentation.

In particular, this example segments [this video](https://www.youtube.com/watch?v=WAz1406SjVw)
...
[Run Facebook’s Segment Anything Model 2 (SAM 2) on Modal](https://modal.com/docs/examples/segment_anything#run-facebooks-segment-anything-model-2-sam-2-on-modal)
[Set up dependencies for SAM 2](https://modal.com/docs/examples/segment_anything#set-up-dependencies-for-sam-2)
[Wrapping the SAM 2 model in a Modal class](https://modal.com/docs/examples/segment_anything#wrapping-the-sam-2-model-in-a-modal-class)
[Segmenting videos from the command line](https://modal.com/docs/examples/segment_anything#segmenting-videos-from-the-command-line)
[Helper functions for SAM 2 inference](https://modal.com/docs/examples/segment_anything#helper-functions-for-sam-2-inference)
