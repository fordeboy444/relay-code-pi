...
- **URL:** https://modal.com/docs/examples/fasthtml_checkboxes
- **Summary:** This example shows how you can deploy a multiplayer checkbox game with FastHTML on Modal.

[View on GitHub](https://github.com/modal-labs/modal-examples/blob/main/07_web/fasthtml-checkboxes/fasthtml_checkboxes.py)

Copy page

Deploy 100,000 multiplayer checkboxes on Modal with FastHTML

[![Screenshot of FastHTML Checkboxes UI](https://modal.com/_app/immutable/assets/ui.BaSTrcQW.png)](https://modal-labs-examples--example-fasthtml-checkboxes-web.modal.run/)
...
[FastHTML](https://www.fastht.ml/)
 ...
 which allows you to create entire web applications using only Python. For a simpler template for using FastHTML with Modal, check out [this example](https://modal.com/docs/examples/fasthtml_app)
.
...
[Deploy 100,000 multiplayer checkboxes on Modal with FastHTML](https://modal.com/docs/examples/fasthtml_checkboxes#deploy-100000-multiplayer-checkboxes-on-modal-with-fasthtml)
> Common reference appendix (shared error/status catalog): see [../_shared-appendix.md](../_shared-appendix.md).
    modal serve -m 07_web.fasthtml-checkboxes.fasthtml_checkboxes
