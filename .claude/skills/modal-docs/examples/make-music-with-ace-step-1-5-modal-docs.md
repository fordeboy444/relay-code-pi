...
- **Summary:** In this example, we show you how you can run ACE Studio’s ACE-Step 1.5 music generation model on Modal.
...
In this example, we show you how you can run [ACE Studio](https://acestudio.ai/)
’s [ACE-Step 1.5](https://github.com/ace-step/ACE-Step-1.5)
 music generation model on Modal.
...
, which we build step-by-step by calling methods to add dependencies, like `apt_install` to add system packages and `uv_pip_install` to add Python packages.
...
We use a single `checkpoints/` directory for all model downloads (both the DiT and LM models) and persist it with a Modal [Volume](https://modal.com/docs/guide/volumes)
...
*   We make an [App](https://modal.com/docs/guide/apps)
...
[Make music with ACE-Step 1.5](https://modal.com/docs/examples/generate_music#make-music-with-ace-step-15)
[Setting up dependencies](https://modal.com/docs/examples/generate_music#setting-up-dependencies)
[Running music generation on Modal](https://modal.com/docs/examples/generate_music#running-music-generation-on-modal)
[Hosting a web UI for the music generator](https://modal.com/docs/examples/generate_music#hosting-a-web-ui-for-the-music-generator)
