# Text-to-video generation with Mochi | Modal Docs

- **URL:** https://modal.com/docs/examples/mochi
- **Summary:** This example demonstrates how to run the Mochi 1 video generation model by Genmo on Modal.
...
This example demonstrates how to run the [Mochi 1](https://github.com/genmoai/models)
 video generation model by [Genmo](https://www.genmo.ai/)
 on Modal.
...
At the time of writing, Mochi is supported natively in the [`diffusers`](https://github.com/huggingface/diffusers)
 library, but only in a pre-release version. So we’ll need to install `diffusers` and `transformers` from GitHub.
...
On Modal, we save large or expensive-to-compute data to [distributed Volumes](https://modal.com/docs/guide/volumes)
...
We download the model weights into Volume cache to speed up cold starts. For more on storing model weights on Modal, see [this guide](https://modal.com/docs/guide/model-weights)
.
...
The `--detach` flag ensures the download will continue even if you close your terminal or shut down your computer while it’s running.
...
[Text-to-video generation with Mochi](https://modal.com/docs/examples/mochi#text-to-video-generation-with-mochi)
[Setting up the environment for Mochi](https://modal.com/docs/examples/mochi#setting-up-the-environment-for-mochi)
[Saving outputs](https://modal.com/docs/examples/mochi#saving-outputs)
[Downloading the model](https://modal.com/docs/examples/mochi#downloading-the-model)
[Setting up our Mochi class](https://modal.com/docs/examples/mochi#setting-up-our-mochi-class)
[Running Mochi inference](https://modal.com/docs/examples/mochi#running-mochi-inference)
[Addenda](https://modal.com/docs/examples/mochi#addenda)
