# Run TextEmbeddingsInference (TEI) on Modal | Modal Docs

- **URL:** https://modal.com/docs/examples/text_embeddings_inference
- **Summary:** This example runs the Text Embedding Inference (TEI) toolkit on the Hacker News BigQuery public dataset.
...
This example runs the [Text Embedding Inference (TEI)](https://github.com/huggingface/text-embeddings-inference)
...
[Run TextEmbeddingsInference (TEI) on Modal](https://modal.com/docs/examples/text_embeddings_inference#run-textembeddingsinference-tei-on-modal)
