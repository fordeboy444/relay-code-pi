# Set “fallback” GPUs | Modal Docs

- **URL:** https://modal.com/docs/examples/gpu_fallbacks
- **Summary:** GPU availabilities on Modal can fluctuate, especially for tightly-constrained requests, like for eight co-located GPUs in a specific region.
...
[Set “fallback” GPUs](https://modal.com/docs/examples/gpu_fallbacks#set-fallback-gpus)
