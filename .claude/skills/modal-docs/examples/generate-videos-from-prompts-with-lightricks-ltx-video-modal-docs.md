# Generate videos from prompts with Lightricks LTX-Video | Modal Docs

- **URL:** https://modal.com/docs/examples/ltx
- **Summary:** This example demonstrates how to run the LTX-Video video generation model by Lightricks on Modal.
...
This example demonstrates how to run the [LTX-Video](https://github.com/Lightricks/LTX-Video)
 video generation model by [Lightricks](https://www.lightricks.com/)
 on Modal.
...
We start by importing dependencies we need locally, defining a Modal [App](https://modal.com/docs/guide/apps)
...
That decorator also gives us control over the [lifecycle](https://modal.com/docs/guide/lifecycle-functions)
...
This helps reduce tail latencies caused by cold starts. For details and more tips, see [this guide](https://modal.com/docs/guide/cold-start#cold-start-performance)
.
...
[Generate videos from prompts with Lightricks LTX-Video](https://modal.com/docs/examples/ltx#generate-videos-from-prompts-with-lightricks-ltx-video)
[Setup](https://modal.com/docs/examples/ltx#setup)
[Storing data on Modal Volumes](https://modal.com/docs/examples/ltx#storing-data-on-modal-volumes)
[Setting up our LTX class](https://modal.com/docs/examples/ltx#setting-up-our-ltx-class)
[Generate videos from the command line](https://modal.com/docs/examples/ltx#generate-videos-from-the-command-line)
[Addenda](https://modal.com/docs/examples/ltx#addenda)
