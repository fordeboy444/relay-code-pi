...
[Previous](https://trigger.dev/docs/self-hosting/env/webapp)
[Docker (legacy)Self-host Trigger.dev on your own infrastructure using Docker.\
\
Next](https://trigger.dev/docs/open-source-self-hosting)
