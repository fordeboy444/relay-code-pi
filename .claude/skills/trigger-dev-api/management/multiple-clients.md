...
[​](https://trigger.dev/docs/management/multiple-clients#configuration)
...
[​](https://trigger.dev/docs/management/multiple-clients#what%E2%80%99s-on-a-triggerclient-instance)
...
[​](https://trigger.dev/docs/management/multiple-clients#isolation-contract)
...
[​](https://trigger.dev/docs/management/multiple-clients#when-to-use-what)
...
See [Authentication](https://trigger.dev/docs/management/authentication)
 for the underlying token types and the `auth.withAuth` helper.

Was this page helpful?

YesNo

[Previous](https://trigger.dev/docs/management/authentication)
[Errors and retriesHandling errors and retries with the Trigger.dev management API\
\
Next](https://trigger.dev/docs/management/errors-and-retries)
