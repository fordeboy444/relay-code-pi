...
[Previous](https://trigger.dev/docs/guides/example-projects/openai-agent-sdk-guardrails)
[Convert docs to markdownLearn how to use Trigger.dev with Python to convert documents to markdown using MarkItDown.\
\
Next](https://trigger.dev/docs/guides/python/python-doc-to-markdown)
