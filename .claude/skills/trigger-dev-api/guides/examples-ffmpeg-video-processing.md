...
[​](https://trigger.dev/docs/guides/examples/ffmpeg-video-processing#prerequisites)
...
[​](https://trigger.dev/docs/guides/examples/ffmpeg-video-processing#adding-the-ffmpeg-build-extension)
...
You’ll also need to add `@trigger.dev/build` to your `package.json` file under `devDependencies` if you don’t already have it there. If you are modifying this example and using popular FFmpeg libraries like `fluent-ffmpeg` you’ll also need to add them to [`external`](https://trigger.dev/docs/config/config-file#external)
 in your `trigger.config.ts` file.

[​](https://trigger.dev/docs/guides/examples/ffmpeg-video-processing#compress-a-video-using-ffmpeg)
...
[​](https://trigger.dev/docs/guides/examples/ffmpeg-video-processing#key-features)
...
[​](https://trigger.dev/docs/guides/examples/ffmpeg-video-processing#task-code)
...
[​](https://trigger.dev/docs/guides/examples/ffmpeg-video-processing#testing-your-task)
...
[​](https://trigger.dev/docs/guides/examples/ffmpeg-video-processing#extract-audio-from-a-video-using-ffmpeg)
...
[​](https://trigger.dev/docs/guides/examples/ffmpeg-video-processing#key-features-2)
...
[​](https://trigger.dev/docs/guides/examples/ffmpeg-video-processing#task-code-2)
...
[​](https://trigger.dev/docs/guides/examples/ffmpeg-video-processing#testing-your-task-2)
...
[​](https://trigger.dev/docs/guides/examples/ffmpeg-video-processing#generate-a-thumbnail-from-a-video-using-ffmpeg)
...
[​](https://trigger.dev/docs/guides/examples/ffmpeg-video-processing#key-features-3)
...
[​](https://trigger.dev/docs/guides/examples/ffmpeg-video-processing#task-code-3)
...
[​](https://trigger.dev/docs/guides/examples/ffmpeg-video-processing#testing-your-task-3)
...
[​](https://trigger.dev/docs/guides/examples/ffmpeg-video-processing#local-development)
...
[Previous](https://trigger.dev/docs/guides/examples/fal-ai-realtime)
[Firecrawl URL crawlThis example demonstrates how to crawl a URL using Firecrawl with Trigger.dev.\
\
Next](https://trigger.dev/docs/guides/examples/firecrawl-url-crawl)
