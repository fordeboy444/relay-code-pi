...
[Previous](https://trigger.dev/docs/guides/ai-agents/respond-and-check-content)
[Verify news articleCreate an AI agent workflow that verifies the facts in a news article\
\
Next](https://trigger.dev/docs/guides/ai-agents/verify-news-article)
