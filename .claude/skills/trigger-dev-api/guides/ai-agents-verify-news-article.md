...
[​](https://trigger.dev/docs/guides/ai-agents/verify-news-article#overview)

Overview
---------------------------------------------------------------------------------------

This example demonstrates the **orchestrator-workers** pattern, where a central AI agent dynamically breaks down complex tasks and delegates them to specialized worker agents. This pattern is particularly effective when tasks require multiple perspectives or parallel processing streams, with the orchestrator synthesizing the results into a cohesive output. ![Orchestrator](https://mintcdn.com/trigger/uys6iMwf9B_ojh8r/guides/ai-agents/orchestrator-workers.png?w=2500&fit=max&auto=format&n=uys6iMwf9B_ojh8r&q=85&s=3237a8fbb14118204277d67294f8a7e4)

[​](https://trigger.dev/docs/guides/ai-agents/verify-news-article#example-task)
...
*   Uses [`batch.triggerByTaskAndWait`](https://trigger.dev/docs/triggering#batch-triggerbytaskandwait)
     to orchestrate parallel processing of claims
...
[​](https://trigger.dev/docs/guides/ai-agents/verify-news-article#run-a-test)
...
[Previous](https://trigger.dev/docs/guides/ai-agents/translate-and-refine)
[Claude Agent SDKBuild AI agents that can read files, run commands, and edit code using the Claude Agent SDK and Trigger.dev.\
\
Next](https://trigger.dev/docs/guides/ai-agents/claude-code-trigger)
