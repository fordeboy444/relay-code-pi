...
**Deprecated when using the Vercel integration.** If you are using the [Vercel integration](https://trigger.dev/docs/vercel-integration)
, do not use `syncVercelEnvVars` — the integration handles env var syncing natively and using both together can cause env vars to be incorrectly populated.If you are **not** using the Vercel integration, `syncVercelEnvVars` is still supported. Continue with the configuration below.

[​](https://trigger.dev/docs/guides/examples/vercel-sync-env-vars#build-configuration)

Build configuration
-------------------------------------------------------------------------------------------------------------

If you are not using the [Vercel integration](https://trigger.dev/docs/vercel-integration)
, you can sync environment variables manually by adding the `syncVercelEnvVars` build extension to your `trigger.config.ts` file. This extension will run automatically every time you deploy your Trigger.dev project.
...
[​](https://trigger.dev/docs/guides/examples/vercel-sync-env-vars#running-the-sync-operation)
...
[​](https://trigger.dev/docs/guides/examples/vercel-sync-env-vars#learn-more-about-next-js-and-trigger-dev)
...
[​](https://trigger.dev/docs/guides/examples/vercel-sync-env-vars#walk-through-guides-from-development-to-deployment)
...
[​](https://trigger.dev/docs/guides/examples/vercel-sync-env-vars#task-examples)
...
[Previous](https://trigger.dev/docs/guides/examples/vercel-ai-sdk)
[dotenvxA dotenvx package for Trigger.dev.\
\
Next](https://trigger.dev/docs/guides/community/dotenvx)
