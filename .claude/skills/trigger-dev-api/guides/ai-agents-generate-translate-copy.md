...
[​](https://trigger.dev/docs/guides/ai-agents/generate-translate-copy#overview)

Overview
-------------------------------------------------------------------------------------------

**Prompt chaining** is an AI workflow pattern that decomposes a complex task into a sequence of steps, where each LLM call processes the output of the previous one. This approach trades off latency for higher accuracy by making each LLM call an easier, more focused task, with the ability to add programmatic checks between steps to ensure the process remains on track. ![Generating and translating copy](https://mintcdn.com/trigger/uys6iMwf9B_ojh8r/guides/ai-agents/prompt-chaining.png?w=2500&fit=max&auto=format&n=uys6iMwf9B_ojh8r&q=85&s=fcf4372192360767b8e1de9a50ff6340)

[​](https://trigger.dev/docs/guides/ai-agents/generate-translate-copy#example-task)
...
[​](https://trigger.dev/docs/guides/ai-agents/generate-translate-copy#run-a-test)
...
[Previous](https://trigger.dev/docs/guides/ai-agents/overview)
[Route a questionCreate an AI agent workflow that routes a question to a different AI model depending on its complexity\
\
Next](https://trigger.dev/docs/guides/ai-agents/route-question)
