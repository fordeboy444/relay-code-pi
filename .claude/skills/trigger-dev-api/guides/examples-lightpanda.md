...
[​](https://trigger.dev/docs/guides/examples/lightpanda#overview)
...
[​](https://trigger.dev/docs/guides/examples/lightpanda#limitations)
...
[​](https://trigger.dev/docs/guides/examples/lightpanda#using-lightpanda-cloud)
...
[​](https://trigger.dev/docs/guides/examples/lightpanda#prerequisites)

Prerequisites

*   A [Lightpanda](https://lightpanda.io/)
     cloud token

### 

[​](https://trigger.dev/docs/guides/examples/lightpanda#get-links-from-a-website)
...
[​](https://trigger.dev/docs/guides/examples/lightpanda#proxies)

Proxies

Proxies can be used with your browser via the proxy query string parameter. By default, the proxy used is “datacenter” which is a pool of shared datacenter IPs. `datacenter` accepts an optional `country` query string parameter which is an [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2)
 country code.
...
[​](https://trigger.dev/docs/guides/examples/lightpanda#session)

Session

A session is alive until you close it or the connection is closed. The max duration of a session is 15 minutes.

[​](https://trigger.dev/docs/guides/examples/lightpanda#using-lightpanda-browser-directly)
...
[​](https://trigger.dev/docs/guides/examples/lightpanda#prerequisites-2)
...
[​](https://trigger.dev/docs/guides/examples/lightpanda#get-the-html-of-a-webpage)
...
[​](https://trigger.dev/docs/guides/examples/lightpanda#lightpanda-cdp-with-puppeteer)
...
[Previous](https://trigger.dev/docs/guides/examples/firecrawl-url-crawl)
[LibreOffice PDF conversionThis example demonstrates how to convert documents to PDF using LibreOffice with Trigger.dev.\
\
Next](https://trigger.dev/docs/guides/examples/libreoffice-pdf-conversion)
