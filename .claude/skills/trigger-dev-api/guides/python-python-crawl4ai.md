...
[​](https://trigger.dev/docs/guides/python/python-crawl4ai#overview)
...
[​](https://trigger.dev/docs/guides/python/python-crawl4ai#prerequisites)
...
*   Our [Python build extension](https://trigger.dev/docs/config/extensions/pythonExtension)
     to install the dependencies and run the Python script
*   [Crawl4AI](https://github.com/unclecode/crawl4ai)
    , an open source LLM friendly web crawler
*   A custom [Playwright extension](https://playwright.dev/)
     to create a headless chromium browser
*   Proxy support

[​](https://trigger.dev/docs/guides/python/python-crawl4ai#using-proxies)
...
[​](https://trigger.dev/docs/guides/python/python-crawl4ai#github-repo)
...
[​](https://trigger.dev/docs/guides/python/python-crawl4ai#the-code)
...
[​](https://trigger.dev/docs/guides/python/python-crawl4ai#build-configuration)
...
[​](https://trigger.dev/docs/guides/python/python-crawl4ai#task-code)
...
[​](https://trigger.dev/docs/guides/python/python-crawl4ai#add-a-requirements-txt-file)
...
[​](https://trigger.dev/docs/guides/python/python-crawl4ai#the-python-script)
...
[​](https://trigger.dev/docs/guides/python/python-crawl4ai#testing-your-task)
...
4.  If you haven’t already, copy your project ref from your [Trigger.dev dashboard](https://cloud.trigger.dev/)
...
[​](https://trigger.dev/docs/guides/python/python-crawl4ai#deploying-your-task)
...
[​](https://trigger.dev/docs/guides/python/python-crawl4ai#learn-more-about-using-python-with-trigger-dev)
...
[Previous](https://trigger.dev/docs/guides/python/python-doc-to-markdown)
[Extract form data from PDFsLearn how to use Trigger.dev with Python to extract form data from PDF files.\
\
Next](https://trigger.dev/docs/guides/python/python-pdf-form-extractor)
