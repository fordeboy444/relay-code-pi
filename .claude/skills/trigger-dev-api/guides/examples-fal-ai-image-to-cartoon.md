...
[​](https://trigger.dev/docs/guides/examples/fal-ai-image-to-cartoon#walkthrough)
...
[​](https://trigger.dev/docs/guides/examples/fal-ai-image-to-cartoon#prerequisites)
...
*   A [Fal.ai](https://fal.ai/)
     account
*   A [Cloudflare](https://developers.cloudflare.com/r2/)
     account with an R2 bucket setup

[​](https://trigger.dev/docs/guides/examples/fal-ai-image-to-cartoon#task-code)
...
[​](https://trigger.dev/docs/guides/examples/fal-ai-image-to-cartoon#testing-your-task)
...
[Previous](https://trigger.dev/docs/guides/examples/deepgram-transcribe-audio)
[Fal.ai with RealtimeThis example task generates an image from a prompt using Fal.ai and shows the progress of the task on the frontend using Trigger.dev Realtime.\
\
Next](https://trigger.dev/docs/guides/examples/fal-ai-realtime)
