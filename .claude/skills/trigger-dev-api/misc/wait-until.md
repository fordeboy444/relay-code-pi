...
[​](https://trigger.dev/docs/wait-until#throwifinthepast)
...
[​](https://trigger.dev/docs/wait-until#wait-idempotency)
...
[Previous](https://trigger.dev/docs/wait-for)
[Wait for tokenWait until a token is completed using waitpoint tokens.\
\
Next](https://trigger.dev/docs/wait-for-token)
