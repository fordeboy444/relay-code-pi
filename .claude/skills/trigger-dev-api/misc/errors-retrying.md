...
1.  In your [trigger.config file](https://trigger.dev/docs/config/config-file)
     you can set the default retrying behavior for all tasks.
...
By default when you create your project using the CLI init command we disabled retrying in the DEV environment. You can enable it in your [trigger.config file](https://trigger.dev/docs/config/config-file)
.

[​](https://trigger.dev/docs/errors-retrying#a-simple-example-with-openai)
...
[​](https://trigger.dev/docs/errors-retrying#combining-tasks)

Combining tasks
--------------------------------------------------------------------------------

One way to gain reliability is to break your work into smaller tasks and [trigger](https://trigger.dev/docs/triggering)
 them from each other. Each task can have its own retrying behavior:
...
[​](https://trigger.dev/docs/errors-retrying#retrying-smaller-parts-of-a-task)
...
[​](https://trigger.dev/docs/errors-retrying#retry-onthrow)
...
[​](https://trigger.dev/docs/errors-retrying#retry-fetch)
...
[​](https://trigger.dev/docs/errors-retrying#advanced-error-handling-and-retrying)
...
[​](https://trigger.dev/docs/errors-retrying#openai-error-handling-example)
...
[​](https://trigger.dev/docs/errors-retrying#preventing-retries)
...
[​](https://trigger.dev/docs/errors-retrying#using-aborttaskrunerror)
...
[​](https://trigger.dev/docs/errors-retrying#using-try/catch)
...
[Previous](https://trigger.dev/docs/logging)
[OverviewDuring your run you can wait for a period of time or for something to happen.\
\
Next](https://trigger.dev/docs/wait)
