...
-----------\
\
Get started with Trigger.dev and run your first task in 3 minutes](https://trigger.dev/docs/quick-start)
...
-----------------------------\
\
Browse our wide range of guides, frameworks and example projects](https://trigger.dev/docs/guides/introduction#example-tasks)
...
----------------\
\
Learn how to build Trigger.dev projects using AI coding assistants](https://trigger.dev/docs/building-with-ai)
...
-----------------\
\
Watch an end-to-end demo of Trigger.dev in 10 minutes](https://trigger.dev/docs/video-walkthrough)

[​](https://trigger.dev/docs#what-is-trigger-dev)
...
[​](https://trigger.dev/docs#learn-the-concepts)
...
-------------\
\
Tasks are the core of Trigger.dev. Learn what they are and how to write them.](https://trigger.dev/docs/tasks/overview)

[Triggering tasks\
----------------\
\
Learn how to trigger tasks from your codebase.](https://trigger.dev/docs/triggering)

[Runs\
----\
\
Runs are the instances of tasks that are executed. Learn how they work.](https://trigger.dev/docs/runs)

[API keys\
--------\
\
API keys are used to authenticate requests to the Trigger.dev API. Learn how to create and use them.](https://trigger.dev/docs/apikeys)

[​](https://trigger.dev/docs#explore-by-feature)
...
----------------------\
\
Scheduled tasks are a type of task that is scheduled to run at a specific time.](https://trigger.dev/docs/tasks/scheduled)

[Realtime API\
------------\
\
The Realtime API allows you to trigger tasks and get the status of runs.](https://trigger.dev/docs/realtime)

[React hooks\
-----------\
\
React hooks are a way to show task status in your frontend.](https://trigger.dev/docs/realtime/react-hooks)

[Waits\
-----\
\
Waits are a way to wait for a task to finish before continuing.](https://trigger.dev/docs/wait)

[Errors and retries\
------------------\
\
Learn how to handle errors and retries.](https://trigger.dev/docs/errors-retrying)

[Concurrency & Queues\
--------------------\
\
Configure what you want to happen when there is more than one run at a time.](https://trigger.dev/docs/queue-concurrency)

[Wait for token (human-in-the-loop)\
----------------------------------\
\
Pause runs until a token is completed via an approval workflow.](https://trigger.dev/docs/wait-for-token)

[Build extensions\
----------------\
\
Customize the build process or the resulting bundle and container image.](https://trigger.dev/docs/config/extensions/overview)

[​](https://trigger.dev/docs#explore-by-build-extension)
...
[​](https://trigger.dev/docs#explore-by-example)
...
[​](https://trigger.dev/docs#getting-help)
...
-----------------------\
\
Our Discord is the best place to get help with any questions about Trigger.dev.](https://discord.gg/kA47vcd8P6)

[Follow us on X (Twitter)\
------------------------\
\
Follow us to get the latest updates and news.](https://twitter.com/triggerdotdev)

[Schedule a call\
---------------\
\
Arrange a call with one of the founders to get help with any questions.](https://cal.com/team/triggerdotdev/founders-call)

[Give us a star on GitHub\
------------------------\
\
Check us out our GitHub repo and give us a star if you like what we’re doing.](https://github.com/triggerdotdev/trigger.dev)
