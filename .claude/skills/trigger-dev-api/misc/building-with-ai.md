...
[​](https://trigger.dev/docs/building-with-ai#quick-setup)
...
[​](https://trigger.dev/docs/building-with-ai#skills-and-the-mcp-server)
...
**Our recommendation:** Install both. Skills teach your AI _how_ to write Trigger.dev code; the MCP Server lets it _do things_ in your project.

[​](https://trigger.dev/docs/building-with-ai#project-level-context-snippet)
...
Create the file that matches your AI tool (or multiple files if your team uses different tools) and paste the snippet below. This gives the AI essential Trigger.dev context without installing anything.Copy the snippet
...
[​](https://trigger.dev/docs/building-with-ai#llms-txt)
...
*   [trigger.dev/docs/llms.txt](https://trigger.dev/docs/llms.txt)
     — concise overview
*   [trigger.dev/docs/llms-full.txt](https://trigger.dev/docs/llms-full.txt)
     — full documentation

These follow the [llms.txt standard](https://llmstxt.org/)
 and can be fed directly into any LLM context window.

[​](https://trigger.dev/docs/building-with-ai#troubleshooting)
...
Install [Skills](https://trigger.dev/docs/skills)
; they override the outdated patterns in the AI’s training data. The [context snippet](https://trigger.dev/docs/building-with-ai#project-level-context-snippet)
 above is a quick alternative.
...
4.  See the [MCP introduction](https://trigger.dev/docs/mcp-introduction)
     for client-specific config details
...
[​](https://trigger.dev/docs/building-with-ai#next-steps)
...
----------\
\
Install and configure the MCP Server for live project interaction.](https://trigger.dev/docs/mcp-introduction)

[Skills\
------\
\
Install Trigger.dev agent skills into any AI coding assistant.](https://trigger.dev/docs/skills)

[Writing tasks\
-------------\
\
Learn the task patterns your AI assistant will follow.](https://trigger.dev/docs/tasks/overview)

Was this page helpful?

YesNo

[Previous](https://trigger.dev/docs/apikeys)
[IntroductionLearn how to install and configure the Trigger.dev MCP Server\
\
Next](https://trigger.dev/docs/mcp-introduction)
