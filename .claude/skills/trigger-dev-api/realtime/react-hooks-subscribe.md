...
**Subscribe to a run and your component re-renders whenever its status, metadata, or tags change.** Build progress bars, deployment monitors, or any UI that needs to reflect what a background task is doing right now. For streaming continuous data (AI tokens, file chunks), see [Streaming](https://trigger.dev/docs/realtime/react-hooks/streams)
 instead.

[​](https://trigger.dev/docs/realtime/react-hooks/subscribe#trigger-+-subscribe-combo-hooks)

Trigger + subscribe combo hooks
-------------------------------------------------------------------------------------------------------------------------------

Trigger a task and immediately subscribe to its run. Details in the [triggering](https://trigger.dev/docs/realtime/react-hooks/triggering)
 section.

*   **[`useRealtimeTaskTrigger`](https://trigger.dev/docs/realtime/react-hooks/triggering#userealtimetasktrigger)
    ** - Trigger a task and subscribe to the run
*   **[`useRealtimeTaskTriggerWithStreams`](https://trigger.dev/docs/realtime/react-hooks/triggering#userealtimetasktriggerwithstreams)
    ** - Trigger a task and subscribe to both run updates and streams

[​](https://trigger.dev/docs/realtime/react-hooks/subscribe#subscribe-hooks)
...
[​](https://trigger.dev/docs/realtime/react-hooks/subscribe#userealtimerun)
...
You can skip any of: `payload`, `output`, `metadata`, `startedAt`, `delayUntil`, `queuedAt`, `expiredAt`, `completedAt`, `number`, `isTest`, `usageDurationMs`, `costInCents`, `baseCostInCents`, `ttl`, `payloadType`, `outputType`, `runTags`, `error`. The `useRealtimeRunsWithTag` hook also accepts a `skipColumns` option in the same way. See our [run object reference](https://trigger.dev/docs/realtime/run-object)
 for the complete schema and [How it Works documentation](https://trigger.dev/docs/realtime/how-it-works)
 for more technical details.

### 

[​](https://trigger.dev/docs/realtime/react-hooks/subscribe#userealtimerunswithtag)
...
[​](https://trigger.dev/docs/realtime/react-hooks/subscribe#userealtimebatch)
...
See our [Realtime documentation](https://trigger.dev/docs/realtime)
 for more information.

[​](https://trigger.dev/docs/realtime/react-hooks/subscribe#using-metadata-to-show-progress-in-your-ui)
...
To learn how to write tasks using metadata, see our [metadata](https://trigger.dev/docs/runs/metadata)
 guide.

### 

[​](https://trigger.dev/docs/realtime/react-hooks/subscribe#progress-monitoring)
...
[​](https://trigger.dev/docs/realtime/react-hooks/subscribe#reusable-progress-bar)
...
[​](https://trigger.dev/docs/realtime/react-hooks/subscribe#status-indicator-with-logs)
...
[​](https://trigger.dev/docs/realtime/react-hooks/subscribe#multi-stage-deployment-monitor)
...
[​](https://trigger.dev/docs/realtime/react-hooks/subscribe#type-safety)
...
[​](https://trigger.dev/docs/realtime/react-hooks/subscribe#common-options)
...
[​](https://trigger.dev/docs/realtime/react-hooks/subscribe#accesstoken-&-baseurl)
...
[​](https://trigger.dev/docs/realtime/react-hooks/subscribe#enabled)
...
[​](https://trigger.dev/docs/realtime/react-hooks/subscribe#id)
...
[​](https://trigger.dev/docs/realtime/react-hooks/subscribe#frequently-asked-questions)
...
[​](https://trigger.dev/docs/realtime/react-hooks/subscribe#how-do-i-show-a-progress-bar-for-a-background-task-in-react)

How do I show a progress bar for a background task in React?

Use `metadata.set()` inside your task to update a progress value, then read it with `useRealtimeRun` in your component. The hook re-renders your component on every metadata change. See [Using metadata to show progress](https://trigger.dev/docs/realtime/react-hooks/subscribe#using-metadata-to-show-progress-in-your-ui)
 above for a complete example.

### 

[​](https://trigger.dev/docs/realtime/react-hooks/subscribe#what%E2%80%99s-the-difference-between-run-updates-and-streaming)

What’s the difference between run updates and streaming?

Run updates (this page) give you **run state**: status, metadata, and tags. They’re for progress bars, status badges, and dashboards. [Streaming](https://trigger.dev/docs/realtime/react-hooks/streams)
 gives you **continuous data** like AI tokens or file chunks. Use run updates for “how far along is my task?” and streaming for “show me the output as it generates.”

### 

[​](https://trigger.dev/docs/realtime/react-hooks/subscribe#can-i-subscribe-to-multiple-runs-at-once)
...
[​](https://trigger.dev/docs/realtime/react-hooks/subscribe#do-i-need-to-set-up-polling-or-websockets)

Do I need to set up polling or WebSockets?

No. The hooks handle the connection automatically using Trigger.dev’s Realtime infrastructure (built on [Electric SQL](https://trigger.dev/docs/realtime/how-it-works)
). Just pass a run ID and an access token.

Was this page helpful?

YesNo

[Previous](https://trigger.dev/docs/realtime/react-hooks/triggering)
[StreamingDisplay AI/LLM output token by token, stream file chunks, or pipe any continuous data from a background task into your React components.\
\
Next](https://trigger.dev/docs/realtime/react-hooks/streams)
