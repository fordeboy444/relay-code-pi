...
[​](https://trigger.dev/docs/ai-chat/reference#compatibility)
...
[​](https://trigger.dev/docs/ai-chat/reference#chatagentoptions)
...
| `onBoot` | `(event: BootEvent) => Promise<void> \| void` | —   | Fires once per worker process — initial, preloaded, AND reactive continuation. Use for `chat.local` init and per-process resources. See [onBoot](https://trigger.dev/docs/ai-chat/lifecycle-hooks#onboot)<br>. |
| `onRecoveryBoot` | `(event: RecoveryBootEvent) => Promise<RecoveryBootResult \| void> \| RecoveryBootResult \| void` | —   | Fires on a continuation boot when the dead predecessor left recovered state (partial assistant or in-flight users). Override the smart default — drop partial, synthesize tool results, emit a recovery banner. See [Recovery boot](https://trigger.dev/docs/ai-chat/patterns/recovery-boot)<br>. |
| `onPreload` | `(event: PreloadEvent) => Promise<void> \| void` | —   | Fires on preloaded runs before the first message |
| `onChatStart` | `(event: ChatStartEvent) => Promise<void> \| void` | —   | Fires once per chat, on the very first user message. Does NOT fire on continuation runs or OOM-retries — see [onChatStart](https://trigger.dev/docs/ai-chat/lifecycle-hooks#onchatstart)<br>. |
...
| `tools` | `ToolSet \| ((event: ResolveToolsEvent) => ToolSet \| Promise<ToolSet>)` | —   | Tools for this agent. Threads each tool’s `toModelOutput` through cross-turn history re-conversion, and hands the resolved set back on the run payload. Static set or per-turn function. See [Tools](https://trigger.dev/docs/ai-chat/tools)<br>. |
...
Plus most standard [TaskOptions](https://trigger.dev/docs/tasks/overview)
 — `queue`, `machine`, `maxDuration`, **`onWait`**, **`onResume`**, **`onComplete`**, and other lifecycle hooks. Generic `retry` is **not** exposed on `chat.agent`; use `oomMachine` for OOM recovery, or drop down to a raw [`task()`](https://trigger.dev/docs/ai-chat/custom-agents)
 if you need richer retry semantics. Standard hooks use the same parameter shapes as on a normal `task()` (including `ctx`).

[​](https://trigger.dev/docs/ai-chat/reference#task-context-ctx)
...
[​](https://trigger.dev/docs/ai-chat/reference#chattaskrunpayload)
...
| `tools` | `ToolSet` | Resolved tools declared on the agent config (empty object when none). Pass straight to `streamText`. See [Tools](https://trigger.dev/docs/ai-chat/tools)<br>. |
...
[​](https://trigger.dev/docs/ai-chat/reference#bootevent)
...
| Field | Type | Description |
| --- | --- | --- |
| `ctx` | `TaskRunContext` | Full task run context — see [Task context](https://trigger.dev/docs/ai-chat/reference#task-context-ctx) |
...
[​](https://trigger.dev/docs/ai-chat/reference#recoverybootevent)

RecoveryBootEvent
--------------------------------------------------------------------------------------

Passed to the `onRecoveryBoot` callback. See [Recovery boot](https://trigger.dev/docs/ai-chat/patterns/recovery-boot)
 for the full guide.
...
| `pendingToolCalls` | [`RecoveryPendingToolCall[]`](https://trigger.dev/docs/ai-chat/reference#recoverypendingtoolcall) | Tool calls in `input-available` state extracted from `partialAssistant` |
| `writer` | [`ChatWriter`](https://trigger.dev/docs/ai-chat/reference#chatwriter) | Lazy session.out writer — emit a recovery banner / signal here |

[​](https://trigger.dev/docs/ai-chat/reference#recoverybootresult)
...
[​](https://trigger.dev/docs/ai-chat/reference#recoverypendingtoolcall)
...
[​](https://trigger.dev/docs/ai-chat/reference#preloadevent)
...
| `chatAccessToken` | `string` | Scoped access token for this run |
| `clientData` | Typed by `clientDataSchema` | Custom data from the frontend |
| `writer` | [`ChatWriter`](https://trigger.dev/docs/ai-chat/reference#chatwriter) | Stream writer for custom chunks. Lazy — no overhead if unused. |

[​](https://trigger.dev/docs/ai-chat/reference#chatstartevent)
...
[​](https://trigger.dev/docs/ai-chat/reference#validatemessagesevent)
...
[​](https://trigger.dev/docs/ai-chat/reference#resolvetoolsevent)
...
[​](https://trigger.dev/docs/ai-chat/reference#hydratemessagesevent)
...
[​](https://trigger.dev/docs/ai-chat/reference#actionevent)
...
[​](https://trigger.dev/docs/ai-chat/reference#turnstartevent)
...
[​](https://trigger.dev/docs/ai-chat/reference#turncompleteevent)
...
[​](https://trigger.dev/docs/ai-chat/reference#beforeturncompleteevent)
...
| Field | Type | Description |
| --- | --- | --- |
| _(all TurnCompleteEvent fields)_ |     | See [TurnCompleteEvent](https://trigger.dev/docs/ai-chat/reference#turncompleteevent)<br> (includes `ctx`) |
| `writer` | [`ChatWriter`](https://trigger.dev/docs/ai-chat/reference#chatwriter) | Stream writer — the stream is still open so chunks appear in the current turn |

[​](https://trigger.dev/docs/ai-chat/reference#chatsuspendevent)
...
[​](https://trigger.dev/docs/ai-chat/reference#chatresumeevent)
...
[​](https://trigger.dev/docs/ai-chat/reference#chatwriter)
...
[​](https://trigger.dev/docs/ai-chat/reference#chatagentcompactionoptions)

ChatAgentCompactionOptions
--------------------------------------------------------------------------------------------------------

Options for the `compaction` field on `chat.agent()`. See [Compaction](https://trigger.dev/docs/ai-chat/compaction)
 for usage guide.
...
[​](https://trigger.dev/docs/ai-chat/reference#compactmessagesevent)
...
[​](https://trigger.dev/docs/ai-chat/reference#compactedevent)
...
| `writer` | [`ChatWriter`](https://trigger.dev/docs/ai-chat/reference#chatwriter) | Stream writer for custom chunks during compaction |

[​](https://trigger.dev/docs/ai-chat/reference#pendingmessagesoptions)

PendingMessagesOptions
------------------------------------------------------------------------------------------------

Options for the `pendingMessages` field. See [Pending Messages](https://trigger.dev/docs/ai-chat/pending-messages)
 for usage guide.
...
[​](https://trigger.dev/docs/ai-chat/reference#pendingmessagesbatchevent)
...
[​](https://trigger.dev/docs/ai-chat/reference#pendingmessagesinjectedevent)
...
[​](https://trigger.dev/docs/ai-chat/reference#usependingmessagesreturn)
...
[​](https://trigger.dev/docs/ai-chat/reference#chatsessionoptions)
...
| `compaction` | `ChatAgentCompactionOptions` | `undefined` | Automatic context [compaction](https://trigger.dev/docs/ai-chat/compaction)<br> — same options as `chat.agent({ compaction })` |
| `pendingMessages` | `PendingMessagesOptions` | `undefined` | Mid-execution [message injection](https://trigger.dev/docs/ai-chat/pending-messages)<br> — same options as `chat.agent({ pendingMessages })` |

[​](https://trigger.dev/docs/ai-chat/reference#chatturn)
...
| `handover` | `{ isFinal: boolean } \| null` | The [`chat.headStart`](https://trigger.dev/docs/ai-chat/fast-starts#handover-with-custom-agents)<br> handover for this turn (turn 0 only); `null` otherwise |
...
[​](https://trigger.dev/docs/ai-chat/reference#headstarthandleroptions)

HeadStartHandlerOptions
--------------------------------------------------------------------------------------------------

Options for [`chat.headStart()`](https://trigger.dev/docs/ai-chat/fast-starts#head-start)
, the warm-server first-turn handler (`@trigger.dev/sdk/chat-server`).
...
`chat.headStart(options)` returns the handler `(req: Request) => Promise<Response>`. The `run` callback receives `HeadStartRunArgs`: `{ messages: UIMessage[], signal: AbortSignal, chat: HeadStartChatHelper }`, where the helper exposes `chat.toStreamTextOptions({ tools })` and a `chat.session` escape hatch. See [Head Start](https://trigger.dev/docs/ai-chat/fast-starts#head-start)
 for the full guide.

[​](https://trigger.dev/docs/ai-chat/reference#chat-namespace)
...
| `chat.local<T>({ id })` | Create a per-run typed local (see [`chat.local`](https://trigger.dev/docs/ai-chat/chat-local)<br>) |
...
| `chat.waitForHandover(options)` | Wait for a [`chat.headStart`](https://trigger.dev/docs/ai-chat/fast-starts#handover-with-custom-agents)<br> handover signal in a custom loop. Returns the signal or `null`. `chat.MessageAccumulator` wraps this as `consumeHandover()` / `applyHandover()` |
...
| `chat.withUIMessage(config?)` | Returns a [ChatBuilder](https://trigger.dev/docs/ai-chat/types#chatbuilder)<br> with a fixed `UIMessage` subtype. See [Types](https://trigger.dev/docs/ai-chat/types) |
| `chat.withClientData({ schema })` | Returns a [ChatBuilder](https://trigger.dev/docs/ai-chat/types#chatbuilder)<br> with a fixed client data schema. See [Types](https://trigger.dev/docs/ai-chat/types#typed-client-data-with-chatwithclientdata) |

[​](https://trigger.dev/docs/ai-chat/reference#chat-withuimessage)

`chat.withUIMessage`
------------------------------------------------------------------------------------------

Returns a [`ChatBuilder`](https://trigger.dev/docs/ai-chat/types#chatbuilder)
 with a fixed `UIMessage` subtype. Chain `.withClientData()`, hook methods, and `.agent()`.
...
Use this when you need [`InferChatUIMessage`](https://trigger.dev/docs/ai-chat/reference#inferchatuimessage)
 / typed `data-*` parts / `InferUITools` to line up across backend hooks and `useChat`. Full guide: [Types](https://trigger.dev/docs/ai-chat/types)
.

[​](https://trigger.dev/docs/ai-chat/reference#chat-withclientdata)

`chat.withClientData`
--------------------------------------------------------------------------------------------

Returns a [`ChatBuilder`](https://trigger.dev/docs/ai-chat/types#chatbuilder)
 with a fixed client data schema. All hooks and `run` get typed `clientData` without passing `clientDataSchema` in `.agent()` options.
...
[​](https://trigger.dev/docs/ai-chat/reference#chatwithuimessageconfig)
...
[​](https://trigger.dev/docs/ai-chat/reference#inferchatuimessage)
...
Use with `useChat<Msg>({ transport })` when using [`chat.withUIMessage`](https://trigger.dev/docs/ai-chat/types)
. For agents defined with plain `chat.agent()` (no custom generic), this resolves to the base `UIMessage`.

[​](https://trigger.dev/docs/ai-chat/reference#inferchatuimessagefromtools)
...
Pin it on the agent with [`chat.withUIMessage<ChatUiMessage>()`](https://trigger.dev/docs/ai-chat/types)
 and reuse it on the client. See [Tools](https://trigger.dev/docs/ai-chat/tools#typing-messages-from-your-tools)
.

[​](https://trigger.dev/docs/ai-chat/reference#ai-helpers-ai-from-@trigger-dev/sdk/ai)
...
| `ai.tool(task, options?)` | **Deprecated** | Wraps `tool()` / `dynamicTool()` and the same execute path. Migrate to `tool({ ..., execute: ai.toolExecute(task) })`. See [Task-backed AI tools](https://trigger.dev/docs/tasks/schemaTask#task-backed-ai-tools)<br>. |
...
[​](https://trigger.dev/docs/ai-chat/reference#chatuimessagestreamoptions)

ChatUIMessageStreamOptions
--------------------------------------------------------------------------------------------------------

Options for customizing `toUIMessageStream()`. Set as static defaults via `uiMessageStreamOptions` on `chat.agent()`, or override per-turn via `chat.setUIMessageStreamOptions()`. See [Stream options](https://trigger.dev/docs/ai-chat/backend#stream-options)
 for usage examples. Derived from the AI SDK’s `UIMessageStreamOptions` with `onFinish` and `originalMessages` omitted (managed internally — `onFinish` for response capture, `originalMessages` for cross-turn message ID reuse).
...
[​](https://trigger.dev/docs/ai-chat/reference#triggerchattransport-options)
...
| `accessToken` | `(params: AccessTokenParams) => string \| Promise<string>` | required | Pure refresh — mints a fresh session-scoped PAT. Called on 401/403. See [callback shape](https://trigger.dev/docs/ai-chat/reference#accesstoken-callback)<br>. |
| `startSession` | `(params: StartSessionParams<TClientData>) => Promise<StartSessionResult>` | optional | Creates the chat Session and returns the session-scoped PAT. Called on `transport.preload(chatId)` and lazily on the first `sendMessage` for any chatId without a cached PAT. See [callback shape](https://trigger.dev/docs/ai-chat/reference#startsession-callback)<br>. |
| `baseURL` | `string \| (ctx: { endpoint: "in" \| "out"; chatId: string }) => string` | `"https://api.trigger.dev"` | API base URL. String form applies to every endpoint; function form lets you pick per endpoint — e.g. route `.in/append` through a trusted edge proxy while keeping `.out` SSE direct (see [Trusted edge signals](https://trigger.dev/docs/ai-chat/patterns/trusted-edge-signals)<br>). |
...
| `sessions` | `Record<string, ChatSession>` | —   | Restore sessions from storage. See [ChatSession](https://trigger.dev/docs/ai-chat/reference#chatsession)<br>. |
...
| `multiTab` | `boolean` | `false` | Enable multi-tab claim coordination via `BroadcastChannel`. See [Frontend → multi-tab](https://trigger.dev/docs/ai-chat/frontend#multi-tab-coordination)<br>. |
...
| `headStart` | `string` | —   | URL of a [`chat.headStart`](https://trigger.dev/docs/ai-chat/fast-starts#head-start)<br> route handler. When set, the FIRST message of a brand-new chat POSTs to this URL so step 1’s LLM call runs in your warm process while the agent run boots in parallel. Subsequent turns bypass it. |

### 

[​](https://trigger.dev/docs/ai-chat/reference#accesstoken-callback)

`accessToken` callback

The transport invokes `accessToken` whenever it needs a _fresh_ session-scoped PAT — initial use after no PAT is cached, or after a 401/403 from any session-PAT-authed request. The callback’s job is to **return a token, not to start a run.** `AccessTokenParams`:
...
[​](https://trigger.dev/docs/ai-chat/reference#startsession-callback)

`startSession` callback

The transport invokes `startSession` when it needs to _create_ the session — on `transport.preload(chatId)`, and lazily on the first `sendMessage` for any chatId without a cached PAT. Concurrent and repeat calls dedupe via an in-flight promise, and the customer’s wrapped helper is idempotent on `(env, externalId)` so two tabs / two `preload` calls converge on the same session. `StartSessionParams<TClientData>`:
...
[​](https://trigger.dev/docs/ai-chat/reference#multitab)
...
[​](https://trigger.dev/docs/ai-chat/reference#trigger-configuration)
...
[​](https://trigger.dev/docs/ai-chat/reference#transport-stopgeneration)
...
[​](https://trigger.dev/docs/ai-chat/reference#transport-sendaction)
...
See [Actions](https://trigger.dev/docs/ai-chat/actions)
 for backend setup and [Sending actions](https://trigger.dev/docs/ai-chat/frontend#sending-actions)
 for frontend usage.

### 

[​](https://trigger.dev/docs/ai-chat/reference#transport-preload)
...
No-op if a session already exists for this chatId. The preload idle window is set by `preloadIdleTimeoutInSeconds` on the agent, not by this call. See [Preload](https://trigger.dev/docs/ai-chat/fast-starts#preload)
 for full details.

[​](https://trigger.dev/docs/ai-chat/reference#usetriggerchattransport)
...
[​](https://trigger.dev/docs/ai-chat/reference#agentchat-options)
...
[​](https://trigger.dev/docs/ai-chat/reference#createstartsessionaction-options)
...
[​](https://trigger.dev/docs/ai-chat/reference#usemultitabchat)
...
[​](https://trigger.dev/docs/ai-chat/reference#chatsession)
...
| `isStreaming` | `boolean \| undefined` | Optional. If persisted, `reconnectToStream` uses it as a fast-path short-circuit. If omitted, the server decides via the session’s [`X-Session-Settled`](https://trigger.dev/docs/ai-chat/client-protocol#x-session-settled-fast-close-on-idle-reconnects)<br> response header. |

[​](https://trigger.dev/docs/ai-chat/reference#chatinputchunk)
...
[​](https://trigger.dev/docs/ai-chat/reference#session-token-scopes)
...
[​](https://trigger.dev/docs/ai-chat/reference#related)

Related
------------------------------------------------------------------

*   [Realtime Streams](https://trigger.dev/docs/tasks/streams)
     — How streams work under the hood
*   [Using the Vercel AI SDK](https://trigger.dev/docs/guides/examples/vercel-ai-sdk)
     — Basic AI SDK usage with Trigger.dev
*   [Realtime React Hooks](https://trigger.dev/docs/realtime/react-hooks/overview)
     — Lower-level realtime hooks
*   [Authentication](https://trigger.dev/docs/realtime/auth)
     — Public access tokens and trigger tokens

Was this page helpful?

YesNo

[Previous](https://trigger.dev/docs/ai-chat/patterns/trusted-edge-signals)
[Client ProtocolThe wire protocol for building custom chat transports — how clients communicate with chat agents over Sessions and SSE.\
\
Next](https://trigger.dev/docs/ai-chat/client-protocol)
