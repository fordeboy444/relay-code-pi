...
[​](https://trigger.dev/docs/ai-chat/error-handling#error-layers-at-a-glance)
...
[​](https://trigger.dev/docs/ai-chat/error-handling#stream-errors-mid-turn)
...
[​](https://trigger.dev/docs/ai-chat/error-handling#hook-and-turn-errors)
...
[​](https://trigger.dev/docs/ai-chat/error-handling#catching-errors-in-your-own-hooks)
...
[​](https://trigger.dev/docs/ai-chat/error-handling#catching-errors-inside-run)
...
[​](https://trigger.dev/docs/ai-chat/error-handling#saving-error-state-to-your-db)
...
[​](https://trigger.dev/docs/ai-chat/error-handling#using-onturncomplete)
...
[​](https://trigger.dev/docs/ai-chat/error-handling#using-the-standard-onfailure-task-hook)
...
[​](https://trigger.dev/docs/ai-chat/error-handling#recovery-patterns)
...
[​](https://trigger.dev/docs/ai-chat/error-handling#pattern-1-undo-to-last-successful-response)
...
[​](https://trigger.dev/docs/ai-chat/error-handling#pattern-2-retry-the-last-message)
...
[​](https://trigger.dev/docs/ai-chat/error-handling#pattern-3-save-partial-responses)
...
[​](https://trigger.dev/docs/ai-chat/error-handling#pattern-4-fall-back-to-a-different-model)
...
[​](https://trigger.dev/docs/ai-chat/error-handling#what-gets-written-to-the-stream-on-error)
...
A `turn-complete` control record follows on `session.out` (header-form, not a data chunk — see [`turn-complete` control record](https://trigger.dev/docs/ai-chat/client-protocol#turn-complete-control-record)
 for the wire format) to mark the turn as done. The AI SDK’s `useChat` processes this and:
...
[​](https://trigger.dev/docs/ai-chat/error-handling#frontend-error-handling)
...
[​](https://trigger.dev/docs/ai-chat/error-handling#showing-the-error-to-the-user)
...
[​](https://trigger.dev/docs/ai-chat/error-handling#distinguishing-error-types)
...
For richer error structures, use [`chat.response.write()`](https://trigger.dev/docs/ai-chat/backend#custom-data-parts)
 with a custom `data-error` part type. This lets you ship structured error metadata (codes, retry hints, etc.) instead of stringly-typed messages.

### 

[​](https://trigger.dev/docs/ai-chat/error-handling#errors-from-accesstoken-/-startsession)
...
[​](https://trigger.dev/docs/ai-chat/error-handling#run-level-retries)
...
[​](https://trigger.dev/docs/ai-chat/error-handling#best-practices)
...
[​](https://trigger.dev/docs/ai-chat/error-handling#chatchunktoolargeerror)

`ChatChunkTooLargeError`
-------------------------------------------------------------------------------------------------------

A specific run-failing error worth flagging on its own. Anything written through the chat output is one record on the underlying realtime stream, capped at ~1 MiB per record. A single chunk over the cap throws `ChatChunkTooLargeError` (named export from `@trigger.dev/sdk`). The most common trigger is a tool whose result object is large enough to overflow as one `tool-output-available` chunk. The error carries `chunkType`, `chunkSize`, and `maxSize`. Catch with the `isChatChunkTooLargeError` guard and route oversized values out-of-band. See [Large payloads in chat.agent](https://trigger.dev/docs/ai-chat/patterns/large-payloads)
 for the ID-reference pattern that works around the cap, plus guidance on transient data parts and out-of-band logging.

[​](https://trigger.dev/docs/ai-chat/error-handling#see-also)

See also
-------------------------------------------------------------------------

*   [`uiMessageStreamOptions.onError`](https://trigger.dev/docs/ai-chat/backend#error-handling-with-onerror)
     — stream error handler details
*   [Custom actions](https://trigger.dev/docs/ai-chat/actions)
     — implement undo/retry actions
...
[Previous](https://trigger.dev/docs/ai-chat/actions)
[Sub-AgentsDelegate work to durable sub-agents from within a parent agent's tool calls, with streaming preliminary results.\
\
Next](https://trigger.dev/docs/ai-chat/patterns/sub-agents)
