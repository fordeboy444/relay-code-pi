...
[​](https://trigger.dev/docs/ai-chat/compaction#overview)
...
[​](https://trigger.dev/docs/ai-chat/compaction#basic-usage)
...
[​](https://trigger.dev/docs/ai-chat/compaction#how-it-works)
...
[​](https://trigger.dev/docs/ai-chat/compaction#customizing-what-gets-persisted)
...
[​](https://trigger.dev/docs/ai-chat/compaction#summary-+-recent-messages)
...
[​](https://trigger.dev/docs/ai-chat/compaction#flatten-to-summary-only)
...
[​](https://trigger.dev/docs/ai-chat/compaction#customizing-model-messages)
...
[​](https://trigger.dev/docs/ai-chat/compaction#summary-+-recent-context)
...
[​](https://trigger.dev/docs/ai-chat/compaction#keep-tool-results)
...
[​](https://trigger.dev/docs/ai-chat/compaction#shouldcompact-event)
...
[​](https://trigger.dev/docs/ai-chat/compaction#summarize-event)
...
[​](https://trigger.dev/docs/ai-chat/compaction#oncompacted-hook)
...
[​](https://trigger.dev/docs/ai-chat/compaction#user-initiated-compaction)

User-initiated compaction
-------------------------------------------------------------------------------------------------------

Sometimes you want the user to decide when to compact — a “Summarize conversation” button, a `/compact` slash command, or a settings toggle. Wire this up with [actions](https://trigger.dev/docs/ai-chat/actions)
: the frontend sends a typed action, `onAction` runs the summary, and `chat.history.set()` replaces the conversation.

### 

[​](https://trigger.dev/docs/ai-chat/compaction#backend)
...
Actions fire `onAction` only (plus `hydrateMessages` if set) — `run()` and `onTurnComplete` do not fire for actions. Persist the compacted state directly inside `onAction` after the `chat.history.set` call. See [Actions](https://trigger.dev/docs/ai-chat/actions)
 for the full lifecycle.

### 

[​](https://trigger.dev/docs/ai-chat/compaction#frontend)
...
[​](https://trigger.dev/docs/ai-chat/compaction#indicating-compaction-in-the-ui)
...
See [Raw streaming with `chat.stream`](https://trigger.dev/docs/ai-chat/backend#raw-streaming-with-chat-stream)
 for the full API.

[​](https://trigger.dev/docs/ai-chat/compaction#using-with-chat-createsession)
...
[​](https://trigger.dev/docs/ai-chat/compaction#using-with-raw-tasks-messageaccumulator)
...
[​](https://trigger.dev/docs/ai-chat/compaction#fully-manual-compaction)
...
[Previous](https://trigger.dev/docs/ai-chat/fast-starts)
[Prompt cachingCache the stable prefix of your agent's prompt with Anthropic prompt caching to cut token cost and latency on every turn.\
\
Next](https://trigger.dev/docs/ai-chat/prompt-caching)
