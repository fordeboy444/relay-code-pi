...
[​](https://trigger.dev/docs/ai-chat/chat-local#declaring-and-initializing)
...
[​](https://trigger.dev/docs/ai-chat/chat-local#accessing-from-tools)
...
[​](https://trigger.dev/docs/ai-chat/chat-local#accessing-from-subtasks)
...
[​](https://trigger.dev/docs/ai-chat/chat-local#dirty-tracking-and-persistence)
...
[​](https://trigger.dev/docs/ai-chat/chat-local#api)
...
[​](https://trigger.dev/docs/ai-chat/chat-local#see-also)

See also
---------------------------------------------------------------------

*   [Lifecycle hooks](https://trigger.dev/docs/ai-chat/lifecycle-hooks)
     — `onBoot` is the canonical init site for `chat.local`.
*   [Database persistence pattern](https://trigger.dev/docs/ai-chat/patterns/database-persistence)
     — full per-hook breakdown using `chat.local` alongside DB rows.
*   [Code execution sandbox pattern](https://trigger.dev/docs/ai-chat/patterns/code-sandbox)
     — example of using `chat.local` to hold a sandbox handle across turns.
*   [Database connections](https://trigger.dev/docs/database-connections)
     — why the database client and its connection pool belong at module scope, not in `chat.local`.

Was this page helpful?

YesNo

[Previous](https://trigger.dev/docs/ai-chat/sessions)
[TypesTypeScript types for AI Agents, UI messages, and the frontend transport.\
\
Next](https://trigger.dev/docs/ai-chat/types)
