...
> Source: https://trigger.dev/docs/ai-chat/changelog#/in/append-413-+-precise-cap

[​](https://trigger.dev/docs/ai-chat/changelog#june-17-2026)
...
[​](https://trigger.dev/docs/ai-chat/changelog#chat-headstart-now-works-for-custom-agents-and-sessions)

chat.headStart now works for custom agents and sessions
------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Head Start](https://trigger.dev/docs/ai-chat/fast-starts#head-start)
 — running the first `streamText` step in your warm server while the agent boots in parallel — now works with the `chat.customAgent` and `chat.createSession` backends, not just the managed `chat.agent`. The warm step-1 response hands over to your loop the same way it does for a managed agent. ([#3963](https://github.com/triggerdotdev/trigger.dev/pull/3963)
...
[​](https://trigger.dev/docs/ai-chat/changelog#cache-your-system-prompt-with-anthropic-prompt-caching)
...
Pairs with a `prepareMessages` cache breakpoint to cache the conversation prefix across turns too. See the [Prompt caching](https://trigger.dev/docs/ai-chat/prompt-caching)
 guide.

[​](https://trigger.dev/docs/ai-chat/changelog#custom-agent-loop-fixes)
...
[​](https://trigger.dev/docs/ai-chat/changelog#trigger-skills-namespacing-docs-bundling-and-a-cost-savings-skill)

trigger skills: namespacing, docs bundling, and a cost-savings skill
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

Follow-ups to the [`trigger skills`](https://trigger.dev/docs/ai-chat/patterns/skills)
 command shipped in rc.6:
...
[​](https://trigger.dev/docs/ai-chat/changelog#june-12-2026)
...
[​](https://trigger.dev/docs/ai-chat/changelog#chat-agent-reliability-fixes)
...
[​](https://trigger.dev/docs/ai-chat/changelog#continuation-boots-no-longer-stall)
...
[​](https://trigger.dev/docs/ai-chat/changelog#chat-headstart-hydration-and-reasoning-fixes)

chat.headStart: hydration and reasoning fixes
---------------------------------------------------------------------------------------------------------------------------------------------

Two fixes for the [Head Start](https://trigger.dev/docs/ai-chat/fast-starts)
 handover:
...
[​](https://trigger.dev/docs/ai-chat/changelog#chat-createsession-stop-and-continuation-fixes)

chat.createSession: stop and continuation fixes
-------------------------------------------------------------------------------------------------------------------------------------------------

Stopping a generation no longer wedges the run: `turn.complete()` bare-awaited the AI SDK’s `totalUsage` promise, which never settles after a stop-abort, so the loop hung inside the stopped turn and the chat couldn’t take another message. It’s now raced with a timeout, the same guard `chat.agent`’s turn loop uses.Continuation runs also no longer invoke the model with an empty prompt: a message-less continuation boot now waits for the next session input, and `turn.continuation` is preserved so your loop can seed stored history on the first turn:
...
[​](https://trigger.dev/docs/ai-chat/changelog#trigger-skills-agent-skills-for-your-coding-assistant)
...
[​](https://trigger.dev/docs/ai-chat/changelog#june-5-2026)
...
[​](https://trigger.dev/docs/ai-chat/changelog#june-1-2026)
...
`tools` also accepts a per-turn function (`(event) => ToolSet`) for tools that depend on the user or a feature flag. Only `inputSchema` and `toModelOutput` are read during conversion, never `execute`. No behavior change for agents that don’t declare `tools`.A new `InferChatUIMessageFromTools<typeof tools>` helper derives the chat `UIMessage` type (with typed tool parts) directly from a tool set. See the new [Tools](https://trigger.dev/docs/ai-chat/tools)
 guide.

[​](https://trigger.dev/docs/ai-chat/changelog#may-23-2026)
...
[​](https://trigger.dev/docs/ai-chat/changelog#hitl-continuations-%E2%80%94-slim-wire-by-default-+-field-level-merge)
...
The helper pushes fresh user messages, no-ops on HITL continuations (so the runtime can overlay the new tool-state advance), and skips on non-`submit-message` triggers. Returns `true` if it mutated `stored`. The examples in [lifecycle hooks](https://trigger.dev/docs/ai-chat/lifecycle-hooks#hydratemessages)
, [Database persistence](https://trigger.dev/docs/ai-chat/patterns/database-persistence#alternative-hydratemessages)
, and [Persistence and replay](https://trigger.dev/docs/ai-chat/patterns/persistence-and-replay)
 have all been updated. Custom hydrate logic (branching, rollback, etc.) can still write the upsert by hand — the helper is a convenience for the common shape.

### 

[​](https://trigger.dev/docs/ai-chat/changelog#onvalidatemessages-slim-wire-caveat)
...
[​](https://trigger.dev/docs/ai-chat/changelog#/in/append-413-+-precise-cap)
...
[​](https://trigger.dev/docs/ai-chat/changelog#may-21-2026)
...
[​](https://trigger.dev/docs/ai-chat/changelog#v4-5-0-rc-1-%E2%80%94-two-bug-fixes)
...
[​](https://trigger.dev/docs/ai-chat/changelog#fixes)

Fixes

*   **Agent Skills silently missing in `trigger dev`** for projects whose task files read `process.env` at module top level (e.g. a third-party SDK client initialized at import). [Skill folders](https://trigger.dev/docs/ai-chat/patterns/skills)
     now bundle into `.trigger/skills/` reliably regardless of which env vars are set when the CLI launches. ([#3690](https://github.com/triggerdotdev/trigger.dev/pull/3690)
    )
...
[​](https://trigger.dev/docs/ai-chat/changelog#may-21-2026-2)
...
[​](https://trigger.dev/docs/ai-chat/changelog#v4-5-0-rc-0-%E2%80%94-ai-agents-graduate-from-chat-prerelease)
...
[​](https://trigger.dev/docs/ai-chat/changelog#what%E2%80%99s-in-the-box)

What’s in the box

*   **`chat.agent`** — multi-turn AI chat backends as durable Trigger.dev tasks. Lifecycle hooks, recovery from cancel/crash/OOM, version upgrades, all in. See [Overview](https://trigger.dev/docs/ai-chat/overview)
     and [Quick Start](https://trigger.dev/docs/ai-chat/quick-start)
    .
...
[​](https://trigger.dev/docs/ai-chat/changelog#compatibility)
...
[​](https://trigger.dev/docs/ai-chat/changelog#docs)

Docs

This release ships with a refreshed AI Agents documentation set covering [Backend](https://trigger.dev/docs/ai-chat/backend)
...
, [`chat.local`](https://trigger.dev/docs/ai-chat/chat-local)
, the [Patterns](https://trigger.dev/docs/ai-chat/patterns/sub-agents)
 library, [Testing](https://trigger.dev/docs/ai-chat/testing)
, and a full [API Reference](https://trigger.dev/docs/ai-chat/reference)
.

[​](https://trigger.dev/docs/ai-chat/changelog#may-19-2026)
...
[​](https://trigger.dev/docs/ai-chat/changelog#recovery-boot-%E2%80%94-context-preserving-continuation-after-cancel-/-crash-/-oom)
...
[​](https://trigger.dev/docs/ai-chat/changelog#session-out-is-now-bounded-%E2%80%94-header-form-control-records-+-per-turn-trim)
...
[​](https://trigger.dev/docs/ai-chat/changelog#what-changed-on-the-wire)
...
[​](https://trigger.dev/docs/ai-chat/changelog#custom-transport-implementers)
...
[​](https://trigger.dev/docs/ai-chat/changelog#sessions-dashboard-snapshot-read)
...
[​](https://trigger.dev/docs/ai-chat/changelog#breaking-surface)
...
[​](https://trigger.dev/docs/ai-chat/changelog#docs-2)

Docs

*   [Records on `session.out`](https://trigger.dev/docs/ai-chat/client-protocol#records-on-session-out)
     — full filter rule for data / control / command records.
*   [Resuming a stream](https://trigger.dev/docs/ai-chat/client-protocol#resuming-a-stream)
     — explicit single-turn vs multi-turn-away semantics.
*   [`turn-complete` control record](https://trigger.dev/docs/ai-chat/client-protocol#turn-complete-control-record)
     and [`upgrade-required` control record](https://trigger.dev/docs/ai-chat/client-protocol#upgrade-required-control-record)
     — replaced the old chunk-shape docs.

[​](https://trigger.dev/docs/ai-chat/changelog#may-8-2026)
...
[​](https://trigger.dev/docs/ai-chat/changelog#512-kib-/in/append-ceiling-removed-for-long-chats-%E2%80%94-slim-wire-+-s3-snapshot)
...
[​](https://trigger.dev/docs/ai-chat/changelog#what-changed)
...
[​](https://trigger.dev/docs/ai-chat/changelog#object-store-configuration)
...
[​](https://trigger.dev/docs/ai-chat/changelog#breaking-surface-2)
...
*   **Custom transports**: any code constructing `ChatTaskWirePayload` directly must drop `messages` and use `message`. See the rewritten [Client Protocol](https://trigger.dev/docs/ai-chat/client-protocol)
    .
*   **Client-side `setMessages` no longer round-trips**: full-history mutations on the client never reached the agent before this release either, but the slim wire makes that explicit. Use server-side [`chat.history.set()`](https://trigger.dev/docs/ai-chat/backend#chat-history)
     inside `onTurnStart` for compaction.
...
[​](https://trigger.dev/docs/ai-chat/changelog#docs-3)

Docs

*   Rewritten [Client Protocol](https://trigger.dev/docs/ai-chat/client-protocol)
     — slim payload, new `headStartMessages` field, new “How history is rebuilt” and “Head-start protocol caveat” sections.
*   New [Persistence and replay](https://trigger.dev/docs/ai-chat/patterns/persistence-and-replay)
     — end-to-end walkthrough of the snapshot model, OOM-retry interaction, crash semantics, `hydrateMessages` short-circuit.
*   New [Tool result auditing](https://trigger.dev/docs/ai-chat/patterns/tool-result-auditing)
     — the `extractNewToolResults` + `onTurnComplete` / `hydrateMessages` pattern for HITL audit logging.
*   [v4.5 section of the upgrade guide](https://trigger.dev/docs/ai-chat/upgrade-guide#v45-wire-format-change)
     — migration steps for custom transports and `hydrateMessages` consumers.
*   [`hydrateMessages`](https://trigger.dev/docs/ai-chat/lifecycle-hooks#hydratemessages)
    , [`onChatStart`](https://trigger.dev/docs/ai-chat/lifecycle-hooks#onchatstart)
     — clarifications on the new `incomingMessages` and `messages` shapes.

[​](https://trigger.dev/docs/ai-chat/changelog#may-7-2026)
...
[​](https://trigger.dev/docs/ai-chat/changelog#chat-history-read-primitives-for-hitl-flows)
...
See [`chat.history`](https://trigger.dev/docs/ai-chat/backend#chat-history)
 and [Human-in-the-loop](https://trigger.dev/docs/ai-chat/patterns/human-in-the-loop)
.

[​](https://trigger.dev/docs/ai-chat/changelog#fix-hitl-addtooloutput-resume-preserves-the-assistant-message-id)
...
[​](https://trigger.dev/docs/ai-chat/changelog#may-6-2026)
...
[​](https://trigger.dev/docs/ai-chat/changelog#chat-agent-actions-are-no-longer-turns)
...
[​](https://trigger.dev/docs/ai-chat/changelog#migration)
...
[​](https://trigger.dev/docs/ai-chat/changelog#may-5-2026)
...
[​](https://trigger.dev/docs/ai-chat/changelog#fix-duplicate-turn-after-chat-agent-idle-suspends)
...
[​](https://trigger.dev/docs/ai-chat/changelog#may-5-2026-2)
...
[​](https://trigger.dev/docs/ai-chat/changelog#chat-headstart-%E2%80%94-fast-first-turn-for-chat-agent)
...
[​](https://trigger.dev/docs/ai-chat/changelog#setup)
...
[​](https://trigger.dev/docs/ai-chat/changelog#works-on-every-runtime)
...
[​](https://trigger.dev/docs/ai-chat/changelog#docs-4)

Docs
--------------------------------------------------------------

*   New [Head Start guide](https://trigger.dev/docs/ai-chat/fast-starts#head-start)
     — bundle isolation, schema/execute split, route handler setup, transport option, lifecycle, limitations.
*   [Reference](https://trigger.dev/docs/ai-chat/reference#triggerchattransport-options)
     — `headStart` transport option.

[​](https://trigger.dev/docs/ai-chat/changelog#may-2-2026)
...
[​](https://trigger.dev/docs/ai-chat/changelog#resilient-sse-reconnection)
...
[​](https://trigger.dev/docs/ai-chat/changelog#april-24-2026)
...
[​](https://trigger.dev/docs/ai-chat/changelog#chat-agent-now-runs-on-sessions)
...
*   Client messages and stops land on `session.in` as a [`ChatInputChunk`](https://trigger.dev/docs/ai-chat/reference#chatinputchunk)
     tagged union (was two run-scoped `streams.input` definitions).
...
[​](https://trigger.dev/docs/ai-chat/changelog#x-session-settled-%E2%80%94-fast-reconnect-on-idle-chats)
...
[​](https://trigger.dev/docs/ai-chat/changelog#migration-2)

Migration
------------------------------------------------------------------------

See the [Sessions Upgrade Guide](https://trigger.dev/docs/ai-chat/upgrade-guide)
 for the full step-by-step — auth callback split, persisted `ChatSession` shape, server-side helpers (`chat.createStartSessionAction`, `chat.createAccessToken` for renewal), and the `clientData` validation pivot.

[​](https://trigger.dev/docs/ai-chat/changelog#docs-5)

Docs
--------------------------------------------------------------

*   Rewritten [Client Protocol](https://trigger.dev/docs/ai-chat/client-protocol)
     — full wire format for the new `/realtime/v1/sessions/{sessionId}/...` endpoints, JWT scopes, S2 direct-write credentials, and `Last-Event-ID` resume.
*   [Database persistence pattern](https://trigger.dev/docs/ai-chat/patterns/database-persistence)
     — new `chatId`\-keyed `ChatSession` shape (no more `runId`) and a warning on the `onTurnComplete` race that requires a single atomic write of `messages` + `lastEventId`.
*   [Reference](https://trigger.dev/docs/ai-chat/reference)
     — added `chat.createStartSessionAction`, `chat.createAccessToken`, `ChatInputChunk`, `TriggerChatTaskResult.sessionId`, `ChatTaskRunPayload.sessionId`. The old run-scoped stream-ID constants are gone.
*   Refreshed [Backend](https://trigger.dev/docs/ai-chat/backend)
    , [Frontend](https://trigger.dev/docs/ai-chat/frontend)
    , [Server Chat](https://trigger.dev/docs/ai-chat/server-chat)
    , [Quick start](https://trigger.dev/docs/ai-chat/quick-start)
    , [Overview](https://trigger.dev/docs/ai-chat/overview)
    , [Types](https://trigger.dev/docs/ai-chat/types)
    , [Error handling](https://trigger.dev/docs/ai-chat/error-handling)
    , and [Testing](https://trigger.dev/docs/ai-chat/testing)
     for the session-based wiring.

[​](https://trigger.dev/docs/ai-chat/changelog#april-19-2026)
...
[​](https://trigger.dev/docs/ai-chat/changelog#agent-skills)

Agent Skills
----------------------------------------------------------------------------

Ship reusable capabilities as folders — a `SKILL.md` plus optional scripts, references, and assets. The agent sees short descriptions in its system prompt, loads full instructions on demand via `loadSkill`, and invokes bundled scripts via `bash` — no manual wiring.`skills.define({ id, path })` registers the skill; the CLI bundles the folder into the deploy image. `chat.skills.set([...])` activates skills for the run; `chat.toStreamTextOptions()` auto-injects the preamble and tools.See the new [Agent Skills guide](https://trigger.dev/docs/ai-chat/patterns/skills)
.

[​](https://trigger.dev/docs/ai-chat/changelog#april-18-2026)
...
[​](https://trigger.dev/docs/ai-chat/changelog#chat-endrun-%E2%80%94-exit-on-your-own-terms)
...
[​](https://trigger.dev/docs/ai-chat/changelog#finishreason-on-turn-complete-events)
...
[​](https://trigger.dev/docs/ai-chat/changelog#user-initiated-compaction-pattern)

User-initiated compaction pattern
----------------------------------------------------------------------------------------------------------------------

The [Compaction guide](https://trigger.dev/docs/ai-chat/compaction)
 now covers how to wire a “Summarize conversation” button or `/compact` slash command via `actionSchema` + `onAction`. The agent summarizes on demand, rewrites history with `chat.history.set()`, and short-circuits the LLM call for action turns.Needed a small type fix for this: `ChatTaskPayload.trigger` now correctly includes `"action"`, so `run()` handlers can short-circuit with `if (trigger === "action") return` when an action doesn’t need a response.

[​](https://trigger.dev/docs/ai-chat/changelog#human-in-the-loop-pattern-page)

Human-in-the-loop pattern page
----------------------------------------------------------------------------------------------------------------

New [Human-in-the-loop](https://trigger.dev/docs/ai-chat/patterns/human-in-the-loop)
 page walks through `ask_user`\-style mid-turn user input end-to-end: defining a no-execute tool, rendering pending tool calls on the frontend with `addToolOutput` + `sendAutomaticallyWhen`, detecting paused turns via `finishReason`, and two persistence strategies (overwrite vs. checkpoint nodes).

[​](https://trigger.dev/docs/ai-chat/changelog#april-18-2026-2)
...
[​](https://trigger.dev/docs/ai-chat/changelog#offline-test-harness-for-chat-agent)
...
[​](https://trigger.dev/docs/ai-chat/changelog#dependency-injection-via-locals)
...
Hooks then read the seeded value with `locals.get(dbKey)`. Falls through to the production client in real runs.See [Testing](https://trigger.dev/docs/ai-chat/testing)
.

[​](https://trigger.dev/docs/ai-chat/changelog#runinmocktaskcontext-%E2%80%94-lower-level-test-harness)
...
[​](https://trigger.dev/docs/ai-chat/changelog#april-17-2026)
...
[​](https://trigger.dev/docs/ai-chat/changelog#multi-tab-coordination)
...
Only one tab can send at a time. Other tabs enter read-only mode with real-time message updates via `BroadcastChannel`. When the active tab’s turn completes, any tab can send next. Crashed tabs are detected via heartbeat timeout (10s).See [Multi-tab coordination](https://trigger.dev/docs/ai-chat/frontend#multi-tab-coordination)
 and [`useMultiTabChat`](https://trigger.dev/docs/ai-chat/reference#usemultitabchat)
.

[​](https://trigger.dev/docs/ai-chat/changelog#error-stack-truncation)
...
[​](https://trigger.dev/docs/ai-chat/changelog#april-15-2026)
...
[​](https://trigger.dev/docs/ai-chat/changelog#fix-resume-true-hangs-on-completed-turns)
...
[​](https://trigger.dev/docs/ai-chat/changelog#april-15-2026-2)
...
[​](https://trigger.dev/docs/ai-chat/changelog#hydratemessages-%E2%80%94-backend-controlled-message-history)
...
Tool approval updates are auto-merged after hydration — no extra handling needed.See [hydrateMessages](https://trigger.dev/docs/ai-chat/lifecycle-hooks#hydratemessages)
.

[​](https://trigger.dev/docs/ai-chat/changelog#chat-history-%E2%80%94-imperative-message-mutations)
...
[​](https://trigger.dev/docs/ai-chat/changelog#custom-actions-%E2%80%94-actionschema-+-onaction)
...
Frontend: `transport.sendAction(chatId, { type: "undo" })` Server: `agentChat.sendAction({ type: "undo" })`See [Actions](https://trigger.dev/docs/ai-chat/actions)
 and [Sending actions](https://trigger.dev/docs/ai-chat/frontend#sending-actions)
.

[​](https://trigger.dev/docs/ai-chat/changelog#april-14-2026)
...
[​](https://trigger.dev/docs/ai-chat/changelog#chat-response-%E2%80%94-persistent-data-parts)
...
Non-transient `data-*` chunks written via lifecycle hook `writer.write()` now automatically persist to the response message, matching the AI SDK’s default semantics. Add `transient: true` for ephemeral chunks (progress indicators, status updates).See [Custom data parts](https://trigger.dev/docs/ai-chat/backend#custom-data-parts)
.

[​](https://trigger.dev/docs/ai-chat/changelog#tool-approvals)
...
[​](https://trigger.dev/docs/ai-chat/changelog#transport-stopgeneration-chatid)
...
[​](https://trigger.dev/docs/ai-chat/changelog#generatemessageid-support)
...
[​](https://trigger.dev/docs/ai-chat/changelog#bug-fixes)
...
[Previous](https://trigger.dev/docs/ai-chat/upgrade-guide)
[trigger.config.tsThis file is used to configure your project and how it's built.\
\
Next](https://trigger.dev/docs/config/config-file)

⌘I

FiltersClear

SDKBug fixCLIBreakingWebappReleasePlatform
