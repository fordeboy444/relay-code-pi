...
Agent skills are reusable capabilities you ship as folders — a `SKILL.md` describing when and how to use them, plus optional scripts, references, and assets. The chat agent sees a short description of each skill in its system prompt, loads the full instructions on demand via a `loadSkill` tool, and invokes the bundled scripts via `bash` — all without you wiring anything up manually. Built on the [AI SDK cookbook pattern](https://ai-sdk.dev/cookbook/guides/agent-skills)
. Works with any provider (OpenAI, Anthropic, Gemini, etc.) — not tied to Anthropic’s server-side skills.

[​](https://trigger.dev/docs/ai-chat/patterns/skills#why-skills)
...
[​](https://trigger.dev/docs/ai-chat/patterns/skills#trust-model)
...
[​](https://trigger.dev/docs/ai-chat/patterns/skills#skill-folder-layout)
...
[​](https://trigger.dev/docs/ai-chat/patterns/skills#skill-md)
...
[​](https://trigger.dev/docs/ai-chat/patterns/skills#defining-and-using-a-skill)
...
[​](https://trigger.dev/docs/ai-chat/patterns/skills#what-gets-auto-injected)
...
[​](https://trigger.dev/docs/ai-chat/patterns/skills#loadskill--name-)
...
[​](https://trigger.dev/docs/ai-chat/patterns/skills#readfile--skill-path-)
...
[​](https://trigger.dev/docs/ai-chat/patterns/skills#bash--skill-command-)
...
[​](https://trigger.dev/docs/ai-chat/patterns/skills#how-discovery-works-in-the-model)
...
[​](https://trigger.dev/docs/ai-chat/patterns/skills#mixing-skills-with-custom-tools)
...
Your tools win on name conflicts. (Pick names that don’t collide with `loadSkill` / `readFile` / `bash` to keep things predictable.) Also declare those same tools on the agent’s [`tools`](https://trigger.dev/docs/ai-chat/tools)
 config. `toStreamTextOptions` merges them with the skill tools for the model call, while the config option threads them into history re-conversion so any `toModelOutput` survives across turns. The auto-injected skill tools (`loadSkill` / `readFile` / `bash`) don’t define `toModelOutput`, so they don’t need to be on the config.

[​](https://trigger.dev/docs/ai-chat/patterns/skills#bundling)
...
[​](https://trigger.dev/docs/ai-chat/patterns/skills#path-scoping-rules)
...
[​](https://trigger.dev/docs/ai-chat/patterns/skills#current-limitations)
...
[​](https://trigger.dev/docs/ai-chat/patterns/skills#full-example)

Full example
----------------------------------------------------------------------------------

See [`projects/ai-chat/src/trigger/skills/time-utils/`](https://github.com/triggerdotdev/references/tree/main/projects/ai-chat/src/trigger/skills/time-utils)
 in the [references repo](https://github.com/triggerdotdev/references)
 for a working skill that bundles two bash scripts and a reference cheat-sheet, wired into a `chat.agent` that answers timezone questions.

[​](https://trigger.dev/docs/ai-chat/patterns/skills#related)

Related
------------------------------------------------------------------------

*   [AI SDK cookbook — Agent Skills](https://ai-sdk.dev/cookbook/guides/agent-skills)
     — the userland pattern we build on
*   [Anthropic Agent Skills](https://platform.claude.com/docs/en/agents-and-tools/agent-skills/overview)
     — Anthropic’s codified version (server-side, optional future integration)

Was this page helpful?

YesNo

[Previous](https://trigger.dev/docs/ai-chat/patterns/large-payloads)
[OOM resilienceRecover from out-of-memory errors mid-turn by automatically retrying the failed turn on a larger machine — without losing the in-flight user message or re-processing completed turns.\
\
Next](https://trigger.dev/docs/ai-chat/patterns/oom-resilience)
