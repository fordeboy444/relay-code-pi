...
- **URL:** https://docs.composio.dev/api-reference/webhook-subscriptions/index
- **Summary:** Webhook delivery subscriptions. Outbound URLs Composio posts trigger events to, plus signing secret rotation and event-type filters.
