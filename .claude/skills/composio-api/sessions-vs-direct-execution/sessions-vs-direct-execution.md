...
- **URL:** https://docs.composio.dev/sessions-vs-direct-execution
- **Summary:** When to use session-based meta tools vs direct tool fetching and execution
...
| **Auth** | [In-chat](/docs/authentication#in-chat-authentication): agent prompts the user to connect when needed. Also supports [manual](/docs/manually-authenticating) | You build the auth flow with [connect links](/docs/tools-direct/authenticating-tools) |
...
<Card icon={} title="Configuring Sessions" href="/docs/configuring-sessions" description="Toolkits, auth configs, and connected accounts" />
