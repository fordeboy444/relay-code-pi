...
- **URL:** https://docs.composio.dev/sessions-via-mcp
- **Summary:** Connect any MCP-compatible client to a Composio session
...
<Card icon={} title="Configuring Sessions" href="/docs/configuring-sessions" description="Restrict toolkits, set custom auth configs, and select connected accounts" />
