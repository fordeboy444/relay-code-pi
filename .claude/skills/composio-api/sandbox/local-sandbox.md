...
- **URL:** https://docs.composio.dev/sandbox/local
- **Summary:** Run Composio tools in a sandbox you own (your filesystem, your shell, your security boundary), while Composio keeps managed auth and tool discovery.
...
<Card icon={} title="What is a session?" href="/docs/how-composio-works" description="How sessions scope tools, auth, and sandbox state to a user" />
