...
- **URL:** https://docs.composio.dev/sandbox/remote
- **Summary:** A persistent Python sandbox where your agent writes code, calls tools programmatically, and processes data
...
<Card icon={} title="Local sandbox" href="/docs/sandbox/local" description="Run the same tool calls in a sandbox you own, while Composio keeps managed auth and discovery." />
