...
- **URL:** https://docs.composio.dev/managing-multiple-connected-accounts
- **Summary:** Handle users with multiple accounts for the same toolkit using multi-account mode and aliases
...
<Card icon={} title="Shared connections" href="/docs/shared-connections" description="Make one connected account usable by multiple users with a per-user access control list" />
