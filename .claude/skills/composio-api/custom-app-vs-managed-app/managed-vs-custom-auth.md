...
- **URL:** https://docs.composio.dev/custom-app-vs-managed-app
- **Summary:** Decide when to use Composio managed authentication and how to configure your own credentials
...
<Card icon={} title="Programmatic auth configs" href="/docs/programmatic-auth-configs" description="Create auth configs in code and pass them to a session" />
