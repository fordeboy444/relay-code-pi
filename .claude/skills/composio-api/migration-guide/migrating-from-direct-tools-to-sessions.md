...
- **URL:** https://docs.composio.dev/migration-guide/direct-to-sessions
- **Summary:** Move from direct tool execution to the sessions paradigm
...
<Card icon={} title="Configuring Sessions" href="/docs/configuring-sessions" description="Toolkits, auth configs, account selection, and session methods" />
