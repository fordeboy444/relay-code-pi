...
- **URL:** https://docs.composio.dev/sdk-reference/python/session
- **Summary:** A Composio session \u2014 the object returned by `composio.create(...)` / `composio.use(...)`. Use it to fetch session-scoped tools, authorize toolkits,...
