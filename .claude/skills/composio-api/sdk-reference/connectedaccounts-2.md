...
- **URL:** https://docs.composio.dev/sdk-reference/typescript/connected-accounts
- **Summary:** ConnectedAccounts class  This class is used to manage connected accounts in the Composio SDK. Connected accounts are used to authenticate with third-party services.
