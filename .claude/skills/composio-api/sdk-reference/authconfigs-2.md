...
- **URL:** https://docs.composio.dev/sdk-reference/typescript/auth-configs
- **Summary:** AuthConfigs class  This class is used to manage authentication configurations in the Composio SDK. Auth configs are used to configure authentication providers and settings.
