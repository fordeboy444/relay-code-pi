...
- **URL:** https://docs.composio.dev/sdk-reference/typescript/remote-file
- **Summary:** Represents a file stored in a tool router session's file mount. Provides methods to fetch, save, and work with the file content.
