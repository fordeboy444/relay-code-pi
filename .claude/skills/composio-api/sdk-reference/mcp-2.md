...
- **URL:** https://docs.composio.dev/sdk-reference/typescript/mcp
- **Summary:** MCP (Model Control Protocol) class Handles MCP server operations. When `config.experimental.mcp` is enabled, this class augments the features of `composio.mcp`.
