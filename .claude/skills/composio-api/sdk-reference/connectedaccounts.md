...
- **URL:** https://docs.composio.dev/sdk-reference/python/connected-accounts
- **Summary:** Manage connected accounts.  This class is used to manage connected accounts in the Composio SDK. These are used to authenticate with third-party se...
