...
- **URL:** https://docs.composio.dev/sdk-reference/typescript/sessions
- **Summary:** First-class API for creating and reusing Composio sessions.  `composio.sessions.create(...)` is the canonical session creation entrypoint. The top-level `composio.create(...)` method remains as a backwards-compatible alias for `composio.sessions.create(...)`.
