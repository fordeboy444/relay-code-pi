...
- **URL:** https://docs.composio.dev/sdk-reference/typescript/toolkits
- **Summary:** Toolkits class  Toolkits are a collection of tools that can be used to perform various tasks. This is similar/replacement of `apps` in the Composio API.
