...
- **URL:** https://docs.composio.dev/shared-connections
- **Summary:** Make a connected account usable by multiple users with a per-user access control list
...
<Card icon={} title="Configuring sessions" href="/docs/configuring-sessions" description="Pin connected accounts, auth configs, and toolkit restrictions into a session" />
