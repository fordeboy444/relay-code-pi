...
- **URL:** https://docs.composio.dev/auth-configuration/migrating-initiate-to-link
- **Summary:** Move Composio-managed OAuth flows off the legacy POST /api/v3/connected_accounts endpoint and onto link() before the 2026-05-08 / 2026-07-03 cutover.
