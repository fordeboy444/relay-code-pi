...
- **URL:** https://docs.composio.dev/auth-configuration/connected-accounts
- **Summary:** Manage and monitor user connections to toolkits
...
<Card icon={} title="Authenticating tools" href="/docs/tools-direct/authenticating-tools" description="Create auth configs and connect user accounts" />
