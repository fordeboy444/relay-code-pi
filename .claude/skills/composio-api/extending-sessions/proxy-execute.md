...
- **URL:** https://docs.composio.dev/extending-sessions/proxy-execute
- **Summary:** Call any API endpoint on a toolkit from a session and let Composio inject the authenticated credentials for you
...
<Card icon={} title="Custom tools and toolkits" href="/docs/extending-sessions/custom-tools-and-toolkits" description="Define in-process tools and toolkits that run alongside Composio tools" />
