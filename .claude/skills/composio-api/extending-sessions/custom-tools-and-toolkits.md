...
- **URL:** https://docs.composio.dev/extending-sessions/custom-tools-and-toolkits
- **Summary:** Define local tools that run in-process alongside remote Composio tools
...
<Card icon={} title="Configuring sessions" href="/docs/configuring-sessions" description="Filter toolkits and tools, set auth configs, and read tools with session.tools()" />
