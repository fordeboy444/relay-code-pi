...
- **URL:** https://docs.composio.dev/general-agent-with-pi
- **Summary:** Build a general-purpose agent with Pi and Composio, then drop it into Slack so a whole team can use it. Triggers, per-user sessions, a shared workspace connection, redirected auth links, and raw API access.
