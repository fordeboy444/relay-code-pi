...
- **URL:** https://docs.composio.dev/claude-code-plugin
- **Summary:** Act on 1,000+ apps from Claude Code — Slack, GitHub, Gmail, Notion, Linear, and more — with fully managed OAuth. Installs in two commands.
