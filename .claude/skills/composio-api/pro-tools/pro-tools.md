...
- **URL:** https://docs.composio.dev/pro-tools
- **Summary:** Pricing and limits for pro tools in Composio
...
## What counts as a pro tool?
  ...
  <Card icon={} title="Search APIs" href="/toolkits/composio_search" description="Composio Search, Perplexity, Exa, SerpAPI" />
  <Card icon={} title="Code execution" href="/toolkits/codeinterpreter" description="Sandboxed runtimes like E2B" />
  <Card icon={} title="Web scraping & data extraction" description="Crawlers and structured extraction" />
  <Card icon={} title="AI/ML inference" description="Hosted model calls and embeddings" />
  <Card icon={} title="Document processing & OCR" description="PDF, image, and document parsing" />
  <Card icon={} title="Compute-intensive operations" description="Long-running or heavy transforms" />
