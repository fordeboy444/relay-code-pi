...
- **URL:** https://docs.composio.dev/how-composio-works
- **Summary:** What Composio sessions do, and how they scope users, tools, toolkits, auth, MCP, and workbench state
...
<Card icon={} title="Configuring Sessions" href="/docs/configuring-sessions" description="Enable toolkits, set auth configs, and select connected accounts" />
