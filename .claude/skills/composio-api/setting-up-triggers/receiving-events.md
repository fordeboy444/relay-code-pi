...
- **URL:** https://docs.composio.dev/setting-up-triggers/subscribing-to-events
- **Summary:** Get trigger events locally with an SDK subscription or in production over your webhook URL
...
<Card icon={} title="Managing triggers" href="/docs/setting-up-triggers/managing-triggers" description="List, enable, disable, and delete trigger instances" />
