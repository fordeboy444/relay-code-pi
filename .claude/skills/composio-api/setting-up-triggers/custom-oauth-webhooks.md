...
- **URL:** https://docs.composio.dev/setting-up-triggers/custom-oauth-webhooks
- **Summary:** Register Composio's ingress URL when you bring your own OAuth app
...
<Card icon={} title="Creating triggers" href="/docs/setting-up-triggers/creating-triggers" description="Activate a trigger for a user so events start flowing" />
