...
- **URL:** https://docs.composio.dev/white-labeling-authentication
- **Summary:** Remove Composio branding from your auth flows
...
<Card icon={} title="Managed vs custom auth" href="/docs/custom-app-vs-managed-app" description="Decide when to use custom credentials, create an auth config, and pass it to sessions." />
...
<Card icon={} title="Managed vs custom auth" href="/docs/custom-app-vs-managed-app" description="Set up auth configs for OAuth apps, API keys, and toolkits without managed auth" />
