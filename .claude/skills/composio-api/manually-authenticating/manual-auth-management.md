...
- **URL:** https://docs.composio.dev/manually-authenticating
- **Summary:** Authenticate and manage user connections to toolkits outside of chat
...
<Card icon={} title="Managing multiple connected accounts" href="/docs/managing-multiple-connected-accounts" description="Let a user connect work and personal accounts for the same toolkit, then pick which one runs" />
