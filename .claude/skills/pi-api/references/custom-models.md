...
- **Command:** `Custom Models`
- **Summary:** Add custom providers and models (Ollama, vLLM, LM Studio, proxies) via `~/.pi/agent/models.json`. - Minimal Example - Full Example - Supported APIs - Provider Configuration - Model Configuration - Overriding Built-in Providers - Per-model Overrides - Anthropic Messages Compatibility - OpenAI...
