...
- **Command:** `Using Pi`
- **Summary:** This page collects day-to-day usage details that do not fit on the quickstart page. <p align="center"><img src="images/interactive-mode.png" alt="Interactive Mode" width="600"></p> The interface has four main areas: - **Startup header** - shortcuts, loaded context files, prompt templates, skills,...
