// Fixture: the relay-code trigger.config.ts template (empty sentinel project
// field), with `import { defineConfig } from "@trigger.dev/sdk"` replaced by a
// local declare-stub — tests/fixtures/*.ts are inside this repo's tsconfig
// include and the Trigger.dev SDK is not installed here.
